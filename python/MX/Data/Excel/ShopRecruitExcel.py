...
def ShopRecruitExcelAddRecruitSellectionShopId(builder, recruitSellectionShopId): builder.PrependInt64Slot(16, recruitSellectionShopId, 0)
...
def ShopRecruitExcelAddPurchaseCooltimeMin(builder, purchaseCooltimeMin): builder.PrependInt64Slot(17, purchaseCooltimeMin, 0)
...
def ShopRecruitExcelAddPurchaseCountLimit(builder, purchaseCountLimit): builder.PrependInt64Slot(18, purchaseCountLimit, 0)
...
def ShopRecruitExcelAddIsNewbie(builder, isNewbie): builder.PrependBoolSlot(20, isNewbie, 0)
def AddIsNewbie(builder, isNewbie):
    return ShopRecruitExcelAddIsNewbie(builder, isNewbie)
def ShopRecruitExcelAddIsSelectRecruit(builder, isSelectRecruit): builder.PrependBoolSlot(21, isSelectRecruit, 0)
def AddIsSelectRecruit(builder, isSelectRecruit):
    return ShopRecruitExcelAddIsSelectRecruit(builder, isSelectRecruit)
def ShopRecruitExcelAddDirectPayInvisibleTokenId(builder, directPayInvisibleTokenId): builder.PrependInt64Slot(22, directPayInvisibleTokenId, 0)
...
def ShopRecruitExcelAddDirectPayAndroidShopCashId(builder, directPayAndroidShopCashId): builder.PrependInt64Slot(23, directPayAndroidShopCashId, 0)
...
def ShopRecruitExcelAddDirectPayAppleShopCashId(builder, directPayAppleShopCashId): builder.PrependInt64Slot(24, directPayAppleShopCashId, 0)
...
def ShopRecruitExcelAddSelectAbleGachaGroupId(builder, selectAbleGachaGroupId): builder.PrependInt64Slot(25, selectAbleGachaGroupId, 0)
...
def ShopRecruitExcelAddMaxSelectCharacterNum(builder, maxSelectCharacterNum): builder.PrependInt64Slot(26, maxSelectCharacterNum, 0)
