...
def EliminateRaidRankingRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def EliminateRaidRankingRewardExcelAddRewardParcelUniqueId(builder, rewardParcelUniqueId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueId), 0)
...
def EliminateRaidRankingRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def EliminateRaidRankingRewardExcelAddTier(builder, tier): builder.PrependInt32Slot(3, tier, 0)
def AddTier(builder, tier):
    return EliminateRaidRankingRewardExcelAddTier(builder, tier)
def EliminateRaidRankingRewardExcelAddPercentRankEnd(builder, percentRankEnd): builder.PrependInt64Slot(4, percentRankEnd, 0)
...
def EliminateRaidRankingRewardExcelAddPercentRankStart(builder, percentRankStart): builder.PrependInt64Slot(5, percentRankStart, 0)
...
def EliminateRaidRankingRewardExcelAddRankEnd(builder, rankEnd): builder.PrependInt64Slot(6, rankEnd, 0)
def AddRankEnd(builder, rankEnd):
    return EliminateRaidRankingRewardExcelAddRankEnd(builder, rankEnd)
def EliminateRaidRankingRewardExcelAddRankStart(builder, rankStart): builder.PrependInt64Slot(7, rankStart, 0)
def AddRankStart(builder, rankStart):
    return EliminateRaidRankingRewardExcelAddRankStart(builder, rankStart)
def EliminateRaidRankingRewardExcelAddId(builder, id): builder.PrependInt64Slot(8, id, 0)
def AddId(builder, id):
    return EliminateRaidRankingRewardExcelAddId(builder, id)
def EliminateRaidRankingRewardExcelAddRankingRewardGroupId(builder, rankingRewardGroupId): builder.PrependInt64Slot(9, rankingRewardGroupId, 0)
