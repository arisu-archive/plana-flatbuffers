...
def AssistSlotExcelAddSlotId(builder, slotId): builder.PrependInt64Slot(0, slotId, 0)
...
def AssistSlotExcelAddSlotNumber(builder, slotNumber): builder.PrependInt64Slot(2, slotNumber, 0)
def AddSlotNumber(builder, slotNumber):
    return AssistSlotExcelAddSlotNumber(builder, slotNumber)
def AssistSlotExcelAddAssistTermRewardPeriodFromSec(builder, assistTermRewardPeriodFromSec): builder.PrependInt64Slot(3, assistTermRewardPeriodFromSec, 0)
...
def AssistSlotExcelAddAssistRewardLimit(builder, assistRewardLimit): builder.PrependInt64Slot(4, assistRewardLimit, 0)
def AddAssistRewardLimit(builder, assistRewardLimit):
    return AssistSlotExcelAddAssistRewardLimit(builder, assistRewardLimit)
def AssistSlotExcelAddAssistRentRewardDailyMaxCount(builder, assistRentRewardDailyMaxCount): builder.PrependInt64Slot(5, assistRentRewardDailyMaxCount, 0)
...
def AssistSlotExcelAddAssistRentalFeeAmount(builder, assistRentalFeeAmount): builder.PrependInt64Slot(6, assistRentalFeeAmount, 0)
...
def AssistSlotExcelAddAssistRentalFeeAmountStranger(builder, assistRentalFeeAmountStranger): builder.PrependInt64Slot(7, assistRentalFeeAmountStranger, 0)
