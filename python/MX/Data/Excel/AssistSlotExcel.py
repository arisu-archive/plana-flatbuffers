...
def AssistSlotExcelAddAssistRentalFeeAmountStranger(builder, assistRentalFeeAmountStranger): builder.PrependInt64Slot(0, assistRentalFeeAmountStranger, 0)
...
def AssistSlotExcelAddAssistRentalFeeAmount(builder, assistRentalFeeAmount): builder.PrependInt64Slot(1, assistRentalFeeAmount, 0)
...
def AssistSlotExcelAddSlotNumber(builder, slotNumber): builder.PrependInt64Slot(5, slotNumber, 0)
def AddSlotNumber(builder, slotNumber):
    return AssistSlotExcelAddSlotNumber(builder, slotNumber)
def AssistSlotExcelAddEchelonType(builder, echelonType): builder.PrependInt32Slot(6, echelonType, 0)
def AddEchelonType(builder, echelonType):
    return AssistSlotExcelAddEchelonType(builder, echelonType)
def AssistSlotExcelAddSlotId(builder, slotId): builder.PrependInt64Slot(7, slotId, 0)
