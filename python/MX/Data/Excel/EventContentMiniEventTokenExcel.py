...
class EventContentMiniEventTokenExcelT(object):
    ...
    def __init__(
        ...
        self.maximumAmount = maximumAmount  # type: int

    @classmethod
    def InitFromBuf(cls, buf, pos):
        eventContentMiniEventTokenExcel = EventContentMiniEventTokenExcel()
        eventContentMiniEventTokenExcel.Init(buf, pos)
        return cls.InitFromObj(eventContentMiniEventTokenExcel)
    ...
    @classmethod
    def InitFromObj(cls, eventContentMiniEventTokenExcel):
        x = EventContentMiniEventTokenExcelT()
        x._UnPack(eventContentMiniEventTokenExcel)
        return x

    # EventContentMiniEventTokenExcelT
    def _UnPack(self, eventContentMiniEventTokenExcel):
        if eventContentMiniEventTokenExcel is None:
            return
        self.eventContentId = eventContentMiniEventTokenExcel.EventContentId()
        self.itemUniqueId = eventContentMiniEventTokenExcel.ItemUniqueId()
        self.maximumAmount = eventContentMiniEventTokenExcel.MaximumAmount()

    # EventContentMiniEventTokenExcelT
    def Pack(self, builder):
        EventContentMiniEventTokenExcelStart(builder)
        EventContentMiniEventTokenExcelAddEventContentId(builder, self.eventContentId)
        EventContentMiniEventTokenExcelAddItemUniqueId(builder, self.itemUniqueId)
        EventContentMiniEventTokenExcelAddMaximumAmount(builder, self.maximumAmount)
        eventContentMiniEventTokenExcel = EventContentMiniEventTokenExcelEnd(builder)
