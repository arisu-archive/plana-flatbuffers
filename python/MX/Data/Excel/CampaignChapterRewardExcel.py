...
def CampaignChapterRewardExcelAddChapterRewardAmount(builder, chapterRewardAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(chapterRewardAmount), 0)
...
def CampaignChapterRewardExcelAddChapterRewardId(builder, chapterRewardId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(chapterRewardId), 0)
...
def CampaignChapterRewardExcelAddCampaignChapterStar(builder, campaignChapterStar): builder.PrependInt64Slot(3, campaignChapterStar, 0)
