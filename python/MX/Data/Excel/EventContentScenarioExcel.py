...
def EventContentScenarioExcelAddClearedScenarioGroupId(builder, clearedScenarioGroupId): builder.PrependInt64Slot(0, clearedScenarioGroupId, 0)
...
def EventContentScenarioExcelAddConditionAmount(builder, conditionAmount): builder.PrependInt64Slot(1, conditionAmount, 0)
def AddConditionAmount(builder, conditionAmount):
    return EventContentScenarioExcelAddConditionAmount(builder, conditionAmount)
def EventContentScenarioExcelAddConditionEventContentId(builder, conditionEventContentId): builder.PrependInt64Slot(2, conditionEventContentId, 0)
...
def EventContentScenarioExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentScenarioExcelAddEventContentId(builder, eventContentId)
def EventContentScenarioExcelAddId(builder, id): builder.PrependInt64Slot(4, id, 0)
def AddId(builder, id):
    return EventContentScenarioExcelAddId(builder, id)
def EventContentScenarioExcelAddIsMeetup(builder, isMeetup): builder.PrependBoolSlot(5, isMeetup, 0)
def AddIsMeetup(builder, isMeetup):
    return EventContentScenarioExcelAddIsMeetup(builder, isMeetup)
def EventContentScenarioExcelAddIsOmnibus(builder, isOmnibus): builder.PrependBoolSlot(6, isOmnibus, 0)
def AddIsOmnibus(builder, isOmnibus):
    return EventContentScenarioExcelAddIsOmnibus(builder, isOmnibus)
def EventContentScenarioExcelAddIsRecollection(builder, isRecollection): builder.PrependBoolSlot(7, isRecollection, 0)
def AddIsRecollection(builder, isRecollection):
    return EventContentScenarioExcelAddIsRecollection(builder, isRecollection)
def EventContentScenarioExcelAddIsRecollectionHorizon(builder, isRecollectionHorizon): builder.PrependBoolSlot(8, isRecollectionHorizon, 0)
...
def EventContentScenarioExcelAddOrder(builder, order): builder.PrependInt64Slot(9, order, 0)
def AddOrder(builder, order):
    return EventContentScenarioExcelAddOrder(builder, order)
def EventContentScenarioExcelAddRecollectionNumber(builder, recollectionNumber): builder.PrependInt64Slot(10, recollectionNumber, 0)
...
def EventContentScenarioExcelAddRecollectionResource(builder, recollectionResource): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(recollectionResource), 0)
...
def EventContentScenarioExcelAddRecollectionSummaryLocalizeScenarioId(builder, recollectionSummaryLocalizeScenarioId): builder.PrependUint32Slot(12, recollectionSummaryLocalizeScenarioId, 0)
...
def EventContentScenarioExcelAddReplayDisplayGroup(builder, replayDisplayGroup): builder.PrependInt32Slot(13, replayDisplayGroup, 0)
...
def EventContentScenarioExcelAddRewardAmount(builder, rewardAmount): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(rewardAmount), 0)
...
def EventContentScenarioExcelAddRewardId(builder, rewardId): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(rewardId), 0)
...
def EventContentScenarioExcelAddScenarioConditionType(builder, scenarioConditionType): builder.PrependInt32Slot(17, scenarioConditionType, 0)
...
def EventContentScenarioExcelAddScenarioGroupId(builder, scenarioGroupId): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(scenarioGroupId), 0)
