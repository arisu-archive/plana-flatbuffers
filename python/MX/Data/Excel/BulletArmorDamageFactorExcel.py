...
def BulletArmorDamageFactorExcelAddShowHighlightFloater(builder, showHighlightFloater): builder.PrependBoolSlot(0, showHighlightFloater, 0)
...
def BulletArmorDamageFactorExcelAddMaxDamageRate(builder, maxDamageRate): builder.PrependInt64Slot(1, maxDamageRate, 0)
def AddMaxDamageRate(builder, maxDamageRate):
    return BulletArmorDamageFactorExcelAddMaxDamageRate(builder, maxDamageRate)
def BulletArmorDamageFactorExcelAddMinDamageRate(builder, minDamageRate): builder.PrependInt64Slot(2, minDamageRate, 0)
def AddMinDamageRate(builder, minDamageRate):
    return BulletArmorDamageFactorExcelAddMinDamageRate(builder, minDamageRate)
def BulletArmorDamageFactorExcelAddDamageAttribute(builder, damageAttribute): builder.PrependInt32Slot(3, damageAttribute, 0)
...
def BulletArmorDamageFactorExcelAddDamageRate(builder, damageRate): builder.PrependInt64Slot(4, damageRate, 0)
def AddDamageRate(builder, damageRate):
    return BulletArmorDamageFactorExcelAddDamageRate(builder, damageRate)
def BulletArmorDamageFactorExcelAddArmorType(builder, armorType): builder.PrependInt32Slot(5, armorType, 0)
def AddArmorType(builder, armorType):
    return BulletArmorDamageFactorExcelAddArmorType(builder, armorType)
def BulletArmorDamageFactorExcelAddBulletType(builder, bulletType): builder.PrependInt32Slot(6, bulletType, 0)
def AddBulletType(builder, bulletType):
    return BulletArmorDamageFactorExcelAddBulletType(builder, bulletType)
def BulletArmorDamageFactorExcelAddDamageFactorGroupId(builder, damageFactorGroupId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(damageFactorGroupId), 0)
