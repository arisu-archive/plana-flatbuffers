...
def CharacterStatsTransExcelAddStatTransType(builder, statTransType): builder.PrependInt32Slot(0, statTransType, 0)
def AddStatTransType(builder, statTransType):
    return CharacterStatsTransExcelAddStatTransType(builder, statTransType)
def CharacterStatsTransExcelAddTransSupportStatsFactor(builder, transSupportStatsFactor): builder.PrependInt32Slot(1, transSupportStatsFactor, 0)
...
def CharacterStatsTransExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(2, echelonExtensionType, 0)
...
def CharacterStatsTransExcelAddTransSupportStats(builder, transSupportStats): builder.PrependInt32Slot(3, transSupportStats, 0)
