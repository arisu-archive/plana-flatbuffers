...
def FloaterCommonExcelAddFloaterRandomPosRangeY(builder, floaterRandomPosRangeY): builder.PrependInt32Slot(0, floaterRandomPosRangeY, 0)
...
def FloaterCommonExcelAddFloaterRandomPosRangeX(builder, floaterRandomPosRangeX): builder.PrependInt32Slot(1, floaterRandomPosRangeX, 0)
...
def FloaterCommonExcelAddFloaterOffsetPosY(builder, floaterOffsetPosY): builder.PrependInt32Slot(2, floaterOffsetPosY, 0)
...
def FloaterCommonExcelAddFloaterOffsetPosX(builder, floaterOffsetPosX): builder.PrependInt32Slot(3, floaterOffsetPosX, 0)
...
def FloaterCommonExcelAddTacticEntityType(builder, tacticEntityType): builder.PrependInt32Slot(4, tacticEntityType, 0)
def AddTacticEntityType(builder, tacticEntityType):
    return FloaterCommonExcelAddTacticEntityType(builder, tacticEntityType)
def FloaterCommonExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
