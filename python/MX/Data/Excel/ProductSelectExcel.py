...
def ProductSelectExcelAddProductSelectionSlot(builder, productSelectionSlot): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(productSelectionSlot), 0)
...
def ProductSelectExcelAddPurchasePeriodLimit(builder, purchasePeriodLimit): builder.PrependInt64Slot(4, purchasePeriodLimit, 0)
...
def ProductSelectExcelAddPriceReference(builder, priceReference): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(priceReference), 0)
def AddPriceReference(builder, priceReference):
    return ProductSelectExcelAddPriceReference(builder, priceReference)
def ProductSelectExcelAddPrice(builder, price): builder.PrependInt64Slot(7, price, 0)
def AddPrice(builder, price):
    return ProductSelectExcelAddPrice(builder, price)
def ProductSelectExcelAddStoreType(builder, storeType): builder.PrependInt32Slot(8, storeType, 0)
def AddStoreType(builder, storeType):
    return ProductSelectExcelAddStoreType(builder, storeType)
def ProductSelectExcelAddProductId(builder, productId): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(productId), 0)
def AddProductId(builder, productId):
    return ProductSelectExcelAddProductId(builder, productId)
def ProductSelectExcelAddId(builder, id): builder.PrependInt64Slot(10, id, 0)
