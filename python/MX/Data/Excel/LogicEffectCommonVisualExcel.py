...
def LogicEffectCommonVisualExcelAddIconDispelColor(builder, iconDispelColor): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(iconDispelColor), 0)
...
def LogicEffectCommonVisualExcelAddParticleApplyPath(builder, particleApplyPath): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(particleApplyPath), 0)
...
def LogicEffectCommonVisualExcelAddParticleApplySocket(builder, particleApplySocket): builder.PrependInt32Slot(3, particleApplySocket, 0)
...
def LogicEffectCommonVisualExcelAddParticleEndPath(builder, particleEndPath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(particleEndPath), 0)
...
def LogicEffectCommonVisualExcelAddParticleEndSocket(builder, particleEndSocket): builder.PrependInt32Slot(5, particleEndSocket, 0)
...
def LogicEffectCommonVisualExcelAddParticleEnterPath(builder, particleEnterPath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(particleEnterPath), 0)
...
def LogicEffectCommonVisualExcelAddParticleEnterSocket(builder, particleEnterSocket): builder.PrependInt32Slot(7, particleEnterSocket, 0)
...
def LogicEffectCommonVisualExcelAddParticleLoopPath(builder, particleLoopPath): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(particleLoopPath), 0)
...
def LogicEffectCommonVisualExcelAddParticleLoopSocket(builder, particleLoopSocket): builder.PrependInt32Slot(9, particleLoopSocket, 0)
...
def LogicEffectCommonVisualExcelAddParticleRemovedPath(builder, particleRemovedPath): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(particleRemovedPath), 0)
...
def LogicEffectCommonVisualExcelAddParticleRemovedSocket(builder, particleRemovedSocket): builder.PrependInt32Slot(11, particleRemovedSocket, 0)
