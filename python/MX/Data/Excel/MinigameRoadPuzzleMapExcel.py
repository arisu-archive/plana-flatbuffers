...
def MinigameRoadPuzzleMapExcelAddAvailableRailTileAmount(builder, availableRailTileAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(availableRailTileAmount), 0)
...
def MinigameRoadPuzzleMapExcelAddAvailableRailTile(builder, availableRailTile): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(availableRailTile), 0)
...
def MinigameRoadPuzzleMapExcelAddBgmId(builder, bgmId): builder.PrependInt64Slot(2, bgmId, 0)
def AddBgmId(builder, bgmId):
    return MinigameRoadPuzzleMapExcelAddBgmId(builder, bgmId)
def MinigameRoadPuzzleMapExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MinigameRoadPuzzleMapExcelAddEventContentId(builder, eventContentId)
def MinigameRoadPuzzleMapExcelAddMap(builder, map): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(map), 0)
def AddMap(builder, map):
    return MinigameRoadPuzzleMapExcelAddMap(builder, map)
def MinigameRoadPuzzleMapExcelAddMapBg(builder, mapBg): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(mapBg), 0)
...
def MinigameRoadPuzzleMapExcelAddOriginalTileCount(builder, originalTileCount): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(originalTileCount), 0)
...
def MinigameRoadPuzzleMapExcelAddTrainSpeed(builder, trainSpeed): builder.PrependFloat32Slot(8, trainSpeed, 0.0)
def AddTrainSpeed(builder, trainSpeed):
    return MinigameRoadPuzzleMapExcelAddTrainSpeed(builder, trainSpeed)
def MinigameRoadPuzzleMapExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(9, uniqueId, 0)
