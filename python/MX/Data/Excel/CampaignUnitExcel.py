...
def CampaignUnitExcelAddIsTacticSkip(builder, isTacticSkip): builder.PrependBoolSlot(0, isTacticSkip, 0)
def AddIsTacticSkip(builder, isTacticSkip):
    return CampaignUnitExcelAddIsTacticSkip(builder, isTacticSkip)
def CampaignUnitExcelAddScale(builder, scale): builder.PrependFloat32Slot(1, scale, 0.0)
def AddScale(builder, scale):
    return CampaignUnitExcelAddScale(builder, scale)
def CampaignUnitExcelAddEnvironmentType(builder, environmentType): builder.PrependInt32Slot(2, environmentType, 0)
def AddEnvironmentType(builder, environmentType):
    return CampaignUnitExcelAddEnvironmentType(builder, environmentType)
def CampaignUnitExcelAddGrade(builder, grade): builder.PrependInt32Slot(3, grade, 0)
def AddGrade(builder, grade):
    return CampaignUnitExcelAddGrade(builder, grade)
def CampaignUnitExcelAddAiMoveType(builder, aiMoveType): builder.PrependInt32Slot(4, aiMoveType, 0)
def AddAiMoveType(builder, aiMoveType):
    return CampaignUnitExcelAddAiMoveType(builder, aiMoveType)
def CampaignUnitExcelAddMoveRange(builder, moveRange): builder.PrependInt32Slot(5, moveRange, 0)
def AddMoveRange(builder, moveRange):
    return CampaignUnitExcelAddMoveRange(builder, moveRange)
def CampaignUnitExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(6, groundId, 0)
def AddGroundId(builder, groundId):
    return CampaignUnitExcelAddGroundId(builder, groundId)
def CampaignUnitExcelAddClearScenarioGroupId(builder, clearScenarioGroupId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(clearScenarioGroupId), 0)
...
def CampaignUnitExcelAddStrategyPrefabName(builder, strategyPrefabName): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(strategyPrefabName), 0)
...
def CampaignUnitExcelAddPrefabName(builder, prefabName): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(prefabName), 0)
def AddPrefabName(builder, prefabName):
    return CampaignUnitExcelAddPrefabName(builder, prefabName)
def CampaignUnitExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return CampaignUnitExcelAddName(builder, name)
def CampaignUnitExcelAddKey(builder, key): builder.PrependUint32Slot(12, key, 0)
def AddKey(builder, key):
    return CampaignUnitExcelAddKey(builder, key)
def CampaignUnitExcelAddId(builder, id): builder.PrependInt64Slot(13, id, 0)
