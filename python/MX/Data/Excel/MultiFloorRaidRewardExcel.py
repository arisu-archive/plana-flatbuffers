...
def MultiFloorRaidRewardExcelAddClearStageRewardParcelUniqueId(builder, clearStageRewardParcelUniqueId): builder.PrependInt64Slot(1, clearStageRewardParcelUniqueId, 0)
