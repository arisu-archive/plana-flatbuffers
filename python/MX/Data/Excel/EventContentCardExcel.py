...
def EventContentCardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def EventContentCardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def EventContentCardExcelAddBackIconPath(builder, backIconPath): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(backIconPath), 0)
...
def EventContentCardExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(4, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EventContentCardExcelAddLocalizeEtcId(builder, localizeEtcId)
def EventContentCardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(5, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentCardExcelAddEventContentId(builder, eventContentId)
def EventContentCardExcelAddCardGroupId(builder, cardGroupId): builder.PrependInt32Slot(6, cardGroupId, 0)
