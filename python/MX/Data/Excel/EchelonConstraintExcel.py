...
def EchelonConstraintExcelAddRole(builder, role): builder.PrependInt32Slot(0, role, 0)
...
def EchelonConstraintExcelAddSchool(builder, school): builder.PrependInt32Slot(2, school, 0)
def AddSchool(builder, school):
    return EchelonConstraintExcelAddSchool(builder, school)
def EchelonConstraintExcelAddWeaponType(builder, weaponType): builder.PrependInt32Slot(3, weaponType, 0)
...
def EchelonConstraintExcelAddCharacterId(builder, characterId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(characterId), 0)
...
def EchelonConstraintExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(7, groupId, 0)
