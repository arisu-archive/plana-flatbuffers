...
def RecipeExcelAddResultAmountMax(builder, resultAmountMax): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(resultAmountMax), 0)
...
def RecipeExcelAddResultAmountMin(builder, resultAmountMin): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(resultAmountMin), 0)
...
def RecipeExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
...
def RecipeExcelAddParcelType(builder, parcelType): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(parcelType), 0)
...
def RecipeExcelAddRecipeSelectionGroupId(builder, recipeSelectionGroupId): builder.PrependInt64Slot(4, recipeSelectionGroupId, 0)
...
def RecipeExcelAddRecipeIngredientId(builder, recipeIngredientId): builder.PrependInt64Slot(5, recipeIngredientId, 0)
def AddRecipeIngredientId(builder, recipeIngredientId):
    return RecipeExcelAddRecipeIngredientId(builder, recipeIngredientId)
def RecipeExcelAddRecipeType(builder, recipeType): builder.PrependInt32Slot(6, recipeType, 0)
def AddRecipeType(builder, recipeType):
    return RecipeExcelAddRecipeType(builder, recipeType)
def RecipeExcelAddId(builder, id): builder.PrependInt64Slot(7, id, 0)
