...
class EventContentStageRewardExcelT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        ...
        eventContentStageRewardExcel.Init(buf, pos)
        return cls.InitFromObj(eventContentStageRewardExcel)
    ...
    @classmethod
    def InitFromObj(cls, eventContentStageRewardExcel):
        x = EventContentStageRewardExcelT()
        x._UnPack(eventContentStageRewardExcel)
        return x

    # EventContentStageRewardExcelT
    def _UnPack(self, eventContentStageRewardExcel):
        if eventContentStageRewardExcel is None:
            return
        self.groupId = eventContentStageRewardExcel.GroupId()
        self.rewardTag = eventContentStageRewardExcel.RewardTag()
        self.rewardProb = eventContentStageRewardExcel.RewardProb()
        self.rewardParcelType = eventContentStageRewardExcel.RewardParcelType()
        self.rewardId = eventContentStageRewardExcel.RewardId()
        self.rewardAmount = eventContentStageRewardExcel.RewardAmount()
        self.isDisplayed = eventContentStageRewardExcel.IsDisplayed()

    # EventContentStageRewardExcelT
    def Pack(self, builder):
        EventContentStageRewardExcelStart(builder)
        EventContentStageRewardExcelAddGroupId(builder, self.groupId)
        EventContentStageRewardExcelAddRewardTag(builder, self.rewardTag)
        EventContentStageRewardExcelAddRewardProb(builder, self.rewardProb)
        EventContentStageRewardExcelAddRewardParcelType(builder, self.rewardParcelType)
        EventContentStageRewardExcelAddRewardId(builder, self.rewardId)
        EventContentStageRewardExcelAddRewardAmount(builder, self.rewardAmount)
        EventContentStageRewardExcelAddIsDisplayed(builder, self.isDisplayed)
        eventContentStageRewardExcel = EventContentStageRewardExcelEnd(builder)
