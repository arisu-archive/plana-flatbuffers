...
def MinigameTBGEncounterRewardExcelAddAmount(builder, amount): builder.PrependInt64Slot(0, amount, 0)
def AddAmount(builder, amount):
    return MinigameTBGEncounterRewardExcelAddAmount(builder, amount)
def MinigameTBGEncounterRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(1, groupId, 0)
...
def MinigameTBGEncounterRewardExcelAddProb(builder, prob): builder.PrependInt32Slot(5, prob, 0)
def AddProb(builder, prob):
    return MinigameTBGEncounterRewardExcelAddProb(builder, prob)
def MinigameTBGEncounterRewardExcelAddTbgOptionSuccessType(builder, tbgOptionSuccessType): builder.PrependInt32Slot(6, tbgOptionSuccessType, 0)
...
def MinigameTBGEncounterRewardExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(7, uniqueId, 0)
