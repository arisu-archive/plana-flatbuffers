...
def WorldRaidStageRewardExcelAddClearStageRewardParcelUniqueId(builder, clearStageRewardParcelUniqueId): builder.PrependInt64Slot(1, clearStageRewardParcelUniqueId, 0)
...
def WorldRaidStageRewardExcelAddClearStageRewardParcelType(builder, clearStageRewardParcelType): builder.PrependInt32Slot(2, clearStageRewardParcelType, 0)
...
def WorldRaidStageRewardExcelAddIsClearStageRewardHideInfo(builder, isClearStageRewardHideInfo): builder.PrependBoolSlot(4, isClearStageRewardHideInfo, 0)
...
def WorldRaidStageRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(5, groupId, 0)
