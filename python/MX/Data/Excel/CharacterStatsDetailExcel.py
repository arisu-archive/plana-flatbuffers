...
def CharacterStatsDetailExcelAddIsStatsPercent(builder, isStatsPercent): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(isStatsPercent), 0)
...
def CharacterStatsDetailExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
