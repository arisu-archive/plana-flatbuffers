...
def EventContentCardShopExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def EventContentCardShopExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def EventContentCardShopExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def EventContentCardShopExcelAddProbWeight1(builder, probWeight1): builder.PrependInt32Slot(3, probWeight1, 0)
def AddProbWeight1(builder, probWeight1):
    return EventContentCardShopExcelAddProbWeight1(builder, probWeight1)
def EventContentCardShopExcelAddProb(builder, prob): builder.PrependInt32Slot(4, prob, 0)
def AddProb(builder, prob):
    return EventContentCardShopExcelAddProb(builder, prob)
def EventContentCardShopExcelAddRefreshGroup(builder, refreshGroup): builder.PrependInt32Slot(5, refreshGroup, 0)
def AddRefreshGroup(builder, refreshGroup):
    return EventContentCardShopExcelAddRefreshGroup(builder, refreshGroup)
def EventContentCardShopExcelAddIsLegacy(builder, isLegacy): builder.PrependBoolSlot(6, isLegacy, 0)
def AddIsLegacy(builder, isLegacy):
    return EventContentCardShopExcelAddIsLegacy(builder, isLegacy)
def EventContentCardShopExcelAddCardGroupId(builder, cardGroupId): builder.PrependInt32Slot(7, cardGroupId, 0)
def AddCardGroupId(builder, cardGroupId):
    return EventContentCardShopExcelAddCardGroupId(builder, cardGroupId)
def EventContentCardShopExcelAddCostGoodsId(builder, costGoodsId): builder.PrependInt64Slot(8, costGoodsId, 0)
def AddCostGoodsId(builder, costGoodsId):
    return EventContentCardShopExcelAddCostGoodsId(builder, costGoodsId)
def EventContentCardShopExcelAddRarity(builder, rarity): builder.PrependInt32Slot(9, rarity, 0)
def AddRarity(builder, rarity):
    return EventContentCardShopExcelAddRarity(builder, rarity)
def EventContentCardShopExcelAddId(builder, id): builder.PrependInt64Slot(10, id, 0)
def AddId(builder, id):
    return EventContentCardShopExcelAddId(builder, id)
def EventContentCardShopExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(11, eventContentId, 0)
