...
def CharacterVoiceSubtitleExcelAddLocalizeJp(builder, localizeJp): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(localizeJp), 0)
def AddLocalizeJp(builder, localizeJp):
    return CharacterVoiceSubtitleExcelAddLocalizeJp(builder, localizeJp)
def CharacterVoiceSubtitleExcelAddLocalizeKr(builder, localizeKr): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(localizeKr), 0)
def AddLocalizeKr(builder, localizeKr):
    return CharacterVoiceSubtitleExcelAddLocalizeKr(builder, localizeKr)
def CharacterVoiceSubtitleExcelAddSeparate(builder, separate): builder.PrependBoolSlot(2, separate, 0)
def AddSeparate(builder, separate):
    return CharacterVoiceSubtitleExcelAddSeparate(builder, separate)
def CharacterVoiceSubtitleExcelAddDuration(builder, duration): builder.PrependInt64Slot(3, duration, 0)
def AddDuration(builder, duration):
    return CharacterVoiceSubtitleExcelAddDuration(builder, duration)
def CharacterVoiceSubtitleExcelAddCharacterVoiceGroupId(builder, characterVoiceGroupId): builder.PrependInt64Slot(4, characterVoiceGroupId, 0)
...
def CharacterVoiceSubtitleExcelAddLocalizeCvGroup(builder, localizeCvGroup): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(localizeCvGroup), 0)
