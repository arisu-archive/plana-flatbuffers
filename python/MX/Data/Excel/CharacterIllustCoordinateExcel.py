...
def CharacterIllustCoordinateExcelAddMaxScale(builder, maxScale): builder.PrependFloat32Slot(0, maxScale, 0.0)
def AddMaxScale(builder, maxScale):
    return CharacterIllustCoordinateExcelAddMaxScale(builder, maxScale)
def CharacterIllustCoordinateExcelAddMinScale(builder, minScale): builder.PrependFloat32Slot(1, minScale, 0.0)
...
def CharacterIllustCoordinateExcelAddCharacterBodyCenterY(builder, characterBodyCenterY): builder.PrependFloat32Slot(3, characterBodyCenterY, 0.0)
...
def CharacterIllustCoordinateExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
