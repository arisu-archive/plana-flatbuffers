...
def EventContentNotifyExcelAddIsShortcutEnable(builder, isShortcutEnable): builder.PrependBoolSlot(0, isShortcutEnable, 0)
...
def EventContentNotifyExcelAddShortcutEventTargetType(builder, shortcutEventTargetType): builder.PrependInt32Slot(1, shortcutEventTargetType, 0)
...
def EventContentNotifyExcelAddEventTargetType(builder, eventTargetType): builder.PrependInt32Slot(2, eventTargetType, 0)
...
def EventContentNotifyExcelAddIconPath(builder, iconPath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(iconPath), 0)
...
def EventContentNotifyExcelAddId(builder, id): builder.PrependInt32Slot(6, id, 0)
