...
def MinigameCCGLevelNodeExcelAddNextNodeId(builder, nextNodeId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(nextNodeId), 0)
...
def MinigameCCGLevelNodeExcelAddStageGroupId(builder, stageGroupId): builder.PrependInt64Slot(4, stageGroupId, 0)
