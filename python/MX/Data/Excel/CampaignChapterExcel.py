...
def CampaignChapterExcelAddIsTacticSkip(builder, isTacticSkip): builder.PrependBoolSlot(0, isTacticSkip, 0)
def AddIsTacticSkip(builder, isTacticSkip):
    return CampaignChapterExcelAddIsTacticSkip(builder, isTacticSkip)
def CampaignChapterExcelAddVeryHardCampaignStageId(builder, veryHardCampaignStageId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(veryHardCampaignStageId), 0)
...
def CampaignChapterExcelAddHardCampaignStageId(builder, hardCampaignStageId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(hardCampaignStageId), 0)
...
def CampaignChapterExcelAddNormalExtraStageId(builder, normalExtraStageId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(normalExtraStageId), 0)
...
def CampaignChapterExcelAddNormalCampaignStageId(builder, normalCampaignStageId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(normalCampaignStageId), 0)
...
def CampaignChapterExcelAddChapterVeryHardRewardId(builder, chapterVeryHardRewardId): builder.PrependInt64Slot(5, chapterVeryHardRewardId, 0)
...
def CampaignChapterExcelAddChapterHardRewardId(builder, chapterHardRewardId): builder.PrependInt64Slot(6, chapterHardRewardId, 0)
...
def CampaignChapterExcelAddChapterRewardId(builder, chapterRewardId): builder.PrependInt64Slot(7, chapterRewardId, 0)
def AddChapterRewardId(builder, chapterRewardId):
    return CampaignChapterExcelAddChapterRewardId(builder, chapterRewardId)
def CampaignChapterExcelAddPreChapterId(builder, preChapterId): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(preChapterId), 0)
...
def CampaignChapterExcelAddOrder(builder, order): builder.PrependInt64Slot(9, order, 0)
def AddOrder(builder, order):
    return CampaignChapterExcelAddOrder(builder, order)
def CampaignChapterExcelAddHardImagePath(builder, hardImagePath): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(hardImagePath), 0)
def AddHardImagePath(builder, hardImagePath):
    return CampaignChapterExcelAddHardImagePath(builder, hardImagePath)
def CampaignChapterExcelAddNormalImagePath(builder, normalImagePath): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(normalImagePath), 0)
def AddNormalImagePath(builder, normalImagePath):
    return CampaignChapterExcelAddNormalImagePath(builder, normalImagePath)
def CampaignChapterExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return CampaignChapterExcelAddName(builder, name)
def CampaignChapterExcelAddId(builder, id): builder.PrependInt64Slot(13, id, 0)
