...
def AcademyZoneExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def AcademyZoneExcelAddRewardGroupId(builder, rewardGroupId): builder.PrependInt64Slot(1, rewardGroupId, 0)
def AddRewardGroupId(builder, rewardGroupId):
    return AcademyZoneExcelAddRewardGroupId(builder, rewardGroupId)
def AcademyZoneExcelAddStudentVisitProb(builder, studentVisitProb): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(studentVisitProb), 0)
...
def AcademyZoneExcelAddLocationRankForUnlock(builder, locationRankForUnlock): builder.PrependInt64Slot(4, locationRankForUnlock, 0)
...
def AcademyZoneExcelAddLocationId(builder, locationId): builder.PrependInt64Slot(5, locationId, 0)
def AddLocationId(builder, locationId):
    return AcademyZoneExcelAddLocationId(builder, locationId)
def AcademyZoneExcelAddId(builder, id): builder.PrependInt64Slot(6, id, 0)
