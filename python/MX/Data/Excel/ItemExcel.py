...
def ItemExcelAddGachaTicket(builder, gachaTicket): builder.PrependInt32Slot(0, gachaTicket, 0)
def AddGachaTicket(builder, gachaTicket):
    return ItemExcelAddGachaTicket(builder, gachaTicket)
def ItemExcelAddShortcutTypeId(builder, shortcutTypeId): builder.PrependInt64Slot(1, shortcutTypeId, 0)
def AddShortcutTypeId(builder, shortcutTypeId):
    return ItemExcelAddShortcutTypeId(builder, shortcutTypeId)
def ItemExcelAddExpirationNotifyDateIn(builder, expirationNotifyDateIn): builder.PrependInt32Slot(2, expirationNotifyDateIn, 0)
...
def ItemExcelAddExpirationDateTime(builder, expirationDateTime): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(expirationDateTime), 0)
def AddExpirationDateTime(builder, expirationDateTime):
    return ItemExcelAddExpirationDateTime(builder, expirationDateTime)
def ItemExcelAddShopCategory(builder, shopCategory): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(shopCategory), 0)
...
def ItemExcelAddMaxGiftTags(builder, maxGiftTags): builder.PrependInt32Slot(5, maxGiftTags, 0)
def AddMaxGiftTags(builder, maxGiftTags):
    return ItemExcelAddMaxGiftTags(builder, maxGiftTags)
def ItemExcelAddShiftingCraftQuality(builder, shiftingCraftQuality): builder.PrependInt64Slot(6, shiftingCraftQuality, 0)
...
def ItemExcelAddCraftQualityTier2(builder, craftQualityTier2): builder.PrependInt64Slot(7, craftQualityTier2, 0)
def AddCraftQualityTier2(builder, craftQualityTier2):
    return ItemExcelAddCraftQualityTier2(builder, craftQualityTier2)
def ItemExcelAddCraftQualityTier1(builder, craftQualityTier1): builder.PrependInt64Slot(8, craftQualityTier1, 0)
def AddCraftQualityTier1(builder, craftQualityTier1):
    return ItemExcelAddCraftQualityTier1(builder, craftQualityTier1)
def ItemExcelAddCraftQualityTier0(builder, craftQualityTier0): builder.PrependInt64Slot(9, craftQualityTier0, 0)
def AddCraftQualityTier0(builder, craftQualityTier0):
    return ItemExcelAddCraftQualityTier0(builder, craftQualityTier0)
def ItemExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def ItemExcelAddTierUpgradeRecipeCraftId(builder, tierUpgradeRecipeCraftId): builder.PrependInt64Slot(11, tierUpgradeRecipeCraftId, 0)
...
def ItemExcelAddCanTierUpgrade(builder, canTierUpgrade): builder.PrependBoolSlot(12, canTierUpgrade, 0)
def AddCanTierUpgrade(builder, canTierUpgrade):
    return ItemExcelAddCanTierUpgrade(builder, canTierUpgrade)
def ItemExcelAddExpiryChangeAmount(builder, expiryChangeAmount): builder.PrependInt64Slot(13, expiryChangeAmount, 0)
def AddExpiryChangeAmount(builder, expiryChangeAmount):
    return ItemExcelAddExpiryChangeAmount(builder, expiryChangeAmount)
def ItemExcelAddExpiryChangeId(builder, expiryChangeId): builder.PrependInt64Slot(14, expiryChangeId, 0)
def AddExpiryChangeId(builder, expiryChangeId):
    return ItemExcelAddExpiryChangeId(builder, expiryChangeId)
def ItemExcelAddExpiryChangeParcelType(builder, expiryChangeParcelType): builder.PrependInt32Slot(15, expiryChangeParcelType, 0)
...
def ItemExcelAddUsingResultAmount(builder, usingResultAmount): builder.PrependInt64Slot(17, usingResultAmount, 0)
def AddUsingResultAmount(builder, usingResultAmount):
    return ItemExcelAddUsingResultAmount(builder, usingResultAmount)
def ItemExcelAddUsingResultId(builder, usingResultId): builder.PrependInt64Slot(18, usingResultId, 0)
def AddUsingResultId(builder, usingResultId):
    return ItemExcelAddUsingResultId(builder, usingResultId)
def ItemExcelAddUsingResultParcelType(builder, usingResultParcelType): builder.PrependInt32Slot(19, usingResultParcelType, 0)
...
def ItemExcelAddImmediateUse(builder, immediateUse): builder.PrependBoolSlot(20, immediateUse, 0)
def AddImmediateUse(builder, immediateUse):
    return ItemExcelAddImmediateUse(builder, immediateUse)
def ItemExcelAddStackableFunction(builder, stackableFunction): builder.PrependInt32Slot(21, stackableFunction, 0)
def AddStackableFunction(builder, stackableFunction):
    return ItemExcelAddStackableFunction(builder, stackableFunction)
def ItemExcelAddStackableMax(builder, stackableMax): builder.PrependInt32Slot(22, stackableMax, 0)
def AddStackableMax(builder, stackableMax):
    return ItemExcelAddStackableMax(builder, stackableMax)
def ItemExcelAddSpriteName(builder, spriteName): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(spriteName), 0)
def AddSpriteName(builder, spriteName):
    return ItemExcelAddSpriteName(builder, spriteName)
def ItemExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
def AddIcon(builder, icon):
    return ItemExcelAddIcon(builder, icon)
def ItemExcelAddQuality(builder, quality): builder.PrependInt64Slot(25, quality, 0)
def AddQuality(builder, quality):
    return ItemExcelAddQuality(builder, quality)
def ItemExcelAddItemCategory(builder, itemCategory): builder.PrependInt32Slot(26, itemCategory, 0)
def AddItemCategory(builder, itemCategory):
    return ItemExcelAddItemCategory(builder, itemCategory)
def ItemExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(27, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return ItemExcelAddLocalizeEtcId(builder, localizeEtcId)
def ItemExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(28, productionStep, 0)
def AddProductionStep(builder, productionStep):
    return ItemExcelAddProductionStep(builder, productionStep)
def ItemExcelAddRarity(builder, rarity): builder.PrependInt32Slot(29, rarity, 0)
def AddRarity(builder, rarity):
    return ItemExcelAddRarity(builder, rarity)
def ItemExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(30, groupId, 0)
def AddGroupId(builder, groupId):
    return ItemExcelAddGroupId(builder, groupId)
def ItemExcelAddId(builder, id): builder.PrependInt64Slot(31, id, 0)
