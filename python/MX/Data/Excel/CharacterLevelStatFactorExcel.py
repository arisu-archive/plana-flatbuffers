...
class CharacterLevelStatFactorExcelT(object):
    ...
    def __init__(
        ...
        self.criticalFactor = criticalFactor  # type: int
        self.stabilityFactor = stabilityFactor  # type: int
        self.defenceFactor = defenceFactor  # type: int
        self.accuracyFactor = accuracyFactor  # type: int

    @classmethod
    def InitFromBuf(cls, buf, pos):
        characterLevelStatFactorExcel = CharacterLevelStatFactorExcel()
        characterLevelStatFactorExcel.Init(buf, pos)
        return cls.InitFromObj(characterLevelStatFactorExcel)
    ...
    @classmethod
    def InitFromObj(cls, characterLevelStatFactorExcel):
        x = CharacterLevelStatFactorExcelT()
        x._UnPack(characterLevelStatFactorExcel)
        return x

    # CharacterLevelStatFactorExcelT
    def _UnPack(self, characterLevelStatFactorExcel):
        if characterLevelStatFactorExcel is None:
            return
        self.level = characterLevelStatFactorExcel.Level()
        self.criticalFactor = characterLevelStatFactorExcel.CriticalFactor()
        self.stabilityFactor = characterLevelStatFactorExcel.StabilityFactor()
        self.defenceFactor = characterLevelStatFactorExcel.DefenceFactor()
        self.accuracyFactor = characterLevelStatFactorExcel.AccuracyFactor()

    # CharacterLevelStatFactorExcelT
    def Pack(self, builder):
        CharacterLevelStatFactorExcelStart(builder)
        CharacterLevelStatFactorExcelAddLevel(builder, self.level)
        CharacterLevelStatFactorExcelAddCriticalFactor(builder, self.criticalFactor)
        CharacterLevelStatFactorExcelAddStabilityFactor(builder, self.stabilityFactor)
        CharacterLevelStatFactorExcelAddDefenceFactor(builder, self.defenceFactor)
        CharacterLevelStatFactorExcelAddAccuracyFactor(builder, self.accuracyFactor)
        characterLevelStatFactorExcel = CharacterLevelStatFactorExcelEnd(builder)
