...
def CharacterSkillListExcelAddHiddenPassiveSkillGroupId(builder, hiddenPassiveSkillGroupId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(hiddenPassiveSkillGroupId), 0)
...
def CharacterSkillListExcelAddExtraPassiveSkillGroupId(builder, extraPassiveSkillGroupId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(extraPassiveSkillGroupId), 0)
...
def CharacterSkillListExcelAddLeaderSkillGroupId(builder, leaderSkillGroupId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(leaderSkillGroupId), 0)
...
def CharacterSkillListExcelAddPassiveSkillGroupId(builder, passiveSkillGroupId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(passiveSkillGroupId), 0)
...
def CharacterSkillListExcelAddPublicSkillTimeLineIndex(builder, publicSkillTimeLineIndex): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(publicSkillTimeLineIndex), 0)
...
def CharacterSkillListExcelAddPublicSkillGroupId(builder, publicSkillGroupId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(publicSkillGroupId), 0)
...
def CharacterSkillListExcelAddExSkillLevelTimeLineIndex(builder, exSkillLevelTimeLineIndex): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(exSkillLevelTimeLineIndex), 0)
...
def CharacterSkillListExcelAddExSkillCutInTimeLineIndex(builder, exSkillCutInTimeLineIndex): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(exSkillCutInTimeLineIndex), 0)
...
def CharacterSkillListExcelAddExSkillGroupId(builder, exSkillGroupId): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(exSkillGroupId), 0)
...
def CharacterSkillListExcelAddSelectExSkillActionSkillSlot(builder, selectExSkillActionSkillSlot): builder.PrependInt32Slot(9, selectExSkillActionSkillSlot, 0)
...
def CharacterSkillListExcelAddNormalSkillTimeLineIndex(builder, normalSkillTimeLineIndex): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(normalSkillTimeLineIndex), 0)
...
def CharacterSkillListExcelAddNormalSkillGroupId(builder, normalSkillGroupId): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(normalSkillGroupId), 0)
...
def CharacterSkillListExcelAddTsaInteractionId(builder, tsaInteractionId): builder.PrependInt64Slot(12, tsaInteractionId, 0)
...
def CharacterSkillListExcelAddUseRandomExSkillTimeline(builder, useRandomExSkillTimeline): builder.PrependBoolSlot(13, useRandomExSkillTimeline, 0)
...
def CharacterSkillListExcelAddIsMoveLeftRight(builder, isMoveLeftRight): builder.PrependBoolSlot(14, isMoveLeftRight, 0)
def AddIsMoveLeftRight(builder, isMoveLeftRight):
    return CharacterSkillListExcelAddIsMoveLeftRight(builder, isMoveLeftRight)
def CharacterSkillListExcelAddIsRootMotion(builder, isRootMotion): builder.PrependBoolSlot(15, isRootMotion, 0)
def AddIsRootMotion(builder, isRootMotion):
    return CharacterSkillListExcelAddIsRootMotion(builder, isRootMotion)
def CharacterSkillListExcelAddFormIndex(builder, formIndex): builder.PrependInt32Slot(16, formIndex, 0)
def AddFormIndex(builder, formIndex):
    return CharacterSkillListExcelAddFormIndex(builder, formIndex)
def CharacterSkillListExcelAddMinimumTierCharacterGear(builder, minimumTierCharacterGear): builder.PrependInt32Slot(17, minimumTierCharacterGear, 0)
...
def CharacterSkillListExcelAddMinimumGradeCharacterWeapon(builder, minimumGradeCharacterWeapon): builder.PrependInt32Slot(18, minimumGradeCharacterWeapon, 0)
...
def CharacterSkillListExcelAddCharacterSkillListGroupId(builder, characterSkillListGroupId): builder.PrependInt64Slot(19, characterSkillListGroupId, 0)
