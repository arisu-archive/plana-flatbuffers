...
def AcademyRewardExcelAddRewardAmount(builder, rewardAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardAmount), 0)
...
def AcademyRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def AcademyRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def AcademyRewardExcelAddIsExtraRewardDisplayed(builder, isExtraRewardDisplayed): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(isExtraRewardDisplayed), 0)
...
def AcademyRewardExcelAddExtraRewardProb(builder, extraRewardProb): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(extraRewardProb), 0)
...
def AcademyRewardExcelAddExtraRewardAmount(builder, extraRewardAmount): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(extraRewardAmount), 0)
...
def AcademyRewardExcelAddExtraRewardParcelId(builder, extraRewardParcelId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(extraRewardParcelId), 0)
...
def AcademyRewardExcelAddExtraRewardParcelType(builder, extraRewardParcelType): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(extraRewardParcelType), 0)
...
def AcademyRewardExcelAddExtraFavorExpProb(builder, extraFavorExpProb): builder.PrependInt64Slot(8, extraFavorExpProb, 0)
...
def AcademyRewardExcelAddExtraFavorExp(builder, extraFavorExp): builder.PrependInt64Slot(9, extraFavorExp, 0)
def AddExtraFavorExp(builder, extraFavorExp):
    return AcademyRewardExcelAddExtraFavorExp(builder, extraFavorExp)
def AcademyRewardExcelAddSecretStoneProb(builder, secretStoneProb): builder.PrependInt64Slot(10, secretStoneProb, 0)
def AddSecretStoneProb(builder, secretStoneProb):
    return AcademyRewardExcelAddSecretStoneProb(builder, secretStoneProb)
def AcademyRewardExcelAddSecretStoneAmount(builder, secretStoneAmount): builder.PrependInt64Slot(11, secretStoneAmount, 0)
...
def AcademyRewardExcelAddFavorExp(builder, favorExp): builder.PrependInt64Slot(12, favorExp, 0)
def AddFavorExp(builder, favorExp):
    return AcademyRewardExcelAddFavorExp(builder, favorExp)
def AcademyRewardExcelAddLocationRank(builder, locationRank): builder.PrependInt64Slot(13, locationRank, 0)
def AddLocationRank(builder, locationRank):
    return AcademyRewardExcelAddLocationRank(builder, locationRank)
def AcademyRewardExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(14, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return AcademyRewardExcelAddLocalizeEtcId(builder, localizeEtcId)
def AcademyRewardExcelAddProgressTexture(builder, progressTexture): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(progressTexture), 0)
def AddProgressTexture(builder, progressTexture):
    return AcademyRewardExcelAddProgressTexture(builder, progressTexture)
def AcademyRewardExcelAddId(builder, id): builder.PrependInt64Slot(16, id, 0)
def AddId(builder, id):
    return AcademyRewardExcelAddId(builder, id)
def AcademyRewardExcelAddOrderInGroup(builder, orderInGroup): builder.PrependInt64Slot(17, orderInGroup, 0)
def AddOrderInGroup(builder, orderInGroup):
    return AcademyRewardExcelAddOrderInGroup(builder, orderInGroup)
def AcademyRewardExcelAddScheduleGroupId(builder, scheduleGroupId): builder.PrependInt64Slot(18, scheduleGroupId, 0)
def AddScheduleGroupId(builder, scheduleGroupId):
    return AcademyRewardExcelAddScheduleGroupId(builder, scheduleGroupId)
def AcademyRewardExcelAddLocation(builder, location): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(location), 0)
