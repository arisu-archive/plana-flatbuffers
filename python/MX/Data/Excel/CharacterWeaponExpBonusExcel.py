...
def CharacterWeaponExpBonusExcelAddWeaponExpGrowthZ(builder, weaponExpGrowthZ): builder.PrependInt32Slot(0, weaponExpGrowthZ, 0)
...
def CharacterWeaponExpBonusExcelAddWeaponExpGrowthC(builder, weaponExpGrowthC): builder.PrependInt32Slot(1, weaponExpGrowthC, 0)
...
def CharacterWeaponExpBonusExcelAddWeaponExpGrowthA(builder, weaponExpGrowthA): builder.PrependInt32Slot(3, weaponExpGrowthA, 0)
