...
def CafeInfoExcelAddSummonParcelId(builder, summonParcelId): builder.PrependInt64Slot(5, summonParcelId, 0)
def AddSummonParcelId(builder, summonParcelId):
    return CafeInfoExcelAddSummonParcelId(builder, summonParcelId)
def CafeInfoExcelAddSummonParcelAmount(builder, summonParcelAmount): builder.PrependInt64Slot(6, summonParcelAmount, 0)
def AddSummonParcelAmount(builder, summonParcelAmount):
    return CafeInfoExcelAddSummonParcelAmount(builder, summonParcelAmount)
def CafeInfoExcelAddCategoryType(builder, categoryType): builder.PrependInt32Slot(7, categoryType, 0)
