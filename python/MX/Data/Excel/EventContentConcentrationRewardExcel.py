...
def EventContentConcentrationRewardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(0, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentConcentrationRewardExcelAddEventContentId(builder, eventContentId)
def EventContentConcentrationRewardExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(1, uniqueId, 0)
...
def EventContentConcentrationRewardExcelAddRound(builder, round): builder.PrependInt32Slot(5, round, 0)
def AddRound(builder, round):
    return EventContentConcentrationRewardExcelAddRound(builder, round)
def EventContentConcentrationRewardExcelAddIsLoop(builder, isLoop): builder.PrependBoolSlot(6, isLoop, 0)
...
def EventContentConcentrationRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def EventContentConcentrationRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
