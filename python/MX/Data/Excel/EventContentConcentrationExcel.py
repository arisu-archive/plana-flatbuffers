...
def EventContentConcentrationExcelAddInstantClearRound(builder, instantClearRound): builder.PrependInt32Slot(1, instantClearRound, 0)
...
def EventContentConcentrationExcelAddMaxCardOpenCount(builder, maxCardOpenCount): builder.PrependInt32Slot(2, maxCardOpenCount, 0)
...
def EventContentConcentrationExcelAddMaxCardPairCount(builder, maxCardPairCount): builder.PrependInt32Slot(3, maxCardPairCount, 0)
...
def EventContentConcentrationExcelAddCostGoodsId(builder, costGoodsId): builder.PrependInt64Slot(4, costGoodsId, 0)
def AddCostGoodsId(builder, costGoodsId):
    return EventContentConcentrationExcelAddCostGoodsId(builder, costGoodsId)
def EventContentConcentrationExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(5, eventContentId, 0)
