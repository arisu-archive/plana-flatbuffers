...
def EquipmentStatExcelAddTranscendenceMax(builder, transcendenceMax): builder.PrependInt32Slot(1, transcendenceMax, 0)
def AddTranscendenceMax(builder, transcendenceMax):
    return EquipmentStatExcelAddTranscendenceMax(builder, transcendenceMax)
def EquipmentStatExcelAddDefaultMaxLevel(builder, defaultMaxLevel): builder.PrependInt32Slot(2, defaultMaxLevel, 0)
def AddDefaultMaxLevel(builder, defaultMaxLevel):
    return EquipmentStatExcelAddDefaultMaxLevel(builder, defaultMaxLevel)
def EquipmentStatExcelAddLevelUpFeedAddExp(builder, levelUpFeedAddExp): builder.PrependInt64Slot(3, levelUpFeedAddExp, 0)
...
def EquipmentStatExcelAddEquipmentCategory(builder, equipmentCategory): builder.PrependInt32Slot(4, equipmentCategory, 0)
...
def EquipmentStatExcelAddStatType(builder, statType): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(statType), 0)
...
def EquipmentStatExcelAddStatLevelUpType(builder, statLevelUpType): builder.PrependInt32Slot(12, statLevelUpType, 0)
def AddStatLevelUpType(builder, statLevelUpType):
    return EquipmentStatExcelAddStatLevelUpType(builder, statLevelUpType)
def EquipmentStatExcelAddEquipmentId(builder, equipmentId): builder.PrependInt64Slot(13, equipmentId, 0)
