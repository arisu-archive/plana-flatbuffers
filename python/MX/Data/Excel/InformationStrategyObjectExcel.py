...
def InformationStrategyObjectExcelAddLocalizeCodeId(builder, localizeCodeId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(localizeCodeId), 0)
...
def InformationStrategyObjectExcelAddPageName(builder, pageName): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(pageName), 0)
def AddPageName(builder, pageName):
    return InformationStrategyObjectExcelAddPageName(builder, pageName)
def InformationStrategyObjectExcelAddStageId(builder, stageId): builder.PrependInt64Slot(2, stageId, 0)
def AddStageId(builder, stageId):
    return InformationStrategyObjectExcelAddStageId(builder, stageId)
def InformationStrategyObjectExcelAddId(builder, id): builder.PrependInt64Slot(3, id, 0)
