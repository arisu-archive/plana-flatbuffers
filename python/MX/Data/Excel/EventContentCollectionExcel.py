...
def EventContentCollectionExcelAddSubNameLocalizeCodeId(builder, subNameLocalizeCodeId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(subNameLocalizeCodeId), 0)
...
def EventContentCollectionExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(1, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EventContentCollectionExcelAddLocalizeEtcId(builder, localizeEtcId)
def EventContentCollectionExcelAddDecoration(builder, decoration): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(decoration), 0)
...
def EventContentCollectionExcelAddThumbResource(builder, thumbResource): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(thumbResource), 0)
def AddThumbResource(builder, thumbResource):
    return EventContentCollectionExcelAddThumbResource(builder, thumbResource)
def EventContentCollectionExcelAddEmblemResource(builder, emblemResource): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(emblemResource), 0)
...
def EventContentCollectionExcelAddIsObject(builder, isObject): builder.PrependBoolSlot(8, isObject, 0)
def AddIsObject(builder, isObject):
    return EventContentCollectionExcelAddIsObject(builder, isObject)
def EventContentCollectionExcelAddUnlockConditionCount(builder, unlockConditionCount): builder.PrependInt64Slot(9, unlockConditionCount, 0)
...
def EventContentCollectionExcelAddUnlockConditionParameter(builder, unlockConditionParameter): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(unlockConditionParameter), 0)
...
def EventContentCollectionExcelAddUnlockConditionType(builder, unlockConditionType): builder.PrependInt32Slot(12, unlockConditionType, 0)
...
def EventContentCollectionExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(13, groupId, 0)
def AddGroupId(builder, groupId):
    return EventContentCollectionExcelAddGroupId(builder, groupId)
def EventContentCollectionExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(14, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentCollectionExcelAddEventContentId(builder, eventContentId)
def EventContentCollectionExcelAddId(builder, id): builder.PrependInt64Slot(15, id, 0)
