...
def MiniGameShootingStageRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def MiniGameShootingStageRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def MiniGameShootingStageRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def MiniGameShootingStageRewardExcelAddClearSection(builder, clearSection): builder.PrependInt64Slot(3, clearSection, 0)
def AddClearSection(builder, clearSection):
    return MiniGameShootingStageRewardExcelAddClearSection(builder, clearSection)
def MiniGameShootingStageRewardExcelAddRewardId(builder, rewardId): builder.PrependInt64Slot(4, rewardId, 0)
def AddRewardId(builder, rewardId):
    return MiniGameShootingStageRewardExcelAddRewardId(builder, rewardId)
def MiniGameShootingStageRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(5, groupId, 0)
