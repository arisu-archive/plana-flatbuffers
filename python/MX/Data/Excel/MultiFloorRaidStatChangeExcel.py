...
def MultiFloorRaidStatChangeExcelAddApplyCharacterId(builder, applyCharacterId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(applyCharacterId), 0)
...
def MultiFloorRaidStatChangeExcelStartApplyCharacterIdVector(builder, numElems): return builder.StartVector(8, numElems, 8)
...
def MultiFloorRaidStatChangeExcelAddStatMultiply(builder, statMultiply): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(statMultiply), 0)
...
def MultiFloorRaidStatChangeExcelAddStatType(builder, statType): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(statType), 0)
...
def MultiFloorRaidStatChangeExcelAddStatChangeId(builder, statChangeId): builder.PrependInt64Slot(4, statChangeId, 0)
