...
def CharacterStatExcelAddEnhanceExDamageRate(builder, enhanceExDamageRate): builder.PrependInt64Slot(62, enhanceExDamageRate, 0)
...
def CharacterStatExcelAddReduceExDamagedRate(builder, reduceExDamagedRate): builder.PrependInt64Slot(63, reduceExDamagedRate, 0)
...
def CharacterStatExcelAddHealRate(builder, healRate): builder.PrependInt64Slot(64, healRate, 0)
def AddHealRate(builder, healRate):
    return CharacterStatExcelAddHealRate(builder, healRate)
def CharacterStatExcelAddHealLightArmorRate(builder, healLightArmorRate): builder.PrependInt64Slot(65, healLightArmorRate, 0)
...
def CharacterStatExcelAddHealHeavyArmorRate(builder, healHeavyArmorRate): builder.PrependInt64Slot(66, healHeavyArmorRate, 0)
...
def CharacterStatExcelAddHealUnarmedRate(builder, healUnarmedRate): builder.PrependInt64Slot(67, healUnarmedRate, 0)
def AddHealUnarmedRate(builder, healUnarmedRate):
    return CharacterStatExcelAddHealUnarmedRate(builder, healUnarmedRate)
def CharacterStatExcelAddHealElasticArmorRate(builder, healElasticArmorRate): builder.PrependInt64Slot(68, healElasticArmorRate, 0)
...
def CharacterStatExcelAddHealNormalArmorRate(builder, healNormalArmorRate): builder.PrependInt64Slot(69, healNormalArmorRate, 0)
...
def CharacterStatExcelAddHealedExplosionRate(builder, healedExplosionRate): builder.PrependInt64Slot(70, healedExplosionRate, 0)
...
def CharacterStatExcelAddHealedPierceRate(builder, healedPierceRate): builder.PrependInt64Slot(71, healedPierceRate, 0)
def AddHealedPierceRate(builder, healedPierceRate):
    return CharacterStatExcelAddHealedPierceRate(builder, healedPierceRate)
def CharacterStatExcelAddHealedMysticRate(builder, healedMysticRate): builder.PrependInt64Slot(72, healedMysticRate, 0)
def AddHealedMysticRate(builder, healedMysticRate):
    return CharacterStatExcelAddHealedMysticRate(builder, healedMysticRate)
def CharacterStatExcelAddHealedSonicRate(builder, healedSonicRate): builder.PrependInt64Slot(73, healedSonicRate, 0)
def AddHealedSonicRate(builder, healedSonicRate):
    return CharacterStatExcelAddHealedSonicRate(builder, healedSonicRate)
def CharacterStatExcelAddHealedNormalRate(builder, healedNormalRate): builder.PrependInt64Slot(74, healedNormalRate, 0)
def AddHealedNormalRate(builder, healedNormalRate):
    return CharacterStatExcelAddHealedNormalRate(builder, healedNormalRate)
def CharacterStatExcelAddStreetBattleAdaptation(builder, streetBattleAdaptation): builder.PrependInt32Slot(75, streetBattleAdaptation, 0)
...
def CharacterStatExcelAddOutdoorBattleAdaptation(builder, outdoorBattleAdaptation): builder.PrependInt32Slot(76, outdoorBattleAdaptation, 0)
...
def CharacterStatExcelAddIndoorBattleAdaptation(builder, indoorBattleAdaptation): builder.PrependInt32Slot(77, indoorBattleAdaptation, 0)
...
def CharacterStatExcelAddRegenCost(builder, regenCost): builder.PrependInt64Slot(78, regenCost, 0)
