...
def PossessionCheckExcelAddReplaceParcelAmount(builder, replaceParcelAmount): builder.PrependInt32Slot(0, replaceParcelAmount, 0)
...
def PossessionCheckExcelAddReplaceParcelId(builder, replaceParcelId): builder.PrependInt64Slot(1, replaceParcelId, 0)
def AddReplaceParcelId(builder, replaceParcelId):
    return PossessionCheckExcelAddReplaceParcelId(builder, replaceParcelId)
def PossessionCheckExcelAddReplaceParcelType(builder, replaceParcelType): builder.PrependInt32Slot(2, replaceParcelType, 0)
...
def PossessionCheckExcelAddDefaultParcelId(builder, defaultParcelId): builder.PrependInt64Slot(4, defaultParcelId, 0)
def AddDefaultParcelId(builder, defaultParcelId):
    return PossessionCheckExcelAddDefaultParcelId(builder, defaultParcelId)
def PossessionCheckExcelAddDefaultParcelType(builder, defaultParcelType): builder.PrependInt32Slot(5, defaultParcelType, 0)
