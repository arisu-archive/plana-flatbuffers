...
def FurnitureTemplateElementExcelAddFurnitureId(builder, furnitureId): builder.PrependInt64Slot(0, furnitureId, 0)
def AddFurnitureId(builder, furnitureId):
    return FurnitureTemplateElementExcelAddFurnitureId(builder, furnitureId)
def FurnitureTemplateElementExcelAddFurnitureTemplateId(builder, furnitureTemplateId): builder.PrependInt64Slot(1, furnitureTemplateId, 0)
...
def FurnitureTemplateElementExcelAddOrder(builder, order): builder.PrependInt64Slot(3, order, 0)
def AddOrder(builder, order):
    return FurnitureTemplateElementExcelAddOrder(builder, order)
def FurnitureTemplateElementExcelAddPositionX(builder, positionX): builder.PrependFloat32Slot(4, positionX, 0.0)
def AddPositionX(builder, positionX):
    return FurnitureTemplateElementExcelAddPositionX(builder, positionX)
def FurnitureTemplateElementExcelAddPositionY(builder, positionY): builder.PrependFloat32Slot(5, positionY, 0.0)
def AddPositionY(builder, positionY):
    return FurnitureTemplateElementExcelAddPositionY(builder, positionY)
def FurnitureTemplateElementExcelAddRotation(builder, rotation): builder.PrependFloat32Slot(6, rotation, 0.0)
