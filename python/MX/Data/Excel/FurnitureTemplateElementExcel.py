...
def FurnitureTemplateElementExcelAddOrder(builder, order): builder.PrependInt64Slot(0, order, 0)
def AddOrder(builder, order):
    return FurnitureTemplateElementExcelAddOrder(builder, order)
def FurnitureTemplateElementExcelAddRotation(builder, rotation): builder.PrependFloat32Slot(1, rotation, 0.0)
def AddRotation(builder, rotation):
    return FurnitureTemplateElementExcelAddRotation(builder, rotation)
def FurnitureTemplateElementExcelAddPositionY(builder, positionY): builder.PrependFloat32Slot(2, positionY, 0.0)
...
def FurnitureTemplateElementExcelAddLocation(builder, location): builder.PrependInt32Slot(4, location, 0)
def AddLocation(builder, location):
    return FurnitureTemplateElementExcelAddLocation(builder, location)
def FurnitureTemplateElementExcelAddFurnitureId(builder, furnitureId): builder.PrependInt64Slot(5, furnitureId, 0)
def AddFurnitureId(builder, furnitureId):
    return FurnitureTemplateElementExcelAddFurnitureId(builder, furnitureId)
def FurnitureTemplateElementExcelAddFurnitureTemplateId(builder, furnitureTemplateId): builder.PrependInt64Slot(6, furnitureTemplateId, 0)
