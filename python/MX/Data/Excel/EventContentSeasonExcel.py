...
def EventContentSeasonExcelAddEventContentCloseNoteTime(builder, eventContentCloseNoteTime): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(eventContentCloseNoteTime), 0)
...
def EventContentSeasonExcelAddEventContentCloseTime(builder, eventContentCloseTime): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(eventContentCloseTime), 0)
...
def EventContentSeasonExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(8, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentSeasonExcelAddEventContentId(builder, eventContentId)
def EventContentSeasonExcelAddEventContentOpenTime(builder, eventContentOpenTime): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(eventContentOpenTime), 0)
...
def EventContentSeasonExcelAddEventContentReleaseType(builder, eventContentReleaseType): builder.PrependInt32Slot(10, eventContentReleaseType, 0)
...
def EventContentSeasonExcelAddEventContentStageRewardIdPermanent(builder, eventContentStageRewardIdPermanent): builder.PrependInt64Slot(11, eventContentStageRewardIdPermanent, 0)
...
def EventContentSeasonExcelAddEventContentType(builder, eventContentType): builder.PrependInt32Slot(12, eventContentType, 0)
...
def EventContentSeasonExcelAddEventDisplay(builder, eventDisplay): builder.PrependBoolSlot(13, eventDisplay, 0)
def AddEventDisplay(builder, eventDisplay):
    return EventContentSeasonExcelAddEventDisplay(builder, eventDisplay)
def EventContentSeasonExcelAddEventItemId(builder, eventItemId): builder.PrependInt64Slot(14, eventItemId, 0)
def AddEventItemId(builder, eventItemId):
    return EventContentSeasonExcelAddEventItemId(builder, eventItemId)
def EventContentSeasonExcelAddExtensionTime(builder, extensionTime): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(extensionTime), 0)
def AddExtensionTime(builder, extensionTime):
    return EventContentSeasonExcelAddExtensionTime(builder, extensionTime)
def EventContentSeasonExcelAddIconOrder(builder, iconOrder): builder.PrependInt32Slot(16, iconOrder, 0)
def AddIconOrder(builder, iconOrder):
    return EventContentSeasonExcelAddIconOrder(builder, iconOrder)
def EventContentSeasonExcelAddIsReturn(builder, isReturn): builder.PrependBoolSlot(17, isReturn, 0)
def AddIsReturn(builder, isReturn):
    return EventContentSeasonExcelAddIsReturn(builder, isReturn)
def EventContentSeasonExcelAddMainBannerImagePath(builder, mainBannerImagePath): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(mainBannerImagePath), 0)
...
def EventContentSeasonExcelAddMainBgImagePath(builder, mainBgImagePath): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(mainBgImagePath), 0)
def AddMainBgImagePath(builder, mainBgImagePath):
    return EventContentSeasonExcelAddMainBgImagePath(builder, mainBgImagePath)
def EventContentSeasonExcelAddMainEventId(builder, mainEventId): builder.PrependInt64Slot(20, mainEventId, 0)
def AddMainEventId(builder, mainEventId):
    return EventContentSeasonExcelAddMainEventId(builder, mainEventId)
def EventContentSeasonExcelAddMainIconParcelPath(builder, mainIconParcelPath): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(mainIconParcelPath), 0)
...
def EventContentSeasonExcelAddMiniEventShortCutScenarioModeId(builder, miniEventShortCutScenarioModeId): builder.PrependInt64Slot(22, miniEventShortCutScenarioModeId, 0)
...
def EventContentSeasonExcelAddMinigameLobbyPrefabName(builder, minigameLobbyPrefabName): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(minigameLobbyPrefabName), 0)
...
def EventContentSeasonExcelAddMinigameMissionBgImagePath(builder, minigameMissionBgImagePath): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(minigameMissionBgImagePath), 0)
...
def EventContentSeasonExcelAddMinigameMissionBgPrefabName(builder, minigameMissionBgPrefabName): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(minigameMissionBgPrefabName), 0)
...
def EventContentSeasonExcelAddMinigamePrologScenarioGroupId(builder, minigamePrologScenarioGroupId): builder.PrependInt64Slot(26, minigamePrologScenarioGroupId, 0)
...
def EventContentSeasonExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return EventContentSeasonExcelAddName(builder, name)
def EventContentSeasonExcelAddOpenConditionContent(builder, openConditionContent): builder.PrependInt32Slot(29, openConditionContent, 0)
...
def EventContentSeasonExcelAddOriginalEventContentId(builder, originalEventContentId): builder.PrependInt64Slot(30, originalEventContentId, 0)
...
def EventContentSeasonExcelAddRewardTagPermanent(builder, rewardTagPermanent): builder.PrependInt32Slot(31, rewardTagPermanent, 0)
...
def EventContentSeasonExcelAddScenarioContentCollectionGroupId(builder, scenarioContentCollectionGroupId): builder.PrependInt64Slot(32, scenarioContentCollectionGroupId, 0)
...
def EventContentSeasonExcelAddShiftMainBgImagePath(builder, shiftMainBgImagePath): builder.PrependUOffsetTRelativeSlot(33, flatbuffers.number_types.UOffsetTFlags.py_type(shiftMainBgImagePath), 0)
...
def EventContentSeasonExcelAddShiftTriggerStageId(builder, shiftTriggerStageId): builder.PrependInt64Slot(34, shiftTriggerStageId, 0)
...
def EventContentSeasonExcelAddSubEvent(builder, subEvent): builder.PrependBoolSlot(35, subEvent, 0)
def AddSubEvent(builder, subEvent):
    return EventContentSeasonExcelAddSubEvent(builder, subEvent)
def EventContentSeasonExcelAddSubEventType(builder, subEventType): builder.PrependInt32Slot(36, subEventType, 0)
def AddSubEventType(builder, subEventType):
    return EventContentSeasonExcelAddSubEventType(builder, subEventType)
def EventContentSeasonExcelAddSubIconParcelPath(builder, subIconParcelPath): builder.PrependUOffsetTRelativeSlot(37, flatbuffers.number_types.UOffsetTFlags.py_type(subIconParcelPath), 0)
