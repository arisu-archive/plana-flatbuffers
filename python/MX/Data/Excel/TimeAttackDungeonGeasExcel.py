...
def TimeAttackDungeonGeasExcelAddGeasLocalizeEtcKey(builder, geasLocalizeEtcKey): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(geasLocalizeEtcKey), 0)
...
def TimeAttackDungeonGeasExcelAddGeasIconPath(builder, geasIconPath): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(geasIconPath), 0)
...
def TimeAttackDungeonGeasExcelAddEnemyPassiveSkillLevel(builder, enemyPassiveSkillLevel): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(enemyPassiveSkillLevel), 0)
...
def TimeAttackDungeonGeasExcelAddEnemyPassiveSkillId(builder, enemyPassiveSkillId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(enemyPassiveSkillId), 0)
...
def TimeAttackDungeonGeasExcelAddAllyPassiveSkillLevel(builder, allyPassiveSkillLevel): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(allyPassiveSkillLevel), 0)
...
def TimeAttackDungeonGeasExcelAddAllyPassiveSkillId(builder, allyPassiveSkillId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(allyPassiveSkillId), 0)
...
def TimeAttackDungeonGeasExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(6, groundId, 0)
def AddGroundId(builder, groundId):
    return TimeAttackDungeonGeasExcelAddGroundId(builder, groundId)
def TimeAttackDungeonGeasExcelAddRecommandLevel(builder, recommandLevel): builder.PrependInt32Slot(7, recommandLevel, 0)
def AddRecommandLevel(builder, recommandLevel):
    return TimeAttackDungeonGeasExcelAddRecommandLevel(builder, recommandLevel)
def TimeAttackDungeonGeasExcelAddDifficulty(builder, difficulty): builder.PrependInt32Slot(8, difficulty, 0)
def AddDifficulty(builder, difficulty):
    return TimeAttackDungeonGeasExcelAddDifficulty(builder, difficulty)
def TimeAttackDungeonGeasExcelAddTimeWeightConst(builder, timeWeightConst): builder.PrependInt64Slot(9, timeWeightConst, 0)
...
def TimeAttackDungeonGeasExcelAddClearTimeWeightPoint(builder, clearTimeWeightPoint): builder.PrependInt64Slot(10, clearTimeWeightPoint, 0)
...
def TimeAttackDungeonGeasExcelAddClearDefaultPoint(builder, clearDefaultPoint): builder.PrependInt64Slot(11, clearDefaultPoint, 0)
...
def TimeAttackDungeonGeasExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(12, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return TimeAttackDungeonGeasExcelAddBattleDuration(builder, battleDuration)
def TimeAttackDungeonGeasExcelAddLocalizeEtcKey(builder, localizeEtcKey): builder.PrependUint32Slot(13, localizeEtcKey, 0)
def AddLocalizeEtcKey(builder, localizeEtcKey):
    return TimeAttackDungeonGeasExcelAddLocalizeEtcKey(builder, localizeEtcKey)
def TimeAttackDungeonGeasExcelAddTimeAttackDungeonType(builder, timeAttackDungeonType): builder.PrependInt32Slot(14, timeAttackDungeonType, 0)
...
def TimeAttackDungeonGeasExcelAddId(builder, id): builder.PrependInt64Slot(15, id, 0)
