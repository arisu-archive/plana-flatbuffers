...
def BGMExcelAddLoopOffsetTime(builder, loopOffsetTime): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(loopOffsetTime), 0)
...
def BGMExcelAddLoopTranstionTime(builder, loopTranstionTime): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(loopTranstionTime), 0)
...
def BGMExcelAddLoopEndTime(builder, loopEndTime): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(loopEndTime), 0)
...
def BGMExcelAddVolume(builder, volume): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(volume), 0)
...
def BGMExcelAddPath(builder, path): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(path), 0)
...
def BGMExcelAddNation(builder, nation): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(nation), 0)
...
def BGMExcelAddId(builder, id): builder.PrependInt64Slot(7, id, 0)
