...
def PickupFirstGetBonusExcelAddPickupCharacterId(builder, pickupCharacterId): builder.PrependInt64Slot(0, pickupCharacterId, 0)
...
def PickupFirstGetBonusExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependInt64Slot(2, rewardParcelAmount, 0)
def AddRewardParcelAmount(builder, rewardParcelAmount):
    return PickupFirstGetBonusExcelAddRewardParcelAmount(builder, rewardParcelAmount)
def PickupFirstGetBonusExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependInt64Slot(3, rewardParcelId, 0)
def AddRewardParcelId(builder, rewardParcelId):
    return PickupFirstGetBonusExcelAddRewardParcelId(builder, rewardParcelId)
def PickupFirstGetBonusExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(4, rewardParcelType, 0)
