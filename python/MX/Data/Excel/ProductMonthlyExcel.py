...
def ProductMonthlyExcelAddParcelAmount(builder, parcelAmount): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(parcelAmount), 0)
...
def ProductMonthlyExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
...
def ProductMonthlyExcelAddParcelType(builder, parcelType): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(parcelType), 0)
...
def ProductMonthlyExcelAddPurchaseCountLimit(builder, purchaseCountLimit): builder.PrependInt64Slot(7, purchaseCountLimit, 0)
...
def ProductMonthlyExcelAddMonthlyDays(builder, monthlyDays): builder.PrependInt64Slot(9, monthlyDays, 0)
...
def ProductMonthlyExcelAddPriceReference(builder, priceReference): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(priceReference), 0)
def AddPriceReference(builder, priceReference):
    return ProductMonthlyExcelAddPriceReference(builder, priceReference)
def ProductMonthlyExcelAddPrice(builder, price): builder.PrependInt64Slot(12, price, 0)
...
def ProductMonthlyExcelAddProductId(builder, productId): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(productId), 0)
def AddProductId(builder, productId):
    return ProductMonthlyExcelAddProductId(builder, productId)
def ProductMonthlyExcelAddId(builder, id): builder.PrependInt64Slot(15, id, 0)
