...
def EventContentShopExcelAddRestrictBuyWhenInventoryFull(builder, restrictBuyWhenInventoryFull): builder.PrependBoolSlot(0, restrictBuyWhenInventoryFull, 0)
...
def EventContentShopExcelAddBuyReportEventName(builder, buyReportEventName): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(buyReportEventName), 0)
...
def EventContentShopExcelAddPurchaseCountResetType(builder, purchaseCountResetType): builder.PrependInt32Slot(2, purchaseCountResetType, 0)
...
def EventContentShopExcelAddPurchaseCountLimit(builder, purchaseCountLimit): builder.PrependInt64Slot(3, purchaseCountLimit, 0)
...
def EventContentShopExcelAddPurchaseCooltimeMin(builder, purchaseCooltimeMin): builder.PrependInt64Slot(4, purchaseCooltimeMin, 0)
...
def EventContentShopExcelAddSalePeriodTo(builder, salePeriodTo): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(salePeriodTo), 0)
def AddSalePeriodTo(builder, salePeriodTo):
    return EventContentShopExcelAddSalePeriodTo(builder, salePeriodTo)
def EventContentShopExcelAddSalePeriodFrom(builder, salePeriodFrom): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(salePeriodFrom), 0)
def AddSalePeriodFrom(builder, salePeriodFrom):
    return EventContentShopExcelAddSalePeriodFrom(builder, salePeriodFrom)
def EventContentShopExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(7, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return EventContentShopExcelAddDisplayOrder(builder, displayOrder)
def EventContentShopExcelAddGoodsId(builder, goodsId): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(goodsId), 0)
...
def EventContentShopExcelAddIsLegacy(builder, isLegacy): builder.PrependBoolSlot(9, isLegacy, 0)
def AddIsLegacy(builder, isLegacy):
    return EventContentShopExcelAddIsLegacy(builder, isLegacy)
def EventContentShopExcelAddCategoryType(builder, categoryType): builder.PrependInt32Slot(10, categoryType, 0)
def AddCategoryType(builder, categoryType):
    return EventContentShopExcelAddCategoryType(builder, categoryType)
def EventContentShopExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(11, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EventContentShopExcelAddLocalizeEtcId(builder, localizeEtcId)
def EventContentShopExcelAddId(builder, id): builder.PrependInt64Slot(12, id, 0)
def AddId(builder, id):
    return EventContentShopExcelAddId(builder, id)
def EventContentShopExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(13, eventContentId, 0)
