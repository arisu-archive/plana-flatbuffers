...
def EventContentBoxGachaShopExcelAddGoodsId(builder, goodsId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(goodsId), 0)
...
def EventContentBoxGachaShopExcelAddIsPrize(builder, isPrize): builder.PrependBoolSlot(2, isPrize, 0)
def AddIsPrize(builder, isPrize):
    return EventContentBoxGachaShopExcelAddIsPrize(builder, isPrize)
def EventContentBoxGachaShopExcelAddIsLegacy(builder, isLegacy): builder.PrependBoolSlot(3, isLegacy, 0)
def AddIsLegacy(builder, isLegacy):
    return EventContentBoxGachaShopExcelAddIsLegacy(builder, isLegacy)
def EventContentBoxGachaShopExcelAddRound(builder, round): builder.PrependInt64Slot(4, round, 0)
def AddRound(builder, round):
    return EventContentBoxGachaShopExcelAddRound(builder, round)
def EventContentBoxGachaShopExcelAddGroupElementAmount(builder, groupElementAmount): builder.PrependInt64Slot(5, groupElementAmount, 0)
...
def EventContentBoxGachaShopExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(6, groupId, 0)
def AddGroupId(builder, groupId):
    return EventContentBoxGachaShopExcelAddGroupId(builder, groupId)
def EventContentBoxGachaShopExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(7, eventContentId, 0)
