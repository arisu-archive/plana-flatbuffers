...
def TerrainAdaptationFactorExcelAddAttackPowerFactor(builder, attackPowerFactor): builder.PrependInt64Slot(0, attackPowerFactor, 0)
...
def TerrainAdaptationFactorExcelAddDodgeFactor(builder, dodgeFactor): builder.PrependInt64Slot(1, dodgeFactor, 0)
def AddDodgeFactor(builder, dodgeFactor):
    return TerrainAdaptationFactorExcelAddDodgeFactor(builder, dodgeFactor)
def TerrainAdaptationFactorExcelAddAccuracyFactor(builder, accuracyFactor): builder.PrependInt64Slot(2, accuracyFactor, 0)
...
def TerrainAdaptationFactorExcelAddTerrainAdaptationStat(builder, terrainAdaptationStat): builder.PrependInt32Slot(5, terrainAdaptationStat, 0)
...
def TerrainAdaptationFactorExcelAddTerrainAdaptation(builder, terrainAdaptation): builder.PrependInt32Slot(6, terrainAdaptation, 0)
