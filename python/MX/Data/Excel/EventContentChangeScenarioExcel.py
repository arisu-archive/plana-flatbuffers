...
def EventContentChangeScenarioExcelAddScenarioGroupId(builder, scenarioGroupId): builder.PrependInt64Slot(0, scenarioGroupId, 0)
...
def EventContentChangeScenarioExcelAddChangeCount(builder, changeCount): builder.PrependInt64Slot(1, changeCount, 0)
def AddChangeCount(builder, changeCount):
    return EventContentChangeScenarioExcelAddChangeCount(builder, changeCount)
def EventContentChangeScenarioExcelAddChangeType(builder, changeType): builder.PrependInt32Slot(2, changeType, 0)
def AddChangeType(builder, changeType):
    return EventContentChangeScenarioExcelAddChangeType(builder, changeType)
def EventContentChangeScenarioExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
