...
def CharacterStatLimitExcelAddStatRatioMaxValue(builder, statRatioMaxValue): builder.PrependInt64Slot(0, statRatioMaxValue, 0)
...
def CharacterStatLimitExcelAddStatMaxValue(builder, statMaxValue): builder.PrependInt64Slot(2, statMaxValue, 0)
...
def CharacterStatLimitExcelAddStatType(builder, statType): builder.PrependInt32Slot(4, statType, 0)
def AddStatType(builder, statType):
    return CharacterStatLimitExcelAddStatType(builder, statType)
def CharacterStatLimitExcelAddTacticEntityType(builder, tacticEntityType): builder.PrependInt32Slot(5, tacticEntityType, 0)
