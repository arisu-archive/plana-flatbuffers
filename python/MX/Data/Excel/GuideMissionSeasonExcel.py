...
def GuideMissionSeasonExcelAddIsPermanent(builder, isPermanent): builder.PrependBoolSlot(1, isPermanent, 0)
def AddIsPermanent(builder, isPermanent):
    return GuideMissionSeasonExcelAddIsPermanent(builder, isPermanent)
def GuideMissionSeasonExcelAddTabType(builder, tabType): builder.PrependInt32Slot(2, tabType, 0)
def AddTabType(builder, tabType):
    return GuideMissionSeasonExcelAddTabType(builder, tabType)
def GuideMissionSeasonExcelAddRequirementParcelAmount(builder, requirementParcelAmount): builder.PrependInt32Slot(3, requirementParcelAmount, 0)
...
def GuideMissionSeasonExcelAddRequirementParcelId(builder, requirementParcelId): builder.PrependInt64Slot(4, requirementParcelId, 0)
...
def GuideMissionSeasonExcelAddRequirementParcelType(builder, requirementParcelType): builder.PrependInt32Slot(5, requirementParcelType, 0)
...
def GuideMissionSeasonExcelAddTitleImage(builder, titleImage): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(titleImage), 0)
def AddTitleImage(builder, titleImage):
    return GuideMissionSeasonExcelAddTitleImage(builder, titleImage)
def GuideMissionSeasonExcelAddBackgroundImage(builder, backgroundImage): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(backgroundImage), 0)
def AddBackgroundImage(builder, backgroundImage):
    return GuideMissionSeasonExcelAddBackgroundImage(builder, backgroundImage)
def GuideMissionSeasonExcelAddLobbyBannerImage(builder, lobbyBannerImage): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(lobbyBannerImage), 0)
...
def GuideMissionSeasonExcelAddRewardImage(builder, rewardImage): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(rewardImage), 0)
def AddRewardImage(builder, rewardImage):
    return GuideMissionSeasonExcelAddRewardImage(builder, rewardImage)
def GuideMissionSeasonExcelAddRequirementParcelImage(builder, requirementParcelImage): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(requirementParcelImage), 0)
...
def GuideMissionSeasonExcelAddSpineCharacterId(builder, spineCharacterId): builder.PrependInt64Slot(11, spineCharacterId, 0)
...
def GuideMissionSeasonExcelAddIconOrder(builder, iconOrder): builder.PrependInt64Slot(12, iconOrder, 0)
def AddIconOrder(builder, iconOrder):
    return GuideMissionSeasonExcelAddIconOrder(builder, iconOrder)
def GuideMissionSeasonExcelAddExpiryDate(builder, expiryDate): builder.PrependInt64Slot(13, expiryDate, 0)
def AddExpiryDate(builder, expiryDate):
    return GuideMissionSeasonExcelAddExpiryDate(builder, expiryDate)
def GuideMissionSeasonExcelAddMaximumLoginCount(builder, maximumLoginCount): builder.PrependInt64Slot(14, maximumLoginCount, 0)
...
def GuideMissionSeasonExcelAddCloseBannerAfterCompletion(builder, closeBannerAfterCompletion): builder.PrependBoolSlot(15, closeBannerAfterCompletion, 0)
...
def GuideMissionSeasonExcelAddEndDate(builder, endDate): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(endDate), 0)
def AddEndDate(builder, endDate):
    return GuideMissionSeasonExcelAddEndDate(builder, endDate)
def GuideMissionSeasonExcelAddStartableEndDate(builder, startableEndDate): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(startableEndDate), 0)
...
def GuideMissionSeasonExcelAddStartDate(builder, startDate): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(startDate), 0)
def AddStartDate(builder, startDate):
    return GuideMissionSeasonExcelAddStartDate(builder, startDate)
def GuideMissionSeasonExcelAddBannerOpenDate(builder, bannerOpenDate): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(bannerOpenDate), 0)
def AddBannerOpenDate(builder, bannerOpenDate):
    return GuideMissionSeasonExcelAddBannerOpenDate(builder, bannerOpenDate)
def GuideMissionSeasonExcelAddEnabled(builder, enabled): builder.PrependBoolSlot(20, enabled, 0)
def AddEnabled(builder, enabled):
    return GuideMissionSeasonExcelAddEnabled(builder, enabled)
def GuideMissionSeasonExcelAddAccountType(builder, accountType): builder.PrependInt32Slot(21, accountType, 0)
def AddAccountType(builder, accountType):
    return GuideMissionSeasonExcelAddAccountType(builder, accountType)
def GuideMissionSeasonExcelAddInfomationLocalizeCode(builder, infomationLocalizeCode): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(infomationLocalizeCode), 0)
...
def GuideMissionSeasonExcelAddPermanentInfomationLocalizeCode(builder, permanentInfomationLocalizeCode): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(permanentInfomationLocalizeCode), 0)
...
def GuideMissionSeasonExcelAddTitleLocalizeCode(builder, titleLocalizeCode): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(titleLocalizeCode), 0)
...
def GuideMissionSeasonExcelAddId(builder, id): builder.PrependInt64Slot(25, id, 0)
