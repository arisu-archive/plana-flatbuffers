...
def CheatCodeListExcelAddDesc(builder, desc): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(desc), 0)
def AddDesc(builder, desc):
    return CheatCodeListExcelAddDesc(builder, desc)
def CheatCodeListExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return CheatCodeListExcelAddId(builder, id)
def CheatCodeListExcelAddInputTitle(builder, inputTitle): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(inputTitle), 0)
