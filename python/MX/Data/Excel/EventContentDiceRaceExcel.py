...
def EventContentDiceRaceExcelAddDiceRaceEventType(builder, diceRaceEventType): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(diceRaceEventType), 0)
...
def EventContentDiceRaceExcelAddFixedDiceIcon(builder, fixedDiceIcon): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(fixedDiceIcon), 0)
...
def EventContentDiceRaceExcelAddIsUsingFixedDice(builder, isUsingFixedDice): builder.PrependBoolSlot(2, isUsingFixedDice, 0)
...
def EventContentDiceRaceExcelAddSkipableLap(builder, skipableLap): builder.PrependInt32Slot(4, skipableLap, 0)
def AddSkipableLap(builder, skipableLap):
    return EventContentDiceRaceExcelAddSkipableLap(builder, skipableLap)
def EventContentDiceRaceExcelAddDiceCostGoodsId(builder, diceCostGoodsId): builder.PrependInt64Slot(5, diceCostGoodsId, 0)
def AddDiceCostGoodsId(builder, diceCostGoodsId):
    return EventContentDiceRaceExcelAddDiceCostGoodsId(builder, diceCostGoodsId)
def EventContentDiceRaceExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(6, eventContentId, 0)
