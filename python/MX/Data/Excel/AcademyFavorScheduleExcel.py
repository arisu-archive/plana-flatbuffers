...
def AcademyFavorScheduleExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(0, characterId, 0)
def AddCharacterId(builder, characterId):
    return AcademyFavorScheduleExcelAddCharacterId(builder, characterId)
def AcademyFavorScheduleExcelAddFavorRank(builder, favorRank): builder.PrependInt64Slot(1, favorRank, 0)
def AddFavorRank(builder, favorRank):
    return AcademyFavorScheduleExcelAddFavorRank(builder, favorRank)
def AcademyFavorScheduleExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return AcademyFavorScheduleExcelAddId(builder, id)
def AcademyFavorScheduleExcelAddLocalizeScenarioId(builder, localizeScenarioId): builder.PrependUint32Slot(3, localizeScenarioId, 0)
...
def AcademyFavorScheduleExcelAddOrderInGroup(builder, orderInGroup): builder.PrependInt64Slot(5, orderInGroup, 0)
def AddOrderInGroup(builder, orderInGroup):
    return AcademyFavorScheduleExcelAddOrderInGroup(builder, orderInGroup)
def AcademyFavorScheduleExcelAddRewardAmount(builder, rewardAmount): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(rewardAmount), 0)
...
def AcademyFavorScheduleExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def AcademyFavorScheduleExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def AcademyFavorScheduleExcelAddScenarioSriptGroupId(builder, scenarioSriptGroupId): builder.PrependInt64Slot(9, scenarioSriptGroupId, 0)
...
def AcademyFavorScheduleExcelAddScheduleGroupId(builder, scheduleGroupId): builder.PrependInt64Slot(10, scheduleGroupId, 0)
def AddScheduleGroupId(builder, scheduleGroupId):
    return AcademyFavorScheduleExcelAddScheduleGroupId(builder, scheduleGroupId)
def AcademyFavorScheduleExcelAddSecretStoneAmount(builder, secretStoneAmount): builder.PrependInt64Slot(11, secretStoneAmount, 0)
