...
def MiniGameDreamCollectionScenarioExcelAddScenarioGroupId(builder, scenarioGroupId): builder.PrependInt64Slot(0, scenarioGroupId, 0)
...
def MiniGameDreamCollectionScenarioExcelAddParameterAmount(builder, parameterAmount): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(parameterAmount), 0)
...
def MiniGameDreamCollectionScenarioExcelAddParameter(builder, parameter): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(parameter), 0)
...
def MiniGameDreamCollectionScenarioExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MiniGameDreamCollectionScenarioExcelAddEventContentId(builder, eventContentId)
def MiniGameDreamCollectionScenarioExcelAddIsSkip(builder, isSkip): builder.PrependBoolSlot(4, isSkip, 0)
def AddIsSkip(builder, isSkip):
    return MiniGameDreamCollectionScenarioExcelAddIsSkip(builder, isSkip)
def MiniGameDreamCollectionScenarioExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
