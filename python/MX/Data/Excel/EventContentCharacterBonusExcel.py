...
def EventContentCharacterBonusExcelAddEventContentItemType(builder, eventContentItemType): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(eventContentItemType), 0)
...
def EventContentCharacterBonusExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(2, characterId, 0)
def AddCharacterId(builder, characterId):
    return EventContentCharacterBonusExcelAddCharacterId(builder, characterId)
def EventContentCharacterBonusExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
