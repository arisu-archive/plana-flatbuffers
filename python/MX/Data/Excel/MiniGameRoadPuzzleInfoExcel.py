...
def MiniGameRoadPuzzleInfoExcelAddCostGoodsId(builder, costGoodsId): builder.PrependInt64Slot(0, costGoodsId, 0)
def AddCostGoodsId(builder, costGoodsId):
    return MiniGameRoadPuzzleInfoExcelAddCostGoodsId(builder, costGoodsId)
def MiniGameRoadPuzzleInfoExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(1, eventContentId, 0)
...
def MiniGameRoadPuzzleInfoExcelAddEventUseCostType(builder, eventUseCostType): builder.PrependInt32Slot(3, eventUseCostType, 0)
...
def MiniGameRoadPuzzleInfoExcelAddInstantClearRound(builder, instantClearRound): builder.PrependInt32Slot(4, instantClearRound, 0)
