...
def MiniGameAudioAnimatorExcelAddVoiceHash(builder, voiceHash): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(voiceHash), 0)
...
def MiniGameAudioAnimatorExcelAddAudioClipPath(builder, audioClipPath): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(audioClipPath), 0)
...
def MiniGameAudioAnimatorExcelAddAudioPriority(builder, audioPriority): builder.PrependInt32Slot(2, audioPriority, 0)
...
def MiniGameAudioAnimatorExcelAddVolume(builder, volume): builder.PrependFloat32Slot(4, volume, 0.0)
...
def MiniGameAudioAnimatorExcelAddIgnoreInterruptDelay(builder, ignoreInterruptDelay): builder.PrependBoolSlot(6, ignoreInterruptDelay, 0)
...
def MiniGameAudioAnimatorExcelAddStateNameHash(builder, stateNameHash): builder.PrependUint32Slot(8, stateNameHash, 0)
...
def MiniGameAudioAnimatorExcelAddControllerNameHash(builder, controllerNameHash): builder.PrependUint32Slot(10, controllerNameHash, 0)
