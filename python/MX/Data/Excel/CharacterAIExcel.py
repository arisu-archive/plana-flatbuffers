...
def CharacterAIExcelAddHasTargetSwitchingMotion(builder, hasTargetSwitchingMotion): builder.PrependBoolSlot(0, hasTargetSwitchingMotion, 0)
...
def CharacterAIExcelAddCanUseObstacleOfKneelMotion(builder, canUseObstacleOfKneelMotion): builder.PrependBoolSlot(2, canUseObstacleOfKneelMotion, 0)
...
def CharacterAIExcelAddMinimumPositionGap(builder, minimumPositionGap): builder.PrependInt64Slot(3, minimumPositionGap, 0)
...
def CharacterAIExcelAddDistanceReduceFormationPath(builder, distanceReduceFormationPath): builder.PrependInt64Slot(4, distanceReduceFormationPath, 0)
...
def CharacterAIExcelAddDistanceReduceRatioObstaclePath(builder, distanceReduceRatioObstaclePath): builder.PrependInt64Slot(7, distanceReduceRatioObstaclePath, 0)
...
def CharacterAIExcelAddCheckCanUseAutoSkill(builder, checkCanUseAutoSkill): builder.PrependBoolSlot(8, checkCanUseAutoSkill, 0)
...
def CharacterAIExcelAddPositioning(builder, positioning): builder.PrependInt32Slot(9, positioning, 0)
...
def CharacterAIExcelAddId(builder, id): builder.PrependInt64Slot(11, id, 0)
