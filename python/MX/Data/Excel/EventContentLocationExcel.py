...
def EventContentLocationExcelAddInformationGroupId(builder, informationGroupId): builder.PrependInt64Slot(0, informationGroupId, 0)
...
def EventContentLocationExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependInt64Slot(1, rewardParcelId, 0)
def AddRewardParcelId(builder, rewardParcelId):
    return EventContentLocationExcelAddRewardParcelId(builder, rewardParcelId)
def EventContentLocationExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(2, rewardParcelType, 0)
def AddRewardParcelType(builder, rewardParcelType):
    return EventContentLocationExcelAddRewardParcelType(builder, rewardParcelType)
def EventContentLocationExcelAddScheduleEventPointCostParcelAmount(builder, scheduleEventPointCostParcelAmount): builder.PrependInt64Slot(3, scheduleEventPointCostParcelAmount, 0)
...
def EventContentLocationExcelAddScheduleEventPointCostParcelId(builder, scheduleEventPointCostParcelId): builder.PrependInt64Slot(4, scheduleEventPointCostParcelId, 0)
...
def EventContentLocationExcelAddLocationResetScheduleCount(builder, locationResetScheduleCount): builder.PrependInt32Slot(6, locationResetScheduleCount, 0)
...
def EventContentLocationExcelAddPrefabPath(builder, prefabPath): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(prefabPath), 0)
def AddPrefabPath(builder, prefabPath):
    return EventContentLocationExcelAddPrefabPath(builder, prefabPath)
def EventContentLocationExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(8, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EventContentLocationExcelAddLocalizeEtcId(builder, localizeEtcId)
def EventContentLocationExcelAddId(builder, id): builder.PrependInt64Slot(9, id, 0)
def AddId(builder, id):
    return EventContentLocationExcelAddId(builder, id)
def EventContentLocationExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(10, eventContentId, 0)
