...
def EventContentLocationExcelAddBgPath(builder, bgPath):
...
def AddBgPath(builder, bgPath):
    EventContentLocationExcelAddBgPath(builder, bgPath)
...
def EventContentLocationExcelAddScheduleEventPointCostParcelType(builder, scheduleEventPointCostParcelType):
    builder.PrependInt32Slot(6, scheduleEventPointCostParcelType, 0)
...
def EventContentLocationExcelAddRewardParcelType(builder, rewardParcelType):
    builder.PrependInt32Slot(9, rewardParcelType, 0)
...
class EventContentLocationExcelT(object):
    ...
    def _UnPack(self, eventContentLocationExcel):
        ...
        self.bgPath = eventContentLocationExcel.BgPath()
