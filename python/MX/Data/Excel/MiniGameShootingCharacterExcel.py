...
def MiniGameShootingCharacterExcelAddAttackPower(builder, attackPower): builder.PrependInt64Slot(0, attackPower, 0)
def AddAttackPower(builder, attackPower):
    return MiniGameShootingCharacterExcelAddAttackPower(builder, attackPower)
def MiniGameShootingCharacterExcelAddAttackRange(builder, attackRange): builder.PrependInt64Slot(1, attackRange, 0)
...
def MiniGameShootingCharacterExcelAddCharacterVoiceGroupId(builder, characterVoiceGroupId): builder.PrependInt64Slot(3, characterVoiceGroupId, 0)
...
def MiniGameShootingCharacterExcelAddCriticalDamageRate(builder, criticalDamageRate): builder.PrependInt64Slot(4, criticalDamageRate, 0)
...
def MiniGameShootingCharacterExcelAddCriticalRate(builder, criticalRate): builder.PrependInt64Slot(5, criticalRate, 0)
...
def MiniGameShootingCharacterExcelAddDefensePower(builder, defensePower): builder.PrependInt64Slot(7, defensePower, 0)
def AddDefensePower(builder, defensePower):
    return MiniGameShootingCharacterExcelAddDefensePower(builder, defensePower)
def MiniGameShootingCharacterExcelAddIgnoreObstacleCheck(builder, ignoreObstacleCheck): builder.PrependBoolSlot(8, ignoreObstacleCheck, 0)
...
def MiniGameShootingCharacterExcelAddIsBoss(builder, isBoss): builder.PrependBoolSlot(9, isBoss, 0)
def AddIsBoss(builder, isBoss):
    return MiniGameShootingCharacterExcelAddIsBoss(builder, isBoss)
def MiniGameShootingCharacterExcelAddMaxHp(builder, maxHp): builder.PrependInt64Slot(10, maxHp, 0)
def AddMaxHp(builder, maxHp):
    return MiniGameShootingCharacterExcelAddMaxHp(builder, maxHp)
def MiniGameShootingCharacterExcelAddModelPrefabName(builder, modelPrefabName): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(modelPrefabName), 0)
...
def MiniGameShootingCharacterExcelAddMoveSpeed(builder, moveSpeed): builder.PrependInt64Slot(12, moveSpeed, 0)
def AddMoveSpeed(builder, moveSpeed):
    return MiniGameShootingCharacterExcelAddMoveSpeed(builder, moveSpeed)
def MiniGameShootingCharacterExcelAddNormalAttackSkillData(builder, normalAttackSkillData): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(normalAttackSkillData), 0)
...
def MiniGameShootingCharacterExcelAddPublicSkillData(builder, publicSkillData): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(publicSkillData), 0)
...
def MiniGameShootingCharacterExcelAddScale(builder, scale): builder.PrependFloat32Slot(15, scale, 0.0)
def AddScale(builder, scale):
    return MiniGameShootingCharacterExcelAddScale(builder, scale)
def MiniGameShootingCharacterExcelAddShotTime(builder, shotTime): builder.PrependInt64Slot(16, shotTime, 0)
