...
class CharacterExcelT(object):
    ...
    def __init__(
        ...
        self.isPlayableCharacter = isPlayableCharacter  # type: bool
        self.localizeEtcId = localizeEtcId  # type: int
        self.rarity = rarity  # type: int
        self.isNpc = isNpc  # type: bool
        self.tacticEntityType = tacticEntityType  # type: int
        self.canSurvive = canSurvive  # type: bool
        self.isDummy = isDummy  # type: bool
        self.subPartsCount = subPartsCount  # type: int
        self.tacticRole = tacticRole  # type: int
        self.weaponType = weaponType  # type: int
        self.tacticRange = tacticRange  # type: int
        self.bulletType = bulletType  # type: int
        self.armorType = armorType  # type: int
        self.aimIkType = aimIkType  # type: int
        self.school = school  # type: int
        self.club = club  # type: int
        self.defaultStarGrade = defaultStarGrade  # type: int
        self.maxStarGrade = maxStarGrade  # type: int
        self.statLevelUpType = statLevelUpType  # type: int
        self.squadType = squadType  # type: int
        self.jumpable = jumpable  # type: bool
        self.personalityId = personalityId  # type: int
        self.characterAiId = characterAiId  # type: int
        ...
        self.equipmentSlot = equipmentSlot  # type: Optional[List[int]]
        self.weaponLocalizeId = weaponLocalizeId  # type: int
        ...
        self.emojiOffsetX = emojiOffsetX  # type: float
        self.emojiOffsetY = emojiOffsetY  # type: float
        self.moveStartFrame = moveStartFrame  # type: int
        self.moveEndFrame = moveEndFrame  # type: int
        self.jumpMotionFrame = jumpMotionFrame  # type: int
        self.appearFrame = appearFrame  # type: int
        self.canMove = canMove  # type: bool
        self.canFix = canFix  # type: bool
        self.canCrowdControl = canCrowdControl  # type: bool
        self.canBattleItemMove = canBattleItemMove  # type: bool
        self.ignoreObstacle = ignoreObstacle  # type: bool
        self.isAirUnit = isAirUnit  # type: bool
        self.airUnitHeight = airUnitHeight  # type: int
        self.tags = tags  # type: Optional[List[int]]
        self.secretStoneItemId = secretStoneItemId  # type: int
        self.secretStoneItemAmount = secretStoneItemAmount  # type: int
        self.characterPieceItemId = characterPieceItemId  # type: int
        self.characterPieceItemAmount = characterPieceItemAmount  # type: int
        self.combineRecipeId = combineRecipeId  # type: int

    @classmethod
    def InitFromBuf(cls, buf, pos):
        characterExcel = CharacterExcel()
        characterExcel.Init(buf, pos)
        return cls.InitFromObj(characterExcel)
    ...
    @classmethod
    def InitFromObj(cls, characterExcel):
        x = CharacterExcelT()
        x._UnPack(characterExcel)
        return x

    # CharacterExcelT
    def _UnPack(self, characterExcel):
        if characterExcel is None:
            return
        self.id = characterExcel.Id()
        self.devName = characterExcel.DevName()
        self.costumeGroupId = characterExcel.CostumeGroupId()
        self.isPlayable = characterExcel.IsPlayable()
        self.productionStep = characterExcel.ProductionStep()
        self.collectionVisible = characterExcel.CollectionVisible()
        self.releaseDate = characterExcel.ReleaseDate()
        self.collectionVisibleStartDate = characterExcel.CollectionVisibleStartDate()
        self.collectionVisibleEndDate = characterExcel.CollectionVisibleEndDate()
        self.isPlayableCharacter = characterExcel.IsPlayableCharacter()
        self.localizeEtcId = characterExcel.LocalizeEtcId()
        self.rarity = characterExcel.Rarity()
        self.isNpc = characterExcel.IsNpc()
        self.tacticEntityType = characterExcel.TacticEntityType()
        self.canSurvive = characterExcel.CanSurvive()
        self.isDummy = characterExcel.IsDummy()
        self.subPartsCount = characterExcel.SubPartsCount()
        self.tacticRole = characterExcel.TacticRole()
        self.weaponType = characterExcel.WeaponType()
        self.tacticRange = characterExcel.TacticRange()
        self.bulletType = characterExcel.BulletType()
        self.armorType = characterExcel.ArmorType()
        self.aimIkType = characterExcel.AimIkType()
        self.school = characterExcel.School()
        self.club = characterExcel.Club()
        self.defaultStarGrade = characterExcel.DefaultStarGrade()
        self.maxStarGrade = characterExcel.MaxStarGrade()
        self.statLevelUpType = characterExcel.StatLevelUpType()
        self.squadType = characterExcel.SquadType()
        self.jumpable = characterExcel.Jumpable()
        self.personalityId = characterExcel.PersonalityId()
        self.characterAiId = characterExcel.CharacterAiId()
        ...
        if not characterExcel.EquipmentSlotIsNone():
            if np is None:
                self.equipmentSlot = []
                for i in range(characterExcel.EquipmentSlotLength()):
                    self.equipmentSlot.append(characterExcel.EquipmentSlot(i))
            else:
                self.equipmentSlot = characterExcel.EquipmentSlotAsNumpy()
        self.weaponLocalizeId = characterExcel.WeaponLocalizeId()
        ...
        self.emojiOffsetX = characterExcel.EmojiOffsetX()
        self.emojiOffsetY = characterExcel.EmojiOffsetY()
        self.moveStartFrame = characterExcel.MoveStartFrame()
        self.moveEndFrame = characterExcel.MoveEndFrame()
        self.jumpMotionFrame = characterExcel.JumpMotionFrame()
        self.appearFrame = characterExcel.AppearFrame()
        self.canMove = characterExcel.CanMove()
        self.canFix = characterExcel.CanFix()
        self.canCrowdControl = characterExcel.CanCrowdControl()
        self.canBattleItemMove = characterExcel.CanBattleItemMove()
        self.ignoreObstacle = characterExcel.IgnoreObstacle()
        self.isAirUnit = characterExcel.IsAirUnit()
        self.airUnitHeight = characterExcel.AirUnitHeight()
        if not characterExcel.TagsIsNone():
            if np is None:
                self.tags = []
                for i in range(characterExcel.TagsLength()):
                    self.tags.append(characterExcel.Tags(i))
            else:
                self.tags = characterExcel.TagsAsNumpy()
        self.secretStoneItemId = characterExcel.SecretStoneItemId()
        self.secretStoneItemAmount = characterExcel.SecretStoneItemAmount()
        self.characterPieceItemId = characterExcel.CharacterPieceItemId()
        self.characterPieceItemAmount = characterExcel.CharacterPieceItemAmount()
        self.combineRecipeId = characterExcel.CombineRecipeId()
    ...
    def Pack(self, builder):
        ...
        if self.scenarioCharacter is not None:
            scenarioCharacter = builder.CreateString(self.scenarioCharacter)
        if self.equipmentSlot is not None:
            if np is not None and type(self.equipmentSlot) is np.ndarray:
                equipmentSlot = builder.CreateNumpyVector(self.equipmentSlot)
            else:
                CharacterExcelStartEquipmentSlotVector(builder, len(self.equipmentSlot))
                for i in reversed(range(len(self.equipmentSlot))):
                    builder.PrependInt32(self.equipmentSlot[i])
                equipmentSlot = builder.EndVector()
        if self.tags is not None:
            if np is not None and type(self.tags) is np.ndarray:
                tags = builder.CreateNumpyVector(self.tags)
            else:
                CharacterExcelStartTagsVector(builder, len(self.tags))
                for i in reversed(range(len(self.tags))):
                    builder.PrependInt32(self.tags[i])
                tags = builder.EndVector()
        CharacterExcelStart(builder)
        CharacterExcelAddId(builder, self.id)
        if self.devName is not None:
            CharacterExcelAddDevName(builder, devName)
        CharacterExcelAddCostumeGroupId(builder, self.costumeGroupId)
        CharacterExcelAddIsPlayable(builder, self.isPlayable)
        CharacterExcelAddProductionStep(builder, self.productionStep)
        CharacterExcelAddCollectionVisible(builder, self.collectionVisible)
        if self.releaseDate is not None:
            CharacterExcelAddReleaseDate(builder, releaseDate)
        if self.collectionVisibleStartDate is not None:
            CharacterExcelAddCollectionVisibleStartDate(builder, collectionVisibleStartDate)
        if self.collectionVisibleEndDate is not None:
            CharacterExcelAddCollectionVisibleEndDate(builder, collectionVisibleEndDate)
        CharacterExcelAddIsPlayableCharacter(builder, self.isPlayableCharacter)
        CharacterExcelAddLocalizeEtcId(builder, self.localizeEtcId)
        CharacterExcelAddRarity(builder, self.rarity)
        CharacterExcelAddIsNpc(builder, self.isNpc)
        CharacterExcelAddTacticEntityType(builder, self.tacticEntityType)
        CharacterExcelAddCanSurvive(builder, self.canSurvive)
        CharacterExcelAddIsDummy(builder, self.isDummy)
        CharacterExcelAddSubPartsCount(builder, self.subPartsCount)
        CharacterExcelAddTacticRole(builder, self.tacticRole)
        CharacterExcelAddWeaponType(builder, self.weaponType)
        CharacterExcelAddTacticRange(builder, self.tacticRange)
        CharacterExcelAddBulletType(builder, self.bulletType)
        CharacterExcelAddArmorType(builder, self.armorType)
        CharacterExcelAddAimIkType(builder, self.aimIkType)
        CharacterExcelAddSchool(builder, self.school)
        CharacterExcelAddClub(builder, self.club)
        CharacterExcelAddDefaultStarGrade(builder, self.defaultStarGrade)
        CharacterExcelAddMaxStarGrade(builder, self.maxStarGrade)
        CharacterExcelAddStatLevelUpType(builder, self.statLevelUpType)
        CharacterExcelAddSquadType(builder, self.squadType)
        CharacterExcelAddJumpable(builder, self.jumpable)
        CharacterExcelAddPersonalityId(builder, self.personalityId)
        CharacterExcelAddCharacterAiId(builder, self.characterAiId)
        ...
        CharacterExcelAddFavorLevelupType(builder, self.favorLevelupType)
        if self.equipmentSlot is not None:
            CharacterExcelAddEquipmentSlot(builder, equipmentSlot)
        CharacterExcelAddWeaponLocalizeId(builder, self.weaponLocalizeId)
        ...
        CharacterExcelAddEmojiOffsetX(builder, self.emojiOffsetX)
        CharacterExcelAddEmojiOffsetY(builder, self.emojiOffsetY)
        CharacterExcelAddMoveStartFrame(builder, self.moveStartFrame)
        CharacterExcelAddMoveEndFrame(builder, self.moveEndFrame)
        CharacterExcelAddJumpMotionFrame(builder, self.jumpMotionFrame)
        CharacterExcelAddAppearFrame(builder, self.appearFrame)
        CharacterExcelAddCanMove(builder, self.canMove)
        CharacterExcelAddCanFix(builder, self.canFix)
        CharacterExcelAddCanCrowdControl(builder, self.canCrowdControl)
        CharacterExcelAddCanBattleItemMove(builder, self.canBattleItemMove)
        CharacterExcelAddIgnoreObstacle(builder, self.ignoreObstacle)
        CharacterExcelAddIsAirUnit(builder, self.isAirUnit)
        CharacterExcelAddAirUnitHeight(builder, self.airUnitHeight)
        if self.tags is not None:
            CharacterExcelAddTags(builder, tags)
        CharacterExcelAddSecretStoneItemId(builder, self.secretStoneItemId)
        CharacterExcelAddSecretStoneItemAmount(builder, self.secretStoneItemAmount)
        CharacterExcelAddCharacterPieceItemId(builder, self.characterPieceItemId)
        CharacterExcelAddCharacterPieceItemAmount(builder, self.characterPieceItemAmount)
        CharacterExcelAddCombineRecipeId(builder, self.combineRecipeId)
        characterExcel = CharacterExcelEnd(builder)
