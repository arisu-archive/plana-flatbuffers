...
def CurrencyExcelAddResetAmount(builder, resetAmount): builder.PrependInt64Slot(0, resetAmount, 0)
def AddResetAmount(builder, resetAmount):
    return CurrencyExcelAddResetAmount(builder, resetAmount)
def CurrencyExcelAddResetType(builder, resetType): builder.PrependInt32Slot(1, resetType, 0)
def AddResetType(builder, resetType):
    return CurrencyExcelAddResetType(builder, resetType)
def CurrencyExcelAddExpiryChangeAmount(builder, expiryChangeAmount): builder.PrependInt64Slot(2, expiryChangeAmount, 0)
def AddExpiryChangeAmount(builder, expiryChangeAmount):
    return CurrencyExcelAddExpiryChangeAmount(builder, expiryChangeAmount)
def CurrencyExcelAddExpiryChangeId(builder, expiryChangeId): builder.PrependInt64Slot(3, expiryChangeId, 0)
def AddExpiryChangeId(builder, expiryChangeId):
    return CurrencyExcelAddExpiryChangeId(builder, expiryChangeId)
def CurrencyExcelAddExpiryChangeParcelType(builder, expiryChangeParcelType): builder.PrependInt32Slot(4, expiryChangeParcelType, 0)
...
def CurrencyExcelAddExpirationNotifyDateIn(builder, expirationNotifyDateIn): builder.PrependInt32Slot(5, expirationNotifyDateIn, 0)
...
def CurrencyExcelAddExpirationDateTime(builder, expirationDateTime): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(expirationDateTime), 0)
def AddExpirationDateTime(builder, expirationDateTime):
    return CurrencyExcelAddExpirationDateTime(builder, expirationDateTime)
def CurrencyExcelAddDailyRefillTime(builder, dailyRefillTime): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(dailyRefillTime), 0)
...
def CurrencyExcelAddDailyRefillAmount(builder, dailyRefillAmount): builder.PrependInt64Slot(8, dailyRefillAmount, 0)
...
def CurrencyExcelAddSpriteName(builder, spriteName): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(spriteName), 0)
...
def CurrencyExcelAddCurrencyAdditionalChargeType(builder, currencyAdditionalChargeType): builder.PrependInt32Slot(13, currencyAdditionalChargeType, 0)
...
def CurrencyExcelAddCurrencyOverChargeType(builder, currencyOverChargeType): builder.PrependInt32Slot(14, currencyOverChargeType, 0)
...
def CurrencyExcelAddAutoChargeAmount(builder, autoChargeAmount): builder.PrependInt32Slot(15, autoChargeAmount, 0)
def AddAutoChargeAmount(builder, autoChargeAmount):
    return CurrencyExcelAddAutoChargeAmount(builder, autoChargeAmount)
def CurrencyExcelAddAutoChargeMsc(builder, autoChargeMsc): builder.PrependInt32Slot(16, autoChargeMsc, 0)
def AddAutoChargeMsc(builder, autoChargeMsc):
    return CurrencyExcelAddAutoChargeMsc(builder, autoChargeMsc)
def CurrencyExcelAddRarity(builder, rarity): builder.PrependInt32Slot(17, rarity, 0)
def AddRarity(builder, rarity):
    return CurrencyExcelAddRarity(builder, rarity)
def CurrencyExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
def AddIcon(builder, icon):
    return CurrencyExcelAddIcon(builder, icon)
def CurrencyExcelAddCurrencyName(builder, currencyName): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(currencyName), 0)
def AddCurrencyName(builder, currencyName):
    return CurrencyExcelAddCurrencyName(builder, currencyName)
def CurrencyExcelAddCurrencyType(builder, currencyType): builder.PrependInt32Slot(20, currencyType, 0)
def AddCurrencyType(builder, currencyType):
    return CurrencyExcelAddCurrencyType(builder, currencyType)
def CurrencyExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(21, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return CurrencyExcelAddLocalizeEtcId(builder, localizeEtcId)
def CurrencyExcelAddId(builder, id): builder.PrependInt64Slot(22, id, 0)
