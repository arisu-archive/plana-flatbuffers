...
def MinigameCCGInfoExcelAddCardBackPath(builder, cardBackPath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(cardBackPath), 0)
...
def MinigameCCGInfoExcelAddCostParcelAmount(builder, costParcelAmount): builder.PrependInt32Slot(2, costParcelAmount, 0)
...
def MinigameCCGInfoExcelAddCostParcelType(builder, costParcelType): builder.PrependInt32Slot(4, costParcelType, 0)
def AddCostParcelType(builder, costParcelType):
    return MinigameCCGInfoExcelAddCostParcelType(builder, costParcelType)
def MinigameCCGInfoExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(5, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MinigameCCGInfoExcelAddEventContentId(builder, eventContentId)
def MinigameCCGInfoExcelAddPerkCostParcelId(builder, perkCostParcelId): builder.PrependInt64Slot(6, perkCostParcelId, 0)
def AddPerkCostParcelId(builder, perkCostParcelId):
    return MinigameCCGInfoExcelAddPerkCostParcelId(builder, perkCostParcelId)
def MinigameCCGInfoExcelAddPerkCostParcelType(builder, perkCostParcelType): builder.PrependInt32Slot(7, perkCostParcelType, 0)
