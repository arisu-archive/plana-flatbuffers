...
def ArenaRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def ArenaRewardExcelAddRewardParcelUniqueId(builder, rewardParcelUniqueId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueId), 0)
...
def ArenaRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def ArenaRewardExcelAddRankIconPath(builder, rankIconPath): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rankIconPath), 0)
def AddRankIconPath(builder, rankIconPath):
    return ArenaRewardExcelAddRankIconPath(builder, rankIconPath)
def ArenaRewardExcelAddRankEnd(builder, rankEnd): builder.PrependInt64Slot(4, rankEnd, 0)
def AddRankEnd(builder, rankEnd):
    return ArenaRewardExcelAddRankEnd(builder, rankEnd)
def ArenaRewardExcelAddRankStart(builder, rankStart): builder.PrependInt64Slot(5, rankStart, 0)
def AddRankStart(builder, rankStart):
    return ArenaRewardExcelAddRankStart(builder, rankStart)
def ArenaRewardExcelAddArenaRewardType(builder, arenaRewardType): builder.PrependInt32Slot(6, arenaRewardType, 0)
def AddArenaRewardType(builder, arenaRewardType):
    return ArenaRewardExcelAddArenaRewardType(builder, arenaRewardType)
def ArenaRewardExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(7, uniqueId, 0)
