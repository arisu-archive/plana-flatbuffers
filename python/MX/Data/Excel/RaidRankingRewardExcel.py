...
def RaidRankingRewardExcelStart(builder): builder.StartObject(10)
def Start(builder):
    return RaidRankingRewardExcelStart(builder)
def RaidRankingRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def RaidRankingRewardExcelAddRewardParcelUniqueId(builder, rewardParcelUniqueId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueId), 0)
...
def RaidRankingRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def RaidRankingRewardExcelAddTier(builder, tier): builder.PrependInt32Slot(3, tier, 0)
def AddTier(builder, tier):
    return RaidRankingRewardExcelAddTier(builder, tier)
def RaidRankingRewardExcelAddPercentRankEnd(builder, percentRankEnd): builder.PrependInt64Slot(4, percentRankEnd, 0)
def AddPercentRankEnd(builder, percentRankEnd):
    return RaidRankingRewardExcelAddPercentRankEnd(builder, percentRankEnd)
def RaidRankingRewardExcelAddPercentRankStart(builder, percentRankStart): builder.PrependInt64Slot(5, percentRankStart, 0)
...
def RaidRankingRewardExcelAddRankEnd(builder, rankEnd): builder.PrependInt64Slot(6, rankEnd, 0)
def AddRankEnd(builder, rankEnd):
    return RaidRankingRewardExcelAddRankEnd(builder, rankEnd)
def RaidRankingRewardExcelAddRankStart(builder, rankStart): builder.PrependInt64Slot(7, rankStart, 0)
def AddRankStart(builder, rankStart):
    return RaidRankingRewardExcelAddRankStart(builder, rankStart)
def RaidRankingRewardExcelAddId(builder, id): builder.PrependInt64Slot(8, id, 0)
def AddId(builder, id):
    return RaidRankingRewardExcelAddId(builder, id)
def RaidRankingRewardExcelAddRankingRewardGroupId(builder, rankingRewardGroupId): builder.PrependInt64Slot(9, rankingRewardGroupId, 0)
