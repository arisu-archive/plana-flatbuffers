...
def EventContentCardShopModifyExcelAddUsePrefabName(builder, usePrefabName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(usePrefabName), 0)
def AddUsePrefabName(builder, usePrefabName):
    return EventContentCardShopModifyExcelAddUsePrefabName(builder, usePrefabName)
def EventContentCardShopModifyExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(1, eventContentId, 0)
