...
def ShopFilterClassifiedExcelAddGoodsId(builder, goodsId): builder.PrependInt64Slot(0, goodsId, 0)
def AddGoodsId(builder, goodsId):
    return ShopFilterClassifiedExcelAddGoodsId(builder, goodsId)
def ShopFilterClassifiedExcelAddShopFilterType(builder, shopFilterType): builder.PrependInt32Slot(1, shopFilterType, 0)
def AddShopFilterType(builder, shopFilterType):
    return ShopFilterClassifiedExcelAddShopFilterType(builder, shopFilterType)
def ShopFilterClassifiedExcelAddConsumeParcelId(builder, consumeParcelId): builder.PrependInt64Slot(2, consumeParcelId, 0)
def AddConsumeParcelId(builder, consumeParcelId):
    return ShopFilterClassifiedExcelAddConsumeParcelId(builder, consumeParcelId)
def ShopFilterClassifiedExcelAddConsumeParcelType(builder, consumeParcelType): builder.PrependInt32Slot(3, consumeParcelType, 0)
...
def ShopFilterClassifiedExcelAddCategoryType(builder, categoryType): builder.PrependInt32Slot(4, categoryType, 0)
def AddCategoryType(builder, categoryType):
    return ShopFilterClassifiedExcelAddCategoryType(builder, categoryType)
def ShopFilterClassifiedExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
