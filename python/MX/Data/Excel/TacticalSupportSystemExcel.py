...
class TacticalSupportSystemExcelT(object):
    ...
    def __init__(
        ...
        self.id = id  # type: int
        self.summonedTime = summonedTime  # type: int
        self.defaultPersonalityId = defaultPersonalityId  # type: int
        self.canTargeting = canTargeting  # type: bool
        self.canCover = canCover  # type: bool
        self.obstacleUniqueName = obstacleUniqueName  # type: Optional[str]
        self.obstacleCoverRange = obstacleCoverRange  # type: int
        self.summonSkilllGroupId = summonSkilllGroupId  # type: Optional[str]
        self.crashObstacleObbWidth = crashObstacleObbWidth  # type: int
        self.crashObstacleObbHeight = crashObstacleObbHeight  # type: int
        self.isTssBlockedNodeCheck = isTssBlockedNodeCheck  # type: bool
        self.numberOfUses = numberOfUses  # type: int
        self.inventoryOffsetX = inventoryOffsetX  # type: float
        self.inventoryOffsetY = inventoryOffsetY  # type: float
        self.inventoryOffsetZ = inventoryOffsetZ  # type: float
        self.interactionChar = interactionChar  # type: int
        self.characterInteractionStartDelay = characterInteractionStartDelay  # type: int
        self.getOnStartEffectPath = getOnStartEffectPath  # type: Optional[str]
        self.getOnEndEffectPath = getOnEndEffectPath  # type: Optional[str]
        self.summonerCharacterId = summonerCharacterId  # type: int
        self.interactionFrame = interactionFrame  # type: int
        self.tsaInteractionAddDuration = tsaInteractionAddDuration  # type: int
        self.interactionStudentExSkillGroupId = interactionStudentExSkillGroupId  # type: Optional[str]
        self.interactionSkillCardTexture = interactionSkillCardTexture  # type: Optional[str]
        self.interactionSkillSpine = interactionSkillSpine  # type: Optional[str]
        self.retreatFrame = retreatFrame  # type: int
        self.destroyFrame = destroyFrame  # type: int

    @classmethod
    def InitFromBuf(cls, buf, pos):
        tacticalSupportSystemExcel = TacticalSupportSystemExcel()
        tacticalSupportSystemExcel.Init(buf, pos)
        return cls.InitFromObj(tacticalSupportSystemExcel)
    ...
    @classmethod
    def InitFromObj(cls, tacticalSupportSystemExcel):
        x = TacticalSupportSystemExcelT()
        x._UnPack(tacticalSupportSystemExcel)
        return x

    # TacticalSupportSystemExcelT
    def _UnPack(self, tacticalSupportSystemExcel):
        if tacticalSupportSystemExcel is None:
            return
        self.id = tacticalSupportSystemExcel.Id()
        self.summonedTime = tacticalSupportSystemExcel.SummonedTime()
        self.defaultPersonalityId = tacticalSupportSystemExcel.DefaultPersonalityId()
        self.canTargeting = tacticalSupportSystemExcel.CanTargeting()
        self.canCover = tacticalSupportSystemExcel.CanCover()
        self.obstacleUniqueName = tacticalSupportSystemExcel.ObstacleUniqueName()
        self.obstacleCoverRange = tacticalSupportSystemExcel.ObstacleCoverRange()
        self.summonSkilllGroupId = tacticalSupportSystemExcel.SummonSkilllGroupId()
        self.crashObstacleObbWidth = tacticalSupportSystemExcel.CrashObstacleObbWidth()
        self.crashObstacleObbHeight = tacticalSupportSystemExcel.CrashObstacleObbHeight()
        self.isTssBlockedNodeCheck = tacticalSupportSystemExcel.IsTssBlockedNodeCheck()
        self.numberOfUses = tacticalSupportSystemExcel.NumberOfUses()
        self.inventoryOffsetX = tacticalSupportSystemExcel.InventoryOffsetX()
        self.inventoryOffsetY = tacticalSupportSystemExcel.InventoryOffsetY()
        self.inventoryOffsetZ = tacticalSupportSystemExcel.InventoryOffsetZ()
        self.interactionChar = tacticalSupportSystemExcel.InteractionChar()
        self.characterInteractionStartDelay = tacticalSupportSystemExcel.CharacterInteractionStartDelay()
        self.getOnStartEffectPath = tacticalSupportSystemExcel.GetOnStartEffectPath()
        self.getOnEndEffectPath = tacticalSupportSystemExcel.GetOnEndEffectPath()
        self.summonerCharacterId = tacticalSupportSystemExcel.SummonerCharacterId()
        self.interactionFrame = tacticalSupportSystemExcel.InteractionFrame()
        self.tsaInteractionAddDuration = tacticalSupportSystemExcel.TsaInteractionAddDuration()
        self.interactionStudentExSkillGroupId = tacticalSupportSystemExcel.InteractionStudentExSkillGroupId()
        self.interactionSkillCardTexture = tacticalSupportSystemExcel.InteractionSkillCardTexture()
        self.interactionSkillSpine = tacticalSupportSystemExcel.InteractionSkillSpine()
        self.retreatFrame = tacticalSupportSystemExcel.RetreatFrame()
        self.destroyFrame = tacticalSupportSystemExcel.DestroyFrame()

    # TacticalSupportSystemExcelT
    def Pack(self, builder):
        if self.obstacleUniqueName is not None:
            obstacleUniqueName = builder.CreateString(self.obstacleUniqueName)
        if self.summonSkilllGroupId is not None:
            summonSkilllGroupId = builder.CreateString(self.summonSkilllGroupId)
        if self.getOnStartEffectPath is not None:
            getOnStartEffectPath = builder.CreateString(self.getOnStartEffectPath)
        if self.getOnEndEffectPath is not None:
            getOnEndEffectPath = builder.CreateString(self.getOnEndEffectPath)
        if self.interactionStudentExSkillGroupId is not None:
            interactionStudentExSkillGroupId = builder.CreateString(self.interactionStudentExSkillGroupId)
        if self.interactionSkillCardTexture is not None:
            interactionSkillCardTexture = builder.CreateString(self.interactionSkillCardTexture)
        if self.interactionSkillSpine is not None:
            interactionSkillSpine = builder.CreateString(self.interactionSkillSpine)
        TacticalSupportSystemExcelStart(builder)
        TacticalSupportSystemExcelAddId(builder, self.id)
        TacticalSupportSystemExcelAddSummonedTime(builder, self.summonedTime)
        TacticalSupportSystemExcelAddDefaultPersonalityId(builder, self.defaultPersonalityId)
        TacticalSupportSystemExcelAddCanTargeting(builder, self.canTargeting)
        TacticalSupportSystemExcelAddCanCover(builder, self.canCover)
        if self.obstacleUniqueName is not None:
            TacticalSupportSystemExcelAddObstacleUniqueName(builder, obstacleUniqueName)
        TacticalSupportSystemExcelAddObstacleCoverRange(builder, self.obstacleCoverRange)
        if self.summonSkilllGroupId is not None:
            TacticalSupportSystemExcelAddSummonSkilllGroupId(builder, summonSkilllGroupId)
        TacticalSupportSystemExcelAddCrashObstacleObbWidth(builder, self.crashObstacleObbWidth)
        TacticalSupportSystemExcelAddCrashObstacleObbHeight(builder, self.crashObstacleObbHeight)
        TacticalSupportSystemExcelAddIsTssBlockedNodeCheck(builder, self.isTssBlockedNodeCheck)
        TacticalSupportSystemExcelAddNumberOfUses(builder, self.numberOfUses)
        TacticalSupportSystemExcelAddInventoryOffsetX(builder, self.inventoryOffsetX)
        TacticalSupportSystemExcelAddInventoryOffsetY(builder, self.inventoryOffsetY)
        TacticalSupportSystemExcelAddInventoryOffsetZ(builder, self.inventoryOffsetZ)
        TacticalSupportSystemExcelAddInteractionChar(builder, self.interactionChar)
        TacticalSupportSystemExcelAddCharacterInteractionStartDelay(builder, self.characterInteractionStartDelay)
        if self.getOnStartEffectPath is not None:
            TacticalSupportSystemExcelAddGetOnStartEffectPath(builder, getOnStartEffectPath)
        if self.getOnEndEffectPath is not None:
            TacticalSupportSystemExcelAddGetOnEndEffectPath(builder, getOnEndEffectPath)
        TacticalSupportSystemExcelAddSummonerCharacterId(builder, self.summonerCharacterId)
        TacticalSupportSystemExcelAddInteractionFrame(builder, self.interactionFrame)
        TacticalSupportSystemExcelAddTsaInteractionAddDuration(builder, self.tsaInteractionAddDuration)
        if self.interactionStudentExSkillGroupId is not None:
            TacticalSupportSystemExcelAddInteractionStudentExSkillGroupId(builder, interactionStudentExSkillGroupId)
        if self.interactionSkillCardTexture is not None:
            TacticalSupportSystemExcelAddInteractionSkillCardTexture(builder, interactionSkillCardTexture)
        if self.interactionSkillSpine is not None:
            TacticalSupportSystemExcelAddInteractionSkillSpine(builder, interactionSkillSpine)
        TacticalSupportSystemExcelAddRetreatFrame(builder, self.retreatFrame)
        TacticalSupportSystemExcelAddDestroyFrame(builder, self.destroyFrame)
        tacticalSupportSystemExcel = TacticalSupportSystemExcelEnd(builder)
