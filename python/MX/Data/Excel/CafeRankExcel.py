...
def CafeRankExcelAddCafeVisitWeightTagBonus(builder, cafeVisitWeightTagBonus): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(cafeVisitWeightTagBonus), 0)
...
def CafeRankExcelAddCafeVisitWeightTagBonusStep(builder, cafeVisitWeightTagBonusStep): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(cafeVisitWeightTagBonusStep), 0)
...
def CafeRankExcelAddCafeVisitWeightBase(builder, cafeVisitWeightBase): builder.PrependInt32Slot(2, cafeVisitWeightBase, 0)
...
def CafeRankExcelAddCharacterVisitMax(builder, characterVisitMax): builder.PrependInt32Slot(3, characterVisitMax, 0)
def AddCharacterVisitMax(builder, characterVisitMax):
    return CafeRankExcelAddCharacterVisitMax(builder, characterVisitMax)
def CafeRankExcelAddCharacterVisitMin(builder, characterVisitMin): builder.PrependInt32Slot(4, characterVisitMin, 0)
def AddCharacterVisitMin(builder, characterVisitMin):
    return CafeRankExcelAddCharacterVisitMin(builder, characterVisitMin)
def CafeRankExcelAddTagCountMax(builder, tagCountMax): builder.PrependInt64Slot(5, tagCountMax, 0)
...
def CafeRankExcelAddRecipeId(builder, recipeId): builder.PrependInt64Slot(7, recipeId, 0)
def AddRecipeId(builder, recipeId):
    return CafeRankExcelAddRecipeId(builder, recipeId)
def CafeRankExcelAddRank(builder, rank): builder.PrependInt64Slot(8, rank, 0)
def AddRank(builder, rank):
    return CafeRankExcelAddRank(builder, rank)
def CafeRankExcelAddCafeId(builder, cafeId): builder.PrependInt64Slot(9, cafeId, 0)
