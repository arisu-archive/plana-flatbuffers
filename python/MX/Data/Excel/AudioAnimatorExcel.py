...
def AudioAnimatorExcelAddVoiceHash(builder, voiceHash): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(voiceHash), 0)
...
def AudioAnimatorExcelAddAudioClipPath(builder, audioClipPath): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(audioClipPath), 0)
...
def AudioAnimatorExcelAddAudioPriority(builder, audioPriority): builder.PrependInt32Slot(2, audioPriority, 0)
def AddAudioPriority(builder, audioPriority):
    return AudioAnimatorExcelAddAudioPriority(builder, audioPriority)
def AudioAnimatorExcelAddRandomPitchMax(builder, randomPitchMax): builder.PrependInt32Slot(3, randomPitchMax, 0)
...
def AudioAnimatorExcelAddDelay(builder, delay): builder.PrependFloat32Slot(5, delay, 0.0)
...
def AudioAnimatorExcelAddIgnoreVelocity(builder, ignoreVelocity): builder.PrependBoolSlot(7, ignoreVelocity, 0)
def AddIgnoreVelocity(builder, ignoreVelocity):
    return AudioAnimatorExcelAddIgnoreVelocity(builder, ignoreVelocity)
def AudioAnimatorExcelAddIgnoreInterruptPlay(builder, ignoreInterruptPlay): builder.PrependBoolSlot(8, ignoreInterruptPlay, 0)
...
def AudioAnimatorExcelAddIgnoreInterruptDelay(builder, ignoreInterruptDelay): builder.PrependBoolSlot(9, ignoreInterruptDelay, 0)
...
def AudioAnimatorExcelAddStateName(builder, stateName): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(stateName), 0)
def AddStateName(builder, stateName):
    return AudioAnimatorExcelAddStateName(builder, stateName)
def AudioAnimatorExcelAddStateNameHash(builder, stateNameHash): builder.PrependUint32Slot(11, stateNameHash, 0)
