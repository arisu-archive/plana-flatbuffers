...
def CharacterDialogBattlePassExcelAddAnimationName(builder, animationName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(animationName), 0)
def AddAnimationName(builder, animationName):
    return CharacterDialogBattlePassExcelAddAnimationName(builder, animationName)
def CharacterDialogBattlePassExcelAddBattlePassId(builder, battlePassId): builder.PrependInt64Slot(1, battlePassId, 0)
def AddBattlePassId(builder, battlePassId):
    return CharacterDialogBattlePassExcelAddBattlePassId(builder, battlePassId)
def CharacterDialogBattlePassExcelAddCollectionVisible(builder, collectionVisible): builder.PrependBoolSlot(2, collectionVisible, 0)
...
def CharacterDialogBattlePassExcelAddCostumeUniqueId(builder, costumeUniqueId): builder.PrependInt64Slot(3, costumeUniqueId, 0)
...
def CharacterDialogBattlePassExcelAddCvCollectionType(builder, cvCollectionType): builder.PrependInt32Slot(4, cvCollectionType, 0)
...
def CharacterDialogBattlePassExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(10, displayOrder, 0)
...
def CharacterDialogBattlePassExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(12, groupId, 0)
def AddGroupId(builder, groupId):
    return CharacterDialogBattlePassExcelAddGroupId(builder, groupId)
def CharacterDialogBattlePassExcelAddLocalizeCvGroup(builder, localizeCvGroup): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(localizeCvGroup), 0)
...
def CharacterDialogBattlePassExcelAddLocalizeKr(builder, localizeKr): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(localizeKr), 0)
def AddLocalizeKr(builder, localizeKr):
    return CharacterDialogBattlePassExcelAddLocalizeKr(builder, localizeKr)
def CharacterDialogBattlePassExcelAddOriginalCharacterId(builder, originalCharacterId): builder.PrependInt64Slot(16, originalCharacterId, 0)
...
def CharacterDialogBattlePassExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(17, productionStep, 0)
