...
def AssistRewardExcelAddEchelonType(builder, echelonType): builder.PrependInt32Slot(0, echelonType, 0)
def AddEchelonType(builder, echelonType):
    return AssistRewardExcelAddEchelonType(builder, echelonType)
def AssistRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependInt64Slot(1, rewardParcelAmount, 0)
def AddRewardParcelAmount(builder, rewardParcelAmount):
    return AssistRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount)
def AssistRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependInt64Slot(2, rewardParcelId, 0)
def AddRewardParcelId(builder, rewardParcelId):
    return AssistRewardExcelAddRewardParcelId(builder, rewardParcelId)
def AssistRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(3, rewardParcelType, 0)
def AddRewardParcelType(builder, rewardParcelType):
    return AssistRewardExcelAddRewardParcelType(builder, rewardParcelType)
def AssistRewardExcelAddRewardType(builder, rewardType): builder.PrependInt32Slot(4, rewardType, 0)
