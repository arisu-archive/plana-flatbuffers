...
def AssistRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependInt64Slot(0, rewardParcelAmount, 0)
def AddRewardParcelAmount(builder, rewardParcelAmount):
    return AssistRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount)
def AssistRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependInt64Slot(1, rewardParcelId, 0)
...
def AssistRewardExcelAddEchelonType(builder, echelonType): builder.PrependInt32Slot(3, echelonType, 0)
