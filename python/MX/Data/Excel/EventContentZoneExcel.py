...
def EventContentZoneExcelAddWhiteListTags(builder, whiteListTags): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(whiteListTags), 0)
...
def EventContentZoneExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def EventContentZoneExcelAddRewardGroupId(builder, rewardGroupId): builder.PrependInt64Slot(2, rewardGroupId, 0)
def AddRewardGroupId(builder, rewardGroupId):
    return EventContentZoneExcelAddRewardGroupId(builder, rewardGroupId)
def EventContentZoneExcelAddStudentVisitProb(builder, studentVisitProb): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(studentVisitProb), 0)
...
def EventContentZoneExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(4, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EventContentZoneExcelAddLocalizeEtcId(builder, localizeEtcId)
def EventContentZoneExcelAddEventPointForLocationRank(builder, eventPointForLocationRank): builder.PrependInt64Slot(5, eventPointForLocationRank, 0)
...
def EventContentZoneExcelAddLocationId(builder, locationId): builder.PrependInt64Slot(7, locationId, 0)
def AddLocationId(builder, locationId):
    return EventContentZoneExcelAddLocationId(builder, locationId)
def EventContentZoneExcelAddOriginalZoneId(builder, originalZoneId): builder.PrependInt64Slot(8, originalZoneId, 0)
def AddOriginalZoneId(builder, originalZoneId):
    return EventContentZoneExcelAddOriginalZoneId(builder, originalZoneId)
def EventContentZoneExcelAddId(builder, id): builder.PrependInt64Slot(9, id, 0)
