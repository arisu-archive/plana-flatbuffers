...
def CostumeExcelAddShowObjectHpStatus(builder, showObjectHpStatus): builder.PrependBoolSlot(0, showObjectHpStatus, 0)
def AddShowObjectHpStatus(builder, showObjectHpStatus):
    return CostumeExcelAddShowObjectHpStatus(builder, showObjectHpStatus)
def CostumeExcelAddCharacterVoiceGroupId(builder, characterVoiceGroupId): builder.PrependInt64Slot(1, characterVoiceGroupId, 0)
...
def CostumeExcelAddAnimationValidator(builder, animationValidator): builder.PrependBoolSlot(2, animationValidator, 0)
def AddAnimationValidator(builder, animationValidator):
    return CostumeExcelAddAnimationValidator(builder, animationValidator)
def CostumeExcelAddEnterStrategyAnimationName(builder, enterStrategyAnimationName): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(enterStrategyAnimationName), 0)
...
def CostumeExcelAddAnimationSsr(builder, animationSsr): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(animationSsr), 0)
def AddAnimationSsr(builder, animationSsr):
    return CostumeExcelAddAnimationSsr(builder, animationSsr)
def CostumeExcelAddInformationPacel(builder, informationPacel): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(informationPacel), 0)
def AddInformationPacel(builder, informationPacel):
    return CostumeExcelAddInformationPacel(builder, informationPacel)
def CostumeExcelAddTextureSkillCard(builder, textureSkillCard): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(textureSkillCard), 0)
...
def CostumeExcelAddTextureBoss(builder, textureBoss): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(textureBoss), 0)
def AddTextureBoss(builder, textureBoss):
    return CostumeExcelAddTextureBoss(builder, textureBoss)
def CostumeExcelAddUseObjectHpbar(builder, useObjectHpbar): builder.PrependBoolSlot(8, useObjectHpbar, 0)
def AddUseObjectHpbar(builder, useObjectHpbar):
    return CostumeExcelAddUseObjectHpbar(builder, useObjectHpbar)
def CostumeExcelAddCombatStyleTexturePath(builder, combatStyleTexturePath): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(combatStyleTexturePath), 0)
...
def CostumeExcelAddCollectionBgTexturePath(builder, collectionBgTexturePath): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(collectionBgTexturePath), 0)
...
def CostumeExcelAddCollectionTexturePath(builder, collectionTexturePath): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(collectionTexturePath), 0)
...
def CostumeExcelAddTextureDir(builder, textureDir): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(textureDir), 0)
def AddTextureDir(builder, textureDir):
    return CostumeExcelAddTextureDir(builder, textureDir)
def CostumeExcelAddStrategyModelPrefabName(builder, strategyModelPrefabName): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(strategyModelPrefabName), 0)
...
def CostumeExcelAddCafeModelPrefabName(builder, cafeModelPrefabName): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(cafeModelPrefabName), 0)
...
def CostumeExcelAddModelPrefabName(builder, modelPrefabName): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(modelPrefabName), 0)
def AddModelPrefabName(builder, modelPrefabName):
    return CostumeExcelAddModelPrefabName(builder, modelPrefabName)
def CostumeExcelAddEntityMaterialType(builder, entityMaterialType): builder.PrependInt32Slot(18, entityMaterialType, 0)
...
def CostumeExcelAddSpineResourceNameDiorama(builder, spineResourceNameDiorama): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(spineResourceNameDiorama), 0)
...
def CostumeExcelAddSpineResourceName(builder, spineResourceName): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(spineResourceName), 0)
def AddSpineResourceName(builder, spineResourceName):
    return CostumeExcelAddSpineResourceName(builder, spineResourceName)
def CostumeExcelAddCharacterSkillListGroupId(builder, characterSkillListGroupId): builder.PrependInt64Slot(22, characterSkillListGroupId, 0)
...
def CostumeExcelAddRarity(builder, rarity): builder.PrependInt32Slot(23, rarity, 0)
def AddRarity(builder, rarity):
    return CostumeExcelAddRarity(builder, rarity)
def CostumeExcelAddCollectionVisibleEndDate(builder, collectionVisibleEndDate): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(collectionVisibleEndDate), 0)
...
def CostumeExcelAddCollectionVisibleStartDate(builder, collectionVisibleStartDate): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(collectionVisibleStartDate), 0)
...
def CostumeExcelAddReleaseDate(builder, releaseDate): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(releaseDate), 0)
def AddReleaseDate(builder, releaseDate):
    return CostumeExcelAddReleaseDate(builder, releaseDate)
def CostumeExcelAddCollectionVisible(builder, collectionVisible): builder.PrependBoolSlot(27, collectionVisible, 0)
def AddCollectionVisible(builder, collectionVisible):
    return CostumeExcelAddCollectionVisible(builder, collectionVisible)
def CostumeExcelAddIsDefault(builder, isDefault): builder.PrependBoolSlot(28, isDefault, 0)
def AddIsDefault(builder, isDefault):
    return CostumeExcelAddIsDefault(builder, isDefault)
def CostumeExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(29, productionStep, 0)
def AddProductionStep(builder, productionStep):
    return CostumeExcelAddProductionStep(builder, productionStep)
def CostumeExcelAddDevName(builder, devName): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(devName), 0)
def AddDevName(builder, devName):
    return CostumeExcelAddDevName(builder, devName)
def CostumeExcelAddCostumeUniqueId(builder, costumeUniqueId): builder.PrependInt64Slot(31, costumeUniqueId, 0)
def AddCostumeUniqueId(builder, costumeUniqueId):
    return CostumeExcelAddCostumeUniqueId(builder, costumeUniqueId)
def CostumeExcelAddCostumeGroupId(builder, costumeGroupId): builder.PrependInt64Slot(32, costumeGroupId, 0)
