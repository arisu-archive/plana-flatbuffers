...
def CostumeExcelAddCafeModelPrefabName(builder, cafeModelPrefabName): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(cafeModelPrefabName), 0)
...
def CostumeExcelAddCharacterSkillListGroupId(builder, characterSkillListGroupId): builder.PrependInt64Slot(4, characterSkillListGroupId, 0)
...
def CostumeExcelAddCharacterVoiceGroupId(builder, characterVoiceGroupId): builder.PrependInt64Slot(5, characterVoiceGroupId, 0)
...
def CostumeExcelAddCollectionBgTexturePath(builder, collectionBgTexturePath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(collectionBgTexturePath), 0)
...
def CostumeExcelAddCollectionTexturePath(builder, collectionTexturePath): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(collectionTexturePath), 0)
...
def CostumeExcelAddCollectionVisible(builder, collectionVisible): builder.PrependBoolSlot(8, collectionVisible, 0)
def AddCollectionVisible(builder, collectionVisible):
    return CostumeExcelAddCollectionVisible(builder, collectionVisible)
def CostumeExcelAddCollectionVisibleEndDate(builder, collectionVisibleEndDate): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(collectionVisibleEndDate), 0)
...
def CostumeExcelAddCollectionVisibleStartDate(builder, collectionVisibleStartDate): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(collectionVisibleStartDate), 0)
...
def CostumeExcelAddCombatStyleTexturePath(builder, combatStyleTexturePath): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(combatStyleTexturePath), 0)
...
def CostumeExcelAddCostumeGroupId(builder, costumeGroupId): builder.PrependInt64Slot(12, costumeGroupId, 0)
def AddCostumeGroupId(builder, costumeGroupId):
    return CostumeExcelAddCostumeGroupId(builder, costumeGroupId)
def CostumeExcelAddCostumeUniqueId(builder, costumeUniqueId): builder.PrependInt64Slot(13, costumeUniqueId, 0)
def AddCostumeUniqueId(builder, costumeUniqueId):
    return CostumeExcelAddCostumeUniqueId(builder, costumeUniqueId)
def CostumeExcelAddDevName(builder, devName): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(devName), 0)
def AddDevName(builder, devName):
    return CostumeExcelAddDevName(builder, devName)
def CostumeExcelAddEchelonModelPrefabName(builder, echelonModelPrefabName): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(echelonModelPrefabName), 0)
...
def CostumeExcelAddEnterStrategyAnimationName(builder, enterStrategyAnimationName): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(enterStrategyAnimationName), 0)
...
def CostumeExcelAddEntityMaterialType(builder, entityMaterialType): builder.PrependInt32Slot(17, entityMaterialType, 0)
def AddEntityMaterialType(builder, entityMaterialType):
    return CostumeExcelAddEntityMaterialType(builder, entityMaterialType)
def CostumeExcelAddInformationPacel(builder, informationPacel): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(informationPacel), 0)
def AddInformationPacel(builder, informationPacel):
    return CostumeExcelAddInformationPacel(builder, informationPacel)
def CostumeExcelAddIsDefault(builder, isDefault): builder.PrependBoolSlot(19, isDefault, 0)
def AddIsDefault(builder, isDefault):
    return CostumeExcelAddIsDefault(builder, isDefault)
def CostumeExcelAddModelPrefabName(builder, modelPrefabName): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(modelPrefabName), 0)
def AddModelPrefabName(builder, modelPrefabName):
    return CostumeExcelAddModelPrefabName(builder, modelPrefabName)
def CostumeExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(21, productionStep, 0)
def AddProductionStep(builder, productionStep):
    return CostumeExcelAddProductionStep(builder, productionStep)
def CostumeExcelAddRarity(builder, rarity): builder.PrependInt32Slot(22, rarity, 0)
def AddRarity(builder, rarity):
    return CostumeExcelAddRarity(builder, rarity)
def CostumeExcelAddReleaseDate(builder, releaseDate): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(releaseDate), 0)
def AddReleaseDate(builder, releaseDate):
    return CostumeExcelAddReleaseDate(builder, releaseDate)
def CostumeExcelAddShowObjectHpStatus(builder, showObjectHpStatus): builder.PrependBoolSlot(24, showObjectHpStatus, 0)
def AddShowObjectHpStatus(builder, showObjectHpStatus):
    return CostumeExcelAddShowObjectHpStatus(builder, showObjectHpStatus)
def CostumeExcelAddSpineResourceName(builder, spineResourceName): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(spineResourceName), 0)
def AddSpineResourceName(builder, spineResourceName):
    return CostumeExcelAddSpineResourceName(builder, spineResourceName)
def CostumeExcelAddSpineResourceNameDiorama(builder, spineResourceNameDiorama): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(spineResourceNameDiorama), 0)
...
def CostumeExcelAddSpineResourceNameDioramaForFormConversion(builder, spineResourceNameDioramaForFormConversion): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(spineResourceNameDioramaForFormConversion), 0)
...
def CostumeExcelAddStrategyModelPrefabName(builder, strategyModelPrefabName): builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(strategyModelPrefabName), 0)
...
def CostumeExcelAddTextureBoss(builder, textureBoss): builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(textureBoss), 0)
def AddTextureBoss(builder, textureBoss):
    return CostumeExcelAddTextureBoss(builder, textureBoss)
def CostumeExcelAddTextureDir(builder, textureDir): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(textureDir), 0)
def AddTextureDir(builder, textureDir):
    return CostumeExcelAddTextureDir(builder, textureDir)
def CostumeExcelAddTextureSkillCard(builder, textureSkillCard): builder.PrependUOffsetTRelativeSlot(31, flatbuffers.number_types.UOffsetTFlags.py_type(textureSkillCard), 0)
...
def CostumeExcelAddUseObjectHpbar(builder, useObjectHpbar): builder.PrependBoolSlot(32, useObjectHpbar, 0)
