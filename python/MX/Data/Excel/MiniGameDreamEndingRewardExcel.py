...
def MiniGameDreamEndingRewardExcelAddDreamMakerEndingRewardType(builder, dreamMakerEndingRewardType): builder.PrependInt32Slot(0, dreamMakerEndingRewardType, 0)
...
def MiniGameDreamEndingRewardExcelAddDreamMakerEndingType(builder, dreamMakerEndingType): builder.PrependInt32Slot(1, dreamMakerEndingType, 0)
...
def MiniGameDreamEndingRewardExcelAddEndingId(builder, endingId): builder.PrependInt64Slot(2, endingId, 0)
def AddEndingId(builder, endingId):
    return MiniGameDreamEndingRewardExcelAddEndingId(builder, endingId)
def MiniGameDreamEndingRewardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MiniGameDreamEndingRewardExcelAddEventContentId(builder, eventContentId)
def MiniGameDreamEndingRewardExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(4, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return MiniGameDreamEndingRewardExcelAddLocalizeEtcId(builder, localizeEtcId)
def MiniGameDreamEndingRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def MiniGameDreamEndingRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
