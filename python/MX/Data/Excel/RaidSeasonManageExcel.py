...
def RaidSeasonManageExcelAddEndNoteLabelStartDate(builder, endNoteLabelStartDate): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(endNoteLabelStartDate), 0)
...
def RaidSeasonManageExcelAddMaxSeasonRewardGauage(builder, maxSeasonRewardGauage): builder.PrependInt32Slot(1, maxSeasonRewardGauage, 0)
...
def RaidSeasonManageExcelAddOpenRaidBossGroup(builder, openRaidBossGroup): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(openRaidBossGroup), 0)
...
def RaidSeasonManageExcelAddSeasonDisplay(builder, seasonDisplay): builder.PrependInt64Slot(4, seasonDisplay, 0)
def AddSeasonDisplay(builder, seasonDisplay):
    return RaidSeasonManageExcelAddSeasonDisplay(builder, seasonDisplay)
def RaidSeasonManageExcelAddSeasonEndData(builder, seasonEndData): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(seasonEndData), 0)
def AddSeasonEndData(builder, seasonEndData):
    return RaidSeasonManageExcelAddSeasonEndData(builder, seasonEndData)
def RaidSeasonManageExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(6, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return RaidSeasonManageExcelAddSeasonId(builder, seasonId)
def RaidSeasonManageExcelAddSeasonRewardId(builder, seasonRewardId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(seasonRewardId), 0)
...
def RaidSeasonManageExcelAddSettlementEndDate(builder, settlementEndDate): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(settlementEndDate), 0)
...
def RaidSeasonManageExcelAddStackedSeasonRewardGauge(builder, stackedSeasonRewardGauge): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(stackedSeasonRewardGauge), 0)
