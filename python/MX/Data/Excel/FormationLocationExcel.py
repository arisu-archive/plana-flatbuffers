...
def FormationLocationExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
def AddId(builder, id):
    return FormationLocationExcelAddId(builder, id)
def FormationLocationExcelAddSlotX(builder, slotX): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(slotX), 0)
...
def FormationLocationExcelAddSlotZ(builder, slotZ): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(slotZ), 0)
