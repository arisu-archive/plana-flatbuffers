...
def ScenarioContentCollectionExcelAddEmblemResource(builder, emblemResource): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(emblemResource), 0)
...
def ScenarioContentCollectionExcelAddFullResource(builder, fullResource): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(fullResource), 0)
def AddFullResource(builder, fullResource):
    return ScenarioContentCollectionExcelAddFullResource(builder, fullResource)
def ScenarioContentCollectionExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(2, groupId, 0)
def AddGroupId(builder, groupId):
    return ScenarioContentCollectionExcelAddGroupId(builder, groupId)
def ScenarioContentCollectionExcelAddId(builder, id): builder.PrependInt64Slot(3, id, 0)
def AddId(builder, id):
    return ScenarioContentCollectionExcelAddId(builder, id)
def ScenarioContentCollectionExcelAddIsHorizon(builder, isHorizon): builder.PrependBoolSlot(4, isHorizon, 0)
def AddIsHorizon(builder, isHorizon):
    return ScenarioContentCollectionExcelAddIsHorizon(builder, isHorizon)
def ScenarioContentCollectionExcelAddIsObject(builder, isObject): builder.PrependBoolSlot(5, isObject, 0)
def AddIsObject(builder, isObject):
    return ScenarioContentCollectionExcelAddIsObject(builder, isObject)
def ScenarioContentCollectionExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(6, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return ScenarioContentCollectionExcelAddLocalizeEtcId(builder, localizeEtcId)
def ScenarioContentCollectionExcelAddMultipleConditionCheckType(builder, multipleConditionCheckType): builder.PrependInt32Slot(7, multipleConditionCheckType, 0)
...
def ScenarioContentCollectionExcelAddSubNameLocalizeCodeId(builder, subNameLocalizeCodeId): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(subNameLocalizeCodeId), 0)
...
def ScenarioContentCollectionExcelAddUnlockConditionCount(builder, unlockConditionCount): builder.PrependInt64Slot(10, unlockConditionCount, 0)
...
def ScenarioContentCollectionExcelAddUnlockConditionParameter(builder, unlockConditionParameter): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(unlockConditionParameter), 0)
...
def ScenarioContentCollectionExcelAddUnlockConditionType(builder, unlockConditionType): builder.PrependInt32Slot(12, unlockConditionType, 0)
