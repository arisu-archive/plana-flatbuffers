...
def ArenaSeasonCloseRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def ArenaSeasonCloseRewardExcelAddRewardParcelUniqueId(builder, rewardParcelUniqueId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueId), 0)
...
def ArenaSeasonCloseRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def ArenaSeasonCloseRewardExcelAddRankEnd(builder, rankEnd): builder.PrependInt64Slot(3, rankEnd, 0)
def AddRankEnd(builder, rankEnd):
    return ArenaSeasonCloseRewardExcelAddRankEnd(builder, rankEnd)
def ArenaSeasonCloseRewardExcelAddRankStart(builder, rankStart): builder.PrependInt64Slot(4, rankStart, 0)
def AddRankStart(builder, rankStart):
    return ArenaSeasonCloseRewardExcelAddRankStart(builder, rankStart)
def ArenaSeasonCloseRewardExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(5, seasonId, 0)
