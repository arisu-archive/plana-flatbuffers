...
def EquipmentExcelAddCraftQualityTier0(builder, craftQualityTier0): builder.PrependInt64Slot(0, craftQualityTier0, 0)
def AddCraftQualityTier0(builder, craftQualityTier0):
    return EquipmentExcelAddCraftQualityTier0(builder, craftQualityTier0)
def EquipmentExcelAddCraftQualityTier1(builder, craftQualityTier1): builder.PrependInt64Slot(1, craftQualityTier1, 0)
def AddCraftQualityTier1(builder, craftQualityTier1):
    return EquipmentExcelAddCraftQualityTier1(builder, craftQualityTier1)
def EquipmentExcelAddCraftQualityTier2(builder, craftQualityTier2): builder.PrependInt64Slot(2, craftQualityTier2, 0)
def AddCraftQualityTier2(builder, craftQualityTier2):
    return EquipmentExcelAddCraftQualityTier2(builder, craftQualityTier2)
def EquipmentExcelAddEquipmentCategory(builder, equipmentCategory): builder.PrependInt32Slot(3, equipmentCategory, 0)
def AddEquipmentCategory(builder, equipmentCategory):
    return EquipmentExcelAddEquipmentCategory(builder, equipmentCategory)
def EquipmentExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
def AddIcon(builder, icon):
    return EquipmentExcelAddIcon(builder, icon)
def EquipmentExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
def AddId(builder, id):
    return EquipmentExcelAddId(builder, id)
def EquipmentExcelAddImageName(builder, imageName): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(imageName), 0)
def AddImageName(builder, imageName):
    return EquipmentExcelAddImageName(builder, imageName)
def EquipmentExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(7, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EquipmentExcelAddLocalizeEtcId(builder, localizeEtcId)
def EquipmentExcelAddMaxLevel(builder, maxLevel): builder.PrependInt32Slot(8, maxLevel, 0)
def AddMaxLevel(builder, maxLevel):
    return EquipmentExcelAddMaxLevel(builder, maxLevel)
def EquipmentExcelAddNextTierEquipment(builder, nextTierEquipment): builder.PrependInt64Slot(9, nextTierEquipment, 0)
def AddNextTierEquipment(builder, nextTierEquipment):
    return EquipmentExcelAddNextTierEquipment(builder, nextTierEquipment)
def EquipmentExcelAddRarity(builder, rarity): builder.PrependInt32Slot(10, rarity, 0)
def AddRarity(builder, rarity):
    return EquipmentExcelAddRarity(builder, rarity)
def EquipmentExcelAddRecipeId(builder, recipeId): builder.PrependInt32Slot(11, recipeId, 0)
def AddRecipeId(builder, recipeId):
    return EquipmentExcelAddRecipeId(builder, recipeId)
def EquipmentExcelAddShiftingCraftQuality(builder, shiftingCraftQuality): builder.PrependInt64Slot(12, shiftingCraftQuality, 0)
...
def EquipmentExcelAddShopCategory(builder, shopCategory): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(shopCategory), 0)
...
def EquipmentExcelAddShortcutTypeId(builder, shortcutTypeId): builder.PrependInt64Slot(14, shortcutTypeId, 0)
def AddShortcutTypeId(builder, shortcutTypeId):
    return EquipmentExcelAddShortcutTypeId(builder, shortcutTypeId)
def EquipmentExcelAddStackableMax(builder, stackableMax): builder.PrependInt32Slot(15, stackableMax, 0)
def AddStackableMax(builder, stackableMax):
    return EquipmentExcelAddStackableMax(builder, stackableMax)
def EquipmentExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def EquipmentExcelAddTierInit(builder, tierInit): builder.PrependInt64Slot(17, tierInit, 0)
def AddTierInit(builder, tierInit):
    return EquipmentExcelAddTierInit(builder, tierInit)
def EquipmentExcelAddWear(builder, wear): builder.PrependBoolSlot(18, wear, 0)
