...
def EventContentConcentrationCardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(2, eventContentId, 0)
...
def EventContentConcentrationCardExcelAddRarity(builder, rarity): builder.PrependInt32Slot(4, rarity, 0)
