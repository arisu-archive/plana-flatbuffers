...
def CharacterCalculationLimitExcelAddDecreaseRate(builder, decreaseRate): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(decreaseRate), 0)
...
def CharacterCalculationLimitExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return CharacterCalculationLimitExcelAddId(builder, id)
def CharacterCalculationLimitExcelAddLimitStartValue(builder, limitStartValue): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(limitStartValue), 0)
...
def CharacterCalculationLimitExcelAddMinValue(builder, minValue): builder.PrependInt64Slot(5, minValue, 0)
def AddMinValue(builder, minValue):
    return CharacterCalculationLimitExcelAddMinValue(builder, minValue)
def CharacterCalculationLimitExcelAddTacticEntityType(builder, tacticEntityType): builder.PrependInt32Slot(6, tacticEntityType, 0)
