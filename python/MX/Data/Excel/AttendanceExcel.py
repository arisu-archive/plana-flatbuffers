...
def AttendanceExcelAddDecorationGarlandImagePath(builder, decorationGarlandImagePath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(decorationGarlandImagePath), 0)
...
def AttendanceExcelAddDecorationImagePath(builder, decorationImagePath): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(decorationImagePath), 0)
...
def AttendanceExcelAddTitleImagePath(builder, titleImagePath): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(titleImagePath), 0)
def AddTitleImagePath(builder, titleImagePath):
    return AttendanceExcelAddTitleImagePath(builder, titleImagePath)
def AttendanceExcelAddDialogCategory(builder, dialogCategory): builder.PrependInt32Slot(3, dialogCategory, 0)
def AddDialogCategory(builder, dialogCategory):
    return AttendanceExcelAddDialogCategory(builder, dialogCategory)
def AttendanceExcelAddMailType(builder, mailType): builder.PrependInt32Slot(4, mailType, 0)
def AddMailType(builder, mailType):
    return AttendanceExcelAddMailType(builder, mailType)
def AttendanceExcelAddExpiryDate(builder, expiryDate): builder.PrependInt64Slot(5, expiryDate, 0)
def AddExpiryDate(builder, expiryDate):
    return AttendanceExcelAddExpiryDate(builder, expiryDate)
def AttendanceExcelAddEndDate(builder, endDate): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(endDate), 0)
def AddEndDate(builder, endDate):
    return AttendanceExcelAddEndDate(builder, endDate)
def AttendanceExcelAddStartableEndDate(builder, startableEndDate): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(startableEndDate), 0)
def AddStartableEndDate(builder, startableEndDate):
    return AttendanceExcelAddStartableEndDate(builder, startableEndDate)
def AttendanceExcelAddStartDate(builder, startDate): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(startDate), 0)
def AddStartDate(builder, startDate):
    return AttendanceExcelAddStartDate(builder, startDate)
def AttendanceExcelAddBookSize(builder, bookSize): builder.PrependInt64Slot(9, bookSize, 0)
def AddBookSize(builder, bookSize):
    return AttendanceExcelAddBookSize(builder, bookSize)
def AttendanceExcelAddCountReset(builder, countReset): builder.PrependInt32Slot(10, countReset, 0)
def AddCountReset(builder, countReset):
    return AttendanceExcelAddCountReset(builder, countReset)
def AttendanceExcelAddCountRule(builder, countRule): builder.PrependInt32Slot(11, countRule, 0)
...
def AttendanceExcelAddTitle(builder, title): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(title), 0)
def AddTitle(builder, title):
    return AttendanceExcelAddTitle(builder, title)
def AttendanceExcelAddAccountLevelLimit(builder, accountLevelLimit): builder.PrependInt64Slot(14, accountLevelLimit, 0)
def AddAccountLevelLimit(builder, accountLevelLimit):
    return AttendanceExcelAddAccountLevelLimit(builder, accountLevelLimit)
def AttendanceExcelAddAccountType(builder, accountType): builder.PrependInt32Slot(15, accountType, 0)
def AddAccountType(builder, accountType):
    return AttendanceExcelAddAccountType(builder, accountType)
def AttendanceExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(16, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return AttendanceExcelAddDisplayOrder(builder, displayOrder)
def AttendanceExcelAddCountdownPrefab(builder, countdownPrefab): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(countdownPrefab), 0)
...
def AttendanceExcelAddId(builder, id): builder.PrependInt64Slot(19, id, 0)
