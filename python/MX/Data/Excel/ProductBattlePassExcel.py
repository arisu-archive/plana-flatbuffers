...
def ProductBattlePassExcelAddBattlePassProductGroupId(builder, battlePassProductGroupId): builder.PrependInt64Slot(0, battlePassProductGroupId, 0)
...
def ProductBattlePassExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
def AddId(builder, id):
    return ProductBattlePassExcelAddId(builder, id)
def ProductBattlePassExcelAddParcelAmount(builder, parcelAmount): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(parcelAmount), 0)
...
def ProductBattlePassExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
...
def ProductBattlePassExcelAddParcelType(builder, parcelType): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(parcelType), 0)
...
def ProductBattlePassExcelAddProductId(builder, productId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(productId), 0)
def AddProductId(builder, productId):
    return ProductBattlePassExcelAddProductId(builder, productId)
def ProductBattlePassExcelAddPurchaseCountLimit(builder, purchaseCountLimit): builder.PrependInt64Slot(7, purchaseCountLimit, 0)
...
def ProductBattlePassExcelAddStoreType(builder, storeType): builder.PrependInt32Slot(8, storeType, 0)
