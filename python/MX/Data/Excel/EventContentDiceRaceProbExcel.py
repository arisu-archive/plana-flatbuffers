...
def EventContentDiceRaceProbExcelAddProb(builder, prob): builder.PrependInt32Slot(0, prob, 0)
def AddProb(builder, prob):
    return EventContentDiceRaceProbExcelAddProb(builder, prob)
def EventContentDiceRaceProbExcelAddDiceResult(builder, diceResult): builder.PrependInt32Slot(1, diceResult, 0)
def AddDiceResult(builder, diceResult):
    return EventContentDiceRaceProbExcelAddDiceResult(builder, diceResult)
def EventContentDiceRaceProbExcelAddCostItemAmount(builder, costItemAmount): builder.PrependInt32Slot(2, costItemAmount, 0)
def AddCostItemAmount(builder, costItemAmount):
    return EventContentDiceRaceProbExcelAddCostItemAmount(builder, costItemAmount)
def EventContentDiceRaceProbExcelAddCostItemId(builder, costItemId): builder.PrependInt64Slot(3, costItemId, 0)
def AddCostItemId(builder, costItemId):
    return EventContentDiceRaceProbExcelAddCostItemId(builder, costItemId)
def EventContentDiceRaceProbExcelAddEventContentDiceRaceResultType(builder, eventContentDiceRaceResultType): builder.PrependInt32Slot(4, eventContentDiceRaceResultType, 0)
...
def EventContentDiceRaceProbExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(5, eventContentId, 0)
