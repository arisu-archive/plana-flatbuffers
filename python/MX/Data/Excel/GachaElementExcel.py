...
def GachaElementExcelAddGachaGroupId(builder, gachaGroupId): builder.PrependInt64Slot(0, gachaGroupId, 0)
def AddGachaGroupId(builder, gachaGroupId):
    return GachaElementExcelAddGachaGroupId(builder, gachaGroupId)
def GachaElementExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
...
def GachaElementExcelAddParcelId(builder, parcelId): builder.PrependInt64Slot(4, parcelId, 0)
def AddParcelId(builder, parcelId):
    return GachaElementExcelAddParcelId(builder, parcelId)
def GachaElementExcelAddParcelType(builder, parcelType): builder.PrependInt32Slot(5, parcelType, 0)
def AddParcelType(builder, parcelType):
    return GachaElementExcelAddParcelType(builder, parcelType)
def GachaElementExcelAddProb(builder, prob): builder.PrependInt32Slot(6, prob, 0)
def AddProb(builder, prob):
    return GachaElementExcelAddProb(builder, prob)
def GachaElementExcelAddRarity(builder, rarity): builder.PrependInt32Slot(7, rarity, 0)
