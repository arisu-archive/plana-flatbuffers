...
def MinigameTBGSeasonExcelAddMaxDicePlus(builder, maxDicePlus): builder.PrependInt32Slot(0, maxDicePlus, 0)
def AddMaxDicePlus(builder, maxDicePlus):
    return MinigameTBGSeasonExcelAddMaxDicePlus(builder, maxDicePlus)
def MinigameTBGSeasonExcelAddLoopThemaIndex(builder, loopThemaIndex): builder.PrependInt32Slot(1, loopThemaIndex, 0)
def AddLoopThemaIndex(builder, loopThemaIndex):
    return MinigameTBGSeasonExcelAddLoopThemaIndex(builder, loopThemaIndex)
def MinigameTBGSeasonExcelAddStartThemaIndex(builder, startThemaIndex): builder.PrependInt32Slot(2, startThemaIndex, 0)
def AddStartThemaIndex(builder, startThemaIndex):
    return MinigameTBGSeasonExcelAddStartThemaIndex(builder, startThemaIndex)
def MinigameTBGSeasonExcelAddMapNameLocalize(builder, mapNameLocalize): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(mapNameLocalize), 0)
def AddMapNameLocalize(builder, mapNameLocalize):
    return MinigameTBGSeasonExcelAddMapNameLocalize(builder, mapNameLocalize)
def MinigameTBGSeasonExcelAddMapImagePath(builder, mapImagePath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(mapImagePath), 0)
def AddMapImagePath(builder, mapImagePath):
    return MinigameTBGSeasonExcelAddMapImagePath(builder, mapImagePath)
def MinigameTBGSeasonExcelAddMaxHp(builder, maxHp): builder.PrependInt32Slot(5, maxHp, 0)
def AddMaxHp(builder, maxHp):
    return MinigameTBGSeasonExcelAddMaxHp(builder, maxHp)
def MinigameTBGSeasonExcelAddInstantClearRound(builder, instantClearRound): builder.PrependInt32Slot(6, instantClearRound, 0)
...
def MinigameTBGSeasonExcelAddRoundItemSelectLimit(builder, roundItemSelectLimit): builder.PrependInt32Slot(7, roundItemSelectLimit, 0)
...
def MinigameTBGSeasonExcelAddCriticalAttackDamage(builder, criticalAttackDamage): builder.PrependInt32Slot(8, criticalAttackDamage, 0)
...
def MinigameTBGSeasonExcelAddAttackDamage(builder, attackDamage): builder.PrependInt32Slot(9, attackDamage, 0)
def AddAttackDamage(builder, attackDamage):
    return MinigameTBGSeasonExcelAddAttackDamage(builder, attackDamage)
def MinigameTBGSeasonExcelAddEnemyMinionHp(builder, enemyMinionHp): builder.PrependInt32Slot(10, enemyMinionHp, 0)
def AddEnemyMinionHp(builder, enemyMinionHp):
    return MinigameTBGSeasonExcelAddEnemyMinionHp(builder, enemyMinionHp)
def MinigameTBGSeasonExcelAddEnemyBossHp(builder, enemyBossHp): builder.PrependInt32Slot(11, enemyBossHp, 0)
def AddEnemyBossHp(builder, enemyBossHp):
    return MinigameTBGSeasonExcelAddEnemyBossHp(builder, enemyBossHp)
def MinigameTBGSeasonExcelAddEchelonRevivalCostAmount(builder, echelonRevivalCostAmount): builder.PrependInt32Slot(12, echelonRevivalCostAmount, 0)
...
def MinigameTBGSeasonExcelAddEchelonRevivalCostId(builder, echelonRevivalCostId): builder.PrependInt64Slot(13, echelonRevivalCostId, 0)
...
def MinigameTBGSeasonExcelAddEventUseCostId(builder, eventUseCostId): builder.PrependInt64Slot(15, eventUseCostId, 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot4Portrait(builder, echelonSlot4Portrait): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(echelonSlot4Portrait), 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot3Portrait(builder, echelonSlot3Portrait): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(echelonSlot3Portrait), 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot2Portrait(builder, echelonSlot2Portrait): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(echelonSlot2Portrait), 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot1Portrait(builder, echelonSlot1Portrait): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(echelonSlot1Portrait), 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot4CharacterId(builder, echelonSlot4CharacterId): builder.PrependInt64Slot(21, echelonSlot4CharacterId, 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot3CharacterId(builder, echelonSlot3CharacterId): builder.PrependInt64Slot(22, echelonSlot3CharacterId, 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot2CharacterId(builder, echelonSlot2CharacterId): builder.PrependInt64Slot(23, echelonSlot2CharacterId, 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot1CharacterId(builder, echelonSlot1CharacterId): builder.PrependInt64Slot(24, echelonSlot1CharacterId, 0)
...
def MinigameTBGSeasonExcelAddDefaultItemDiceId(builder, defaultItemDiceId): builder.PrependInt64Slot(25, defaultItemDiceId, 0)
...
def MinigameTBGSeasonExcelAddDefaultEchelonHp(builder, defaultEchelonHp): builder.PrependInt32Slot(26, defaultEchelonHp, 0)
...
def MinigameTBGSeasonExcelAddItemSlot(builder, itemSlot): builder.PrependInt32Slot(27, itemSlot, 0)
def AddItemSlot(builder, itemSlot):
    return MinigameTBGSeasonExcelAddItemSlot(builder, itemSlot)
def MinigameTBGSeasonExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(28, eventContentId, 0)
