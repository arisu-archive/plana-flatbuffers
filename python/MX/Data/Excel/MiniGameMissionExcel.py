...
def MiniGameMissionExcelAddAccountLevel(builder, accountLevel): builder.PrependInt64Slot(0, accountLevel, 0)
def AddAccountLevel(builder, accountLevel):
    return MiniGameMissionExcelAddAccountLevel(builder, accountLevel)
def MiniGameMissionExcelAddAccountType(builder, accountType): builder.PrependInt32Slot(1, accountType, 0)
def AddAccountType(builder, accountType):
    return MiniGameMissionExcelAddAccountType(builder, accountType)
def MiniGameMissionExcelAddCategory(builder, category): builder.PrependInt32Slot(2, category, 0)
def AddCategory(builder, category):
    return MiniGameMissionExcelAddCategory(builder, category)
def MiniGameMissionExcelAddCompleteConditionCount(builder, completeConditionCount): builder.PrependInt64Slot(3, completeConditionCount, 0)
...
def MiniGameMissionExcelAddCompleteConditionMissionCount(builder, completeConditionMissionCount): builder.PrependInt64Slot(4, completeConditionMissionCount, 0)
...
def MiniGameMissionExcelAddCompleteConditionMissionId(builder, completeConditionMissionId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionMissionId), 0)
...
def MiniGameMissionExcelAddCompleteConditionParameterTag(builder, completeConditionParameterTag): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameterTag), 0)
...
def MiniGameMissionExcelAddCompleteConditionType(builder, completeConditionType): builder.PrependInt32Slot(8, completeConditionType, 0)
...
def MiniGameMissionExcelAddConditionRewardAmount(builder, conditionRewardAmount): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardAmount), 0)
...
def MiniGameMissionExcelAddConditionRewardParcelId(builder, conditionRewardParcelId): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardParcelId), 0)
...
def MiniGameMissionExcelAddConditionRewardParcelType(builder, conditionRewardParcelType): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardParcelType), 0)
...
def MiniGameMissionExcelAddDescription(builder, description): builder.PrependUint32Slot(12, description, 0)
def AddDescription(builder, description):
    return MiniGameMissionExcelAddDescription(builder, description)
def MiniGameMissionExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(13, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return MiniGameMissionExcelAddDisplayOrder(builder, displayOrder)
def MiniGameMissionExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(14, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MiniGameMissionExcelAddEventContentId(builder, eventContentId)
def MiniGameMissionExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(15, groupId, 0)
def AddGroupId(builder, groupId):
    return MiniGameMissionExcelAddGroupId(builder, groupId)
def MiniGameMissionExcelAddGroupName(builder, groupName): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(groupName), 0)
def AddGroupName(builder, groupName):
    return MiniGameMissionExcelAddGroupName(builder, groupName)
def MiniGameMissionExcelAddId(builder, id): builder.PrependInt64Slot(17, id, 0)
def AddId(builder, id):
    return MiniGameMissionExcelAddId(builder, id)
def MiniGameMissionExcelAddIsCompleteExtensionTime(builder, isCompleteExtensionTime): builder.PrependBoolSlot(18, isCompleteExtensionTime, 0)
...
def MiniGameMissionExcelAddMissionRewardAmount(builder, missionRewardAmount): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardAmount), 0)
...
def MiniGameMissionExcelAddMissionRewardParcelId(builder, missionRewardParcelId): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelId), 0)
...
def MiniGameMissionExcelAddPreMissionId(builder, preMissionId): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(preMissionId), 0)
...
def MiniGameMissionExcelAddResetType(builder, resetType): builder.PrependInt32Slot(23, resetType, 0)
def AddResetType(builder, resetType):
    return MiniGameMissionExcelAddResetType(builder, resetType)
def MiniGameMissionExcelAddRewardIcon(builder, rewardIcon): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(rewardIcon), 0)
def AddRewardIcon(builder, rewardIcon):
    return MiniGameMissionExcelAddRewardIcon(builder, rewardIcon)
def MiniGameMissionExcelAddShortcutUi(builder, shortcutUi): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUi), 0)
...
def MiniGameMissionExcelAddToastDisplayType(builder, toastDisplayType): builder.PrependInt32Slot(26, toastDisplayType, 0)
def AddToastDisplayType(builder, toastDisplayType):
    return MiniGameMissionExcelAddToastDisplayType(builder, toastDisplayType)
def MiniGameMissionExcelAddToastImagePath(builder, toastImagePath): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
def AddToastImagePath(builder, toastImagePath):
    return MiniGameMissionExcelAddToastImagePath(builder, toastImagePath)
def MiniGameMissionExcelAddViewFlag(builder, viewFlag): builder.PrependBoolSlot(28, viewFlag, 0)
