...
def ShopExcelAddShopUpdateGroupId(builder, shopUpdateGroupId): builder.PrependInt32Slot(0, shopUpdateGroupId, 0)
def AddShopUpdateGroupId(builder, shopUpdateGroupId):
    return ShopExcelAddShopUpdateGroupId(builder, shopUpdateGroupId)
def ShopExcelAddDisplayTag(builder, displayTag): builder.PrependInt32Slot(1, displayTag, 0)
def AddDisplayTag(builder, displayTag):
    return ShopExcelAddDisplayTag(builder, displayTag)
def ShopExcelAddRestrictBuyWhenInventoryFull(builder, restrictBuyWhenInventoryFull): builder.PrependBoolSlot(2, restrictBuyWhenInventoryFull, 0)
...
def ShopExcelAddPurchaseCountResetType(builder, purchaseCountResetType): builder.PrependInt32Slot(4, purchaseCountResetType, 0)
...
def ShopExcelAddPurchaseCountLimit(builder, purchaseCountLimit): builder.PrependInt64Slot(5, purchaseCountLimit, 0)
...
def ShopExcelAddSalePeriodFrom(builder, salePeriodFrom): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(salePeriodFrom), 0)
def AddSalePeriodFrom(builder, salePeriodFrom):
    return ShopExcelAddSalePeriodFrom(builder, salePeriodFrom)
def ShopExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(9, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return ShopExcelAddDisplayOrder(builder, displayOrder)
def ShopExcelAddGoodsId(builder, goodsId): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(goodsId), 0)
...
def ShopExcelAddUseBigPopup(builder, useBigPopup): builder.PrependBoolSlot(11, useBigPopup, 0)
def AddUseBigPopup(builder, useBigPopup):
    return ShopExcelAddUseBigPopup(builder, useBigPopup)
def ShopExcelAddIsLegacy(builder, isLegacy): builder.PrependBoolSlot(12, isLegacy, 0)
...
def ShopExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(14, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return ShopExcelAddLocalizeEtcId(builder, localizeEtcId)
def ShopExcelAddId(builder, id): builder.PrependInt64Slot(15, id, 0)
