...
def AccountLevelExcelAddNeedReportEvent(builder, needReportEvent): builder.PrependBoolSlot(0, needReportEvent, 0)
def AddNeedReportEvent(builder, needReportEvent):
    return AccountLevelExcelAddNeedReportEvent(builder, needReportEvent)
def AccountLevelExcelAddApAutoChargeMax(builder, apAutoChargeMax): builder.PrependInt64Slot(1, apAutoChargeMax, 0)
def AddApAutoChargeMax(builder, apAutoChargeMax):
    return AccountLevelExcelAddApAutoChargeMax(builder, apAutoChargeMax)
def AccountLevelExcelAddCloseInterval(builder, closeInterval): builder.PrependInt32Slot(2, closeInterval, 0)
...
def AccountLevelExcelAddExp(builder, exp): builder.PrependInt64Slot(4, exp, 0)
def AddExp(builder, exp):
    return AccountLevelExcelAddExp(builder, exp)
def AccountLevelExcelAddLevel(builder, level): builder.PrependInt64Slot(5, level, 0)
