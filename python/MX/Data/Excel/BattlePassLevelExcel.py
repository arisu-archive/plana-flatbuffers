...
def BattlePassLevelExcelAddIsPickUpReward(builder, isPickUpReward): builder.PrependBoolSlot(1, isPickUpReward, 0)
def AddIsPickUpReward(builder, isPickUpReward):
    return BattlePassLevelExcelAddIsPickUpReward(builder, isPickUpReward)
def BattlePassLevelExcelAddLevel(builder, level): builder.PrependInt64Slot(2, level, 0)
