...
def RecipeCraftExcelAddId(builder, id): builder.PrependInt64Slot(0, id, 0)
...
def RecipeCraftExcelAddRecipeIngredientId(builder, recipeIngredientId): builder.PrependInt64Slot(3, recipeIngredientId, 0)
