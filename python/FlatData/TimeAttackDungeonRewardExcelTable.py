...
class TimeAttackDungeonRewardExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsTimeAttackDungeonRewardExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.TimeAttackDungeonRewardExcel import TimeAttackDungeonRewardExcel
