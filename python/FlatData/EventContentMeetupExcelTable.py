...
class EventContentMeetupExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsEventContentMeetupExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.EventContentMeetupExcel import EventContentMeetupExcel
            obj = EventContentMeetupExcel()
