...
class MiniGameShootingStageRewardExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsMiniGameShootingStageRewardExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.MiniGameShootingStageRewardExcel import MiniGameShootingStageRewardExcel
            obj = MiniGameShootingStageRewardExcel()
