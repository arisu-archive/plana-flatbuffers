...
class EventContentDiceRaceTotalRewardExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsEventContentDiceRaceTotalRewardExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.EventContentDiceRaceTotalRewardExcel import EventContentDiceRaceTotalRewardExcel
            obj = EventContentDiceRaceTotalRewardExcel()
