...
def SpecialLobbyIllustExcelAddSlotTextureName(builder, slotTextureName): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(slotTextureName), 0)
...
def SpecialLobbyIllustExcelAddCharacterCostumeUniqueId(builder, characterCostumeUniqueId): builder.PrependInt64Slot(3, characterCostumeUniqueId, 0)
...
def SpecialLobbyIllustExcelAddDevName(builder, devName): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(devName), 0)
