...
def ConstMinigameRoadPuzzleExcelAddLoopStageIndex(builder, loopStageIndex): builder.PrependInt32Slot(0, loopStageIndex, 0)
def AddLoopStageIndex(builder, loopStageIndex):
    return ConstMinigameRoadPuzzleExcelAddLoopStageIndex(builder, loopStageIndex)
def ConstMinigameRoadPuzzleExcelAddStartStageIndex(builder, startStageIndex): builder.PrependInt32Slot(1, startStageIndex, 0)
...
def ConstMinigameRoadPuzzleExcelAddTileRotationDegree(builder, tileRotationDegree): builder.PrependInt32Slot(2, tileRotationDegree, 0)
...
def ConstMinigameRoadPuzzleExcelAddCameraZoomDefault(builder, cameraZoomDefault): builder.PrependFloat32Slot(4, cameraZoomDefault, 0.0)
...
def ConstMinigameRoadPuzzleExcelAddCameraZoomMin(builder, cameraZoomMin): builder.PrependFloat32Slot(5, cameraZoomMin, 0.0)
def AddCameraZoomMin(builder, cameraZoomMin):
    return ConstMinigameRoadPuzzleExcelAddCameraZoomMin(builder, cameraZoomMin)
def ConstMinigameRoadPuzzleExcelAddCameraZoomMax(builder, cameraZoomMax): builder.PrependFloat32Slot(6, cameraZoomMax, 0.0)
def AddCameraZoomMax(builder, cameraZoomMax):
    return ConstMinigameRoadPuzzleExcelAddCameraZoomMax(builder, cameraZoomMax)
def ConstMinigameRoadPuzzleExcelAddCameraAngle(builder, cameraAngle): builder.PrependFloat32Slot(7, cameraAngle, 0.0)
def AddCameraAngle(builder, cameraAngle):
    return ConstMinigameRoadPuzzleExcelAddCameraAngle(builder, cameraAngle)
def ConstMinigameRoadPuzzleExcelAddRoadPuzzleMapCenterOffsetY(builder, roadPuzzleMapCenterOffsetY): builder.PrependFloat32Slot(8, roadPuzzleMapCenterOffsetY, 0.0)
...
def ConstMinigameRoadPuzzleExcelAddRoadPuzzleMapBoundaryOffsetTop(builder, roadPuzzleMapBoundaryOffsetTop): builder.PrependFloat32Slot(11, roadPuzzleMapBoundaryOffsetTop, 0.0)
...
def ConstMinigameRoadPuzzleExcelAddRoadPuzzleMapBoundaryOffsetRight(builder, roadPuzzleMapBoundaryOffsetRight): builder.PrependFloat32Slot(12, roadPuzzleMapBoundaryOffsetRight, 0.0)
...
def ConstMinigameRoadPuzzleExcelAddRoadPuzzleMapBoundaryOffsetLeft(builder, roadPuzzleMapBoundaryOffsetLeft): builder.PrependFloat32Slot(13, roadPuzzleMapBoundaryOffsetLeft, 0.0)
