...
def FieldDateExcelAddCharacterIconPath(builder, characterIconPath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(characterIconPath), 0)
def AddCharacterIconPath(builder, characterIconPath):
    return FieldDateExcelAddCharacterIconPath(builder, characterIconPath)
def FieldDateExcelAddDateLocalizeKey(builder, dateLocalizeKey): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(dateLocalizeKey), 0)
...
def FieldDateExcelAddDateResultSpineOffsetX(builder, dateResultSpineOffsetX): builder.PrependFloat32Slot(3, dateResultSpineOffsetX, 0.0)
...
def FieldDateExcelAddDateResultSpinePath(builder, dateResultSpinePath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(dateResultSpinePath), 0)
...
def FieldDateExcelAddEndConditionId(builder, endConditionId): builder.PrependInt64Slot(5, endConditionId, 0)
def AddEndConditionId(builder, endConditionId):
    return FieldDateExcelAddEndConditionId(builder, endConditionId)
def FieldDateExcelAddEndConditionType(builder, endConditionType): builder.PrependInt32Slot(6, endConditionType, 0)
def AddEndConditionType(builder, endConditionType):
    return FieldDateExcelAddEndConditionType(builder, endConditionType)
def FieldDateExcelAddEndReadyConditionId(builder, endReadyConditionId): builder.PrependInt64Slot(7, endReadyConditionId, 0)
...
def FieldDateExcelAddEndReadyConditionType(builder, endReadyConditionType): builder.PrependInt32Slot(8, endReadyConditionType, 0)
...
def FieldDateExcelAddEntrySceneId(builder, entrySceneId): builder.PrependInt64Slot(9, entrySceneId, 0)
def AddEntrySceneId(builder, entrySceneId):
    return FieldDateExcelAddEntrySceneId(builder, entrySceneId)
def FieldDateExcelAddOpenConditionStage(builder, openConditionStage): builder.PrependInt64Slot(10, openConditionStage, 0)
...
def FieldDateExcelAddOpenDate(builder, openDate): builder.PrependInt64Slot(11, openDate, 0)
def AddOpenDate(builder, openDate):
    return FieldDateExcelAddOpenDate(builder, openDate)
def FieldDateExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(12, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return FieldDateExcelAddSeasonId(builder, seasonId)
def FieldDateExcelAddStartConditionId(builder, startConditionId): builder.PrependInt64Slot(13, startConditionId, 0)
def AddStartConditionId(builder, startConditionId):
    return FieldDateExcelAddStartConditionId(builder, startConditionId)
def FieldDateExcelAddStartConditionType(builder, startConditionType): builder.PrependInt32Slot(14, startConditionType, 0)
...
def FieldDateExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(15, uniqueId, 0)
