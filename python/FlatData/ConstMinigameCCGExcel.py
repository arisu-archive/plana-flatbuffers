...
def ConstMinigameCCGExcelAddSelectRewardOptionCount(builder, selectRewardOptionCount): builder.PrependInt32Slot(1, selectRewardOptionCount, 0)
...
def ConstMinigameCCGExcelAddCampReviveHealthRate(builder, campReviveHealthRate): builder.PrependInt32Slot(3, campReviveHealthRate, 0)
...
def ConstMinigameCCGExcelAddStartDrawCount(builder, startDrawCount): builder.PrependInt32Slot(4, startDrawCount, 0)
def AddStartDrawCount(builder, startDrawCount):
    return ConstMinigameCCGExcelAddStartDrawCount(builder, startDrawCount)
def ConstMinigameCCGExcelAddStrikerMaxEquipCount(builder, strikerMaxEquipCount): builder.PrependInt32Slot(5, strikerMaxEquipCount, 0)
...
def ConstMinigameCCGExcelAddStrikerSwapFrontCost(builder, strikerSwapFrontCost): builder.PrependInt32Slot(6, strikerSwapFrontCost, 0)
...
def ConstMinigameCCGExcelAddTurnCost(builder, turnCost): builder.PrependInt32Slot(7, turnCost, 0)
def AddTurnCost(builder, turnCost):
    return ConstMinigameCCGExcelAddTurnCost(builder, turnCost)
def ConstMinigameCCGExcelAddStartCost(builder, startCost): builder.PrependInt32Slot(8, startCost, 0)
def AddStartCost(builder, startCost):
    return ConstMinigameCCGExcelAddStartCost(builder, startCost)
def ConstMinigameCCGExcelAddMaxCost(builder, maxCost): builder.PrependInt32Slot(9, maxCost, 0)
def AddMaxCost(builder, maxCost):
    return ConstMinigameCCGExcelAddMaxCost(builder, maxCost)
def ConstMinigameCCGExcelAddMaxHandCount(builder, maxHandCount): builder.PrependInt32Slot(10, maxHandCount, 0)
def AddMaxHandCount(builder, maxHandCount):
    return ConstMinigameCCGExcelAddMaxHandCount(builder, maxHandCount)
def ConstMinigameCCGExcelAddAniAllyBattleAttack(builder, aniAllyBattleAttack): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(aniAllyBattleAttack), 0)
...
def ConstMinigameCCGExcelAddMapAllyRotation(builder, mapAllyRotation): builder.PrependFloat32Slot(12, mapAllyRotation, 0.0)
def AddMapAllyRotation(builder, mapAllyRotation):
    return ConstMinigameCCGExcelAddMapAllyRotation(builder, mapAllyRotation)
def ConstMinigameCCGExcelAddThemaLoadingProgressTime(builder, themaLoadingProgressTime): builder.PrependFloat32Slot(13, themaLoadingProgressTime, 0.0)
...
def ConstMinigameCCGExcelAddCameraZoomDefault(builder, cameraZoomDefault): builder.PrependFloat32Slot(14, cameraZoomDefault, 0.0)
...
def ConstMinigameCCGExcelAddCameraZoomMin(builder, cameraZoomMin): builder.PrependFloat32Slot(15, cameraZoomMin, 0.0)
def AddCameraZoomMin(builder, cameraZoomMin):
    return ConstMinigameCCGExcelAddCameraZoomMin(builder, cameraZoomMin)
def ConstMinigameCCGExcelAddCameraZoomMax(builder, cameraZoomMax): builder.PrependFloat32Slot(16, cameraZoomMax, 0.0)
def AddCameraZoomMax(builder, cameraZoomMax):
    return ConstMinigameCCGExcelAddCameraZoomMax(builder, cameraZoomMax)
def ConstMinigameCCGExcelAddCameraAngle(builder, cameraAngle): builder.PrependFloat32Slot(17, cameraAngle, 0.0)
def AddCameraAngle(builder, cameraAngle):
    return ConstMinigameCCGExcelAddCameraAngle(builder, cameraAngle)
def ConstMinigameCCGExcelAddConquestMapCenterOffsetY(builder, conquestMapCenterOffsetY): builder.PrependFloat32Slot(18, conquestMapCenterOffsetY, 0.0)
...
def ConstMinigameCCGExcelAddConquestMapCenterOffsetX(builder, conquestMapCenterOffsetX): builder.PrependFloat32Slot(19, conquestMapCenterOffsetX, 0.0)
...
def ConstMinigameCCGExcelAddConquestMapBoundaryOffsetTop(builder, conquestMapBoundaryOffsetTop): builder.PrependFloat32Slot(21, conquestMapBoundaryOffsetTop, 0.0)
...
def ConstMinigameCCGExcelAddConquestMapBoundaryOffsetRight(builder, conquestMapBoundaryOffsetRight): builder.PrependFloat32Slot(22, conquestMapBoundaryOffsetRight, 0.0)
