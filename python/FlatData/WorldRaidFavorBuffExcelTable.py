...
class WorldRaidFavorBuffExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsWorldRaidFavorBuffExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.WorldRaidFavorBuffExcel import WorldRaidFavorBuffExcel
            obj = WorldRaidFavorBuffExcel()
