...
class CharacterVictoryInteractionExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsCharacterVictoryInteractionExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.CharacterVictoryInteractionExcel import CharacterVictoryInteractionExcel
