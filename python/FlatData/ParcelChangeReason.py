...
class ParcelChangeReason(object):
    ...
    TacticalRelay_EnterBattle = 201
    TacticalRelay_StageResult = 202
    TacticalRelay_Sweep = 203
    TacticalRelay_GiveUp = 204
    MiniGame_JankenEquipLevelUp = 205
    MiniGame_JankenEndBattle = 206
    MiniGame_JankenScoreReward = 207
    Character_AllocateEngraveNode = 208
    SeasonRecord_BuyDay = 209
    SeasonRecord_Reward = 210
    StreakRecord_Reward = 211
