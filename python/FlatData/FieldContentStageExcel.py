...
def FieldContentStageExcelAddDailyLastPlay(builder, dailyLastPlay): builder.PrependBoolSlot(3, dailyLastPlay, 0)
...
def FieldContentStageExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(5, groundId, 0)
def AddGroundId(builder, groundId):
    return FieldContentStageExcelAddGroundId(builder, groundId)
def FieldContentStageExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(6, groupId, 0)
def AddGroupId(builder, groupId):
    return FieldContentStageExcelAddGroupId(builder, groupId)
def FieldContentStageExcelAddId(builder, id): builder.PrependInt64Slot(7, id, 0)
def AddId(builder, id):
    return FieldContentStageExcelAddId(builder, id)
def FieldContentStageExcelAddInstantClear(builder, instantClear): builder.PrependBoolSlot(8, instantClear, 0)
def AddInstantClear(builder, instantClear):
    return FieldContentStageExcelAddInstantClear(builder, instantClear)
def FieldContentStageExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return FieldContentStageExcelAddName(builder, name)
def FieldContentStageExcelAddPrevStageId(builder, prevStageId): builder.PrependInt64Slot(10, prevStageId, 0)
...
def FieldContentStageExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(12, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return FieldContentStageExcelAddSeasonId(builder, seasonId)
def FieldContentStageExcelAddSkipFormationSettings(builder, skipFormationSettings): builder.PrependBoolSlot(13, skipFormationSettings, 0)
...
def FieldContentStageExcelAddStageDifficulty(builder, stageDifficulty): builder.PrependInt32Slot(14, stageDifficulty, 0)
def AddStageDifficulty(builder, stageDifficulty):
    return FieldContentStageExcelAddStageDifficulty(builder, stageDifficulty)
def FieldContentStageExcelAddStageEnterCostAmount(builder, stageEnterCostAmount): builder.PrependInt32Slot(15, stageEnterCostAmount, 0)
...
def FieldContentStageExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependInt64Slot(16, stageEnterCostId, 0)
...
def FieldContentStageExcelAddStageEnterCostType(builder, stageEnterCostType): builder.PrependInt32Slot(17, stageEnterCostType, 0)
...
def FieldContentStageExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(18, stageTopography, 0)
def AddStageTopography(builder, stageTopography):
    return FieldContentStageExcelAddStageTopography(builder, stageTopography)
def FieldContentStageExcelAddStarGoalAmount(builder, starGoalAmount): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(starGoalAmount), 0)
...
def FieldContentStageExcelAddStarGoal(builder, starGoal): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(starGoal), 0)
