...
def DefaultParcelExcelAddParcelAmount(builder, parcelAmount): builder.PrependInt64Slot(0, parcelAmount, 0)
...
def DefaultParcelExcelAddParcelType(builder, parcelType): builder.PrependInt32Slot(2, parcelType, 0)
