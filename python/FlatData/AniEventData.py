...
def AniEventDataAddStringParam(builder, stringParam): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(stringParam), 0)
def AddStringParam(builder, stringParam):
    return AniEventDataAddStringParam(builder, stringParam)
def AniEventDataAddFloatParam(builder, floatParam): builder.PrependFloat32Slot(1, floatParam, 0.0)
...
def AniEventDataAddTime(builder, time): builder.PrependFloat32Slot(3, time, 0.0)
def AddTime(builder, time):
    return AniEventDataAddTime(builder, time)
def AniEventDataAddName(builder, name): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
