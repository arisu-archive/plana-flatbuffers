...
def FieldSeasonExcelAddEndDate(builder, endDate): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(endDate), 0)
def AddEndDate(builder, endDate):
    return FieldSeasonExcelAddEndDate(builder, endDate)
def FieldSeasonExcelAddEntryDateId(builder, entryDateId): builder.PrependInt64Slot(1, entryDateId, 0)
def AddEntryDateId(builder, entryDateId):
    return FieldSeasonExcelAddEntryDateId(builder, entryDateId)
def FieldSeasonExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(2, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return FieldSeasonExcelAddEventContentId(builder, eventContentId)
def FieldSeasonExcelAddFieldGetKeywordCallDialogEnum(builder, fieldGetKeywordCallDialogEnum): builder.PrependInt32Slot(3, fieldGetKeywordCallDialogEnum, 0)
...
def FieldSeasonExcelAddFieldLobbyTitleImagePath(builder, fieldLobbyTitleImagePath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(fieldLobbyTitleImagePath), 0)
...
def FieldSeasonExcelAddFieldPrefabControlId(builder, fieldPrefabControlId): builder.PrependInt64Slot(5, fieldPrefabControlId, 0)
...
def FieldSeasonExcelAddInstantEntryDateId(builder, instantEntryDateId): builder.PrependInt64Slot(6, instantEntryDateId, 0)
...
def FieldSeasonExcelAddKeywordLogoImagePath(builder, keywordLogoImagePath): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(keywordLogoImagePath), 0)
...
def FieldSeasonExcelAddLobbyBgmChangeStageId(builder, lobbyBgmChangeStageId): builder.PrependInt64Slot(8, lobbyBgmChangeStageId, 0)
...
def FieldSeasonExcelAddStartDate(builder, startDate): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(startDate), 0)
def AddStartDate(builder, startDate):
    return FieldSeasonExcelAddStartDate(builder, startDate)
def FieldSeasonExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(11, uniqueId, 0)
