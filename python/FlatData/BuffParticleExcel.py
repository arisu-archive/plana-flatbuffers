...
def BuffParticleExcelAddResourcePath(builder, resourcePath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(resourcePath), 0)
def AddResourcePath(builder, resourcePath):
    return BuffParticleExcelAddResourcePath(builder, resourcePath)
def BuffParticleExcelAddBuffName(builder, buffName): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(buffName), 0)
...
def BuffParticleExcelAddUniqueName(builder, uniqueName): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(uniqueName), 0)
def AddUniqueName(builder, uniqueName):
    return BuffParticleExcelAddUniqueName(builder, uniqueName)
def BuffParticleExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(4, uniqueId, 0)
