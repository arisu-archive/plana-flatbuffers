...
def ObstacleExcelAddSubObstacleId(builder, subObstacleId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(subObstacleId), 0)
...
def ObstacleExcelAddEnemyPoint2Osset(builder, enemyPoint2Osset): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(enemyPoint2Osset), 0)
...
def ObstacleExcelAddPoint2Offeset(builder, point2Offeset): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(point2Offeset), 0)
...
def ObstacleExcelAddEnemyPoint1Osset(builder, enemyPoint1Osset): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(enemyPoint1Osset), 0)
...
def ObstacleExcelAddPoint1Offeset(builder, point1Offeset): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(point1Offeset), 0)
...
def ObstacleExcelAddDestroyType(builder, destroyType): builder.PrependInt32Slot(5, destroyType, 0)
def AddDestroyType(builder, destroyType):
    return ObstacleExcelAddDestroyType(builder, destroyType)
def ObstacleExcelAddEvasionRate(builder, evasionRate): builder.PrependInt32Slot(6, evasionRate, 0)
def AddEvasionRate(builder, evasionRate):
    return ObstacleExcelAddEvasionRate(builder, evasionRate)
def ObstacleExcelAddBlockRate(builder, blockRate): builder.PrependInt32Slot(7, blockRate, 0)
...
def ObstacleExcelAddHp(builder, hp): builder.PrependInt64Slot(9, hp, 0)
def AddHp(builder, hp):
    return ObstacleExcelAddHp(builder, hp)
def ObstacleExcelAddZ(builder, z): builder.PrependFloat32Slot(10, z, 0.0)
def AddZ(builder, z):
    return ObstacleExcelAddZ(builder, z)
def ObstacleExcelAddX(builder, x): builder.PrependFloat32Slot(11, x, 0.0)
def AddX(builder, x):
    return ObstacleExcelAddX(builder, x)
def ObstacleExcelAddSubOffset(builder, subOffset): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(subOffset), 0)
...
def ObstacleExcelAddJumpAble(builder, jumpAble): builder.PrependBoolSlot(13, jumpAble, 0)
def AddJumpAble(builder, jumpAble):
    return ObstacleExcelAddJumpAble(builder, jumpAble)
def ObstacleExcelAddPrefabName(builder, prefabName): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(prefabName), 0)
def AddPrefabName(builder, prefabName):
    return ObstacleExcelAddPrefabName(builder, prefabName)
def ObstacleExcelAddIndex(builder, index): builder.PrependInt64Slot(15, index, 0)
