...
class EventContentLocationExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsEventContentLocationExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.EventContentLocationExcel import EventContentLocationExcel
            obj = EventContentLocationExcel()
