...
def CharacterDialogEmojiExcelAddLocalizeKr(builder, localizeKr): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(localizeKr), 0)
def AddLocalizeKr(builder, localizeKr):
    return CharacterDialogEmojiExcelAddLocalizeKr(builder, localizeKr)
def CharacterDialogEmojiExcelAddHideUi(builder, hideUi): builder.PrependBoolSlot(2, hideUi, 0)
...
def CharacterDialogEmojiExcelAddDialogType(builder, dialogType): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(dialogType), 0)
