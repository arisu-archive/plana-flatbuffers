...
def ConstEventCommonExcelAddEventStoryReplayHideEventContentId(builder, eventStoryReplayHideEventContentId): builder.PrependInt32Slot(3, eventStoryReplayHideEventContentId, 0)
...
def ConstEventCommonExcelAddEventStrategyPlayTimeLimitInSeconds(builder, eventStrategyPlayTimeLimitInSeconds): builder.PrependInt64Slot(4, eventStrategyPlayTimeLimitInSeconds, 0)
...
def ConstEventCommonExcelAddMeetupScenarioReplayResource(builder, meetupScenarioReplayResource): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(meetupScenarioReplayResource), 0)
...
def ConstEventCommonExcelAddSpecialOperactionCollectionGroupId(builder, specialOperactionCollectionGroupId): builder.PrependInt64Slot(7, specialOperactionCollectionGroupId, 0)
...
def ConstEventCommonExcelAddSubEventChangeLimitSeconds(builder, subEventChangeLimitSeconds): builder.PrependInt64Slot(8, subEventChangeLimitSeconds, 0)
...
def ConstEventCommonExcelAddSubEventInstantClear(builder, subEventInstantClear): builder.PrependBoolSlot(9, subEventInstantClear, 0)
...
def ConstEventCommonExcelAddTreasureLimitVariationClearLoopCount(builder, treasureLimitVariationClearLoopCount): builder.PrependInt32Slot(10, treasureLimitVariationClearLoopCount, 0)
...
def ConstEventCommonExcelAddTreasureLoopVariationAmount(builder, treasureLoopVariationAmount): builder.PrependInt32Slot(12, treasureLoopVariationAmount, 0)
...
def ConstEventCommonExcelAddTreasureNormalVariationAmount(builder, treasureNormalVariationAmount): builder.PrependInt32Slot(13, treasureNormalVariationAmount, 0)
