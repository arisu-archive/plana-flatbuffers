...
func (t *ScenarioReplayExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	for i := len(t.FrontScenarioGroupID) - 1; i >= 0; i-- {
		b.PrependInt64(fbsutils.Convert(t.FrontScenarioGroupID[i], t.FlatBuffer.TableKey))
	}
	...
	for i := len(t.BackScenarioGroupID) - 1; i >= 0; i-- {
		b.PrependInt64(fbsutils.Convert(t.BackScenarioGroupID[i], t.FlatBuffer.TableKey))
	}
	...
	ScenarioReplayExcelAddReplayType(b, ScenarioModeReplayTypes(fbsutils.Convert(int32(t.ReplayType), t.FlatBuffer.TableKey)))
