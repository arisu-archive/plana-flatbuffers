...
func (t *TagExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	TagExcelStart(b)
	TagExcelAddFurniture(b, Tag(fbsutils.Convert(int32(t.Furniture), t.FlatBuffer.TableKey)))
	TagExcelAddNone(b, Club(fbsutils.Convert(int32(t.None), t.FlatBuffer.TableKey)))
