...
func (t *CampaignStageExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	CampaignStageExcelAddName(b, __offset_name)
	CampaignStageExcelAddStageNumber(b, __offset_stage_number)
	...
	CampaignStageExcelAddStrategyMap(b, __offset_strategy_map)
	CampaignStageExcelAddStrategyMapBg(b, __offset_strategy_map_bg)
	...
	CampaignStageExcelAddBgmId(b, __offset_bgm_id)
