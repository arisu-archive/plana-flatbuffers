...
func (t *ConstCombatExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ConstCombatExcelAddCheckCheaterMaxUseCostTacticalRelay(b, fbsutils.Convert(t.CheckCheaterMaxUseCostTacticalRelay, t.FlatBuffer.TableKey))
...
func (t *ConstCombatExcelDto) UnmarshalMessage(e *ConstCombatExcel) error {
	...
	t.CheckCheaterMaxUseCostTacticalRelay = fbsutils.Convert(e.CheckCheaterMaxUseCostTacticalRelay(), t.FlatBuffer.TableKey)
	return nil
}
