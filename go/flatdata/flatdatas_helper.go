...
var fbs = map[string]reflect.Type{
	...
	"constminigamejankenexcel": reflect.TypeOf((*ConstMinigameJankenExcelDto)(nil)).Elem(),
	"constminigamejankenexceltable": reflect.TypeOf((*ConstMinigameJankenExcelTableDto)(nil)).Elem(),
	...
	"localizekeymappingexcel": reflect.TypeOf((*LocalizeKeyMappingExcelDto)(nil)).Elem(),
	"localizekeymappingexceltable": reflect.TypeOf((*LocalizeKeyMappingExcelTableDto)(nil)).Elem(),
