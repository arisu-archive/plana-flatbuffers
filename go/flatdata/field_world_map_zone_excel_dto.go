...
func (t *FieldWorldMapZoneExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	FieldWorldMapZoneExcelAddOpenConditionType(b, FieldConditionType(fbsutils.Convert(int32(t.OpenConditionType), t.FlatBuffer.TableKey)))
	FieldWorldMapZoneExcelAddOpenConditionId(b, fbsutils.Convert(t.OpenConditionID, t.FlatBuffer.TableKey))
	FieldWorldMapZoneExcelAddCloseConditionType(b, FieldConditionType(fbsutils.Convert(int32(t.CloseConditionType), t.FlatBuffer.TableKey)))
	...
	FieldWorldMapZoneExcelAddWorldMapButtonType(b, FieldWorldMapButtonType(fbsutils.Convert(int32(t.WorldMapButtonType), t.FlatBuffer.TableKey)))
