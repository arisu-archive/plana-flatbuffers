...
func (t *ConstStrategyExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	for i := len(t.HealCostAmount) - 1; i >= 0; i-- {
		b.PrependInt64(fbsutils.Convert(t.HealCostAmount[i], t.FlatBuffer.TableKey))
	}
	...
	ConstStrategyExcelAddHealCostType(b, CurrencyTypes(fbsutils.Convert(int32(t.HealCostType), t.FlatBuffer.TableKey)))
	...
	ConstStrategyExcelAddTacticalRelayEchelonCount(b, fbsutils.Convert(t.TacticalRelayEchelonCount, t.FlatBuffer.TableKey))
...
func (t *ConstStrategyExcelDto) UnmarshalMessage(e *ConstStrategyExcel) error {
	...
	t.TacticalRelayEchelonCount = fbsutils.Convert(e.TacticalRelayEchelonCount(), t.FlatBuffer.TableKey)
	return nil
}
