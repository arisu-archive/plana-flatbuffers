...
func (t *ConstMinigameTBGExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	__offset_effect_ally_battle_attack := b.CreateString(fbsutils.Convert(t.EffectAllyBattleAttack, t.FlatBuffer.TableKey))
	__offset_effect_ally_battle_damage := b.CreateString(fbsutils.Convert(t.EffectAllyBattleDamage, t.FlatBuffer.TableKey))
	__offset_ani_enemy_battle_attack := b.CreateString(fbsutils.Convert(t.AniEnemyBattleAttack, t.FlatBuffer.TableKey))
	__offset_effect_enemy_battle_attack := b.CreateString(fbsutils.Convert(t.EffectEnemyBattleAttack, t.FlatBuffer.TableKey))
	__offset_effect_enemy_battle_damage := b.CreateString(fbsutils.Convert(t.EffectEnemyBattleDamage, t.FlatBuffer.TableKey))
	...
	ConstMinigameTBGExcelAddAniAllyBattleAttack(b, __offset_ani_ally_battle_attack)
	ConstMinigameTBGExcelAddEffectAllyBattleAttack(b, __offset_effect_ally_battle_attack)
	ConstMinigameTBGExcelAddEffectAllyBattleDamage(b, __offset_effect_ally_battle_damage)
	ConstMinigameTBGExcelAddAniEnemyBattleAttack(b, __offset_ani_enemy_battle_attack)
	ConstMinigameTBGExcelAddEffectEnemyBattleAttack(b, __offset_effect_enemy_battle_attack)
	ConstMinigameTBGExcelAddEffectEnemyBattleDamage(b, __offset_effect_enemy_battle_damage)
