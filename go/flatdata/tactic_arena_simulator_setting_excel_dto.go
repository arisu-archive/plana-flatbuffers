...
func (t *TacticArenaSimulatorSettingExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	TacticArenaSimulatorSettingExcelAddAttackerFrom(b, ArenaSimulatorServer(fbsutils.Convert(int32(t.AttackerFrom), t.FlatBuffer.TableKey)))
	...
	TacticArenaSimulatorSettingExcelAddDefenderFrom(b, ArenaSimulatorServer(fbsutils.Convert(int32(t.DefenderFrom), t.FlatBuffer.TableKey)))
