...
func (t *TranscendenceRecipeExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	for i := len(t.ParcelAmount) - 1; i >= 0; i-- {
		b.PrependInt32(fbsutils.Convert(t.ParcelAmount[i], t.FlatBuffer.TableKey))
	}
	...
	TranscendenceRecipeExcelAddCostCurrencyType(b, CurrencyTypes(fbsutils.Convert(int32(t.CostCurrencyType), t.FlatBuffer.TableKey)))
