...
func (t *TacticalSupportSystemExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	__offset_obstacle_unique_name := b.CreateString(fbsutils.Convert(t.ObstacleUniqueName, t.FlatBuffer.TableKey))
	__offset_summon_skilll_group_id := b.CreateString(fbsutils.Convert(t.SummonSkilllGroupId, t.FlatBuffer.TableKey))
	__offset_get_on_start_effect_path := b.CreateString(fbsutils.Convert(t.GetOnStartEffectPath, t.FlatBuffer.TableKey))
	__offset_get_on_end_effect_path := b.CreateString(fbsutils.Convert(t.GetOnEndEffectPath, t.FlatBuffer.TableKey))
	__offset_interaction_student_ex_skill_group_id := b.CreateString(fbsutils.Convert(t.InteractionStudentExSkillGroupId, t.FlatBuffer.TableKey))
	__offset_interaction_skill_card_texture := b.CreateString(fbsutils.Convert(t.InteractionSkillCardTexture, t.FlatBuffer.TableKey))
	__offset_interaction_skill_spine := b.CreateString(fbsutils.Convert(t.InteractionSkillSpine, t.FlatBuffer.TableKey))
	...
	TacticalSupportSystemExcelAddObstacleUniqueName(b, __offset_obstacle_unique_name)
	TacticalSupportSystemExcelAddObstacleCoverRange(b, fbsutils.Convert(t.ObstacleCoverRange, t.FlatBuffer.TableKey))
	TacticalSupportSystemExcelAddSummonSkilllGroupId(b, __offset_summon_skilll_group_id)
	...
	TacticalSupportSystemExcelAddGetOnStartEffectPath(b, __offset_get_on_start_effect_path)
	TacticalSupportSystemExcelAddGetOnEndEffectPath(b, __offset_get_on_end_effect_path)
	...
	TacticalSupportSystemExcelAddInteractionStudentExSkillGroupId(b, __offset_interaction_student_ex_skill_group_id)
	TacticalSupportSystemExcelAddInteractionSkillCardTexture(b, __offset_interaction_skill_card_texture)
	TacticalSupportSystemExcelAddInteractionSkillSpine(b, __offset_interaction_skill_spine)
