...
func (t *ConquestUnitExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	__offset_unit_fx_prefab_name := b.CreateString(fbsutils.Convert(t.UnitFxPrefabName, t.FlatBuffer.TableKey))
	__offset_point_animation := b.CreateString(fbsutils.Convert(t.PointAnimation, t.FlatBuffer.TableKey))
	...
	ConquestUnitExcelAddName(b, __offset_name)
	ConquestUnitExcelAddPrefabName(b, __offset_prefab_name)
	ConquestUnitExcelAddStrategyPrefabName(b, __offset_strategy_prefab_name)
	...
	ConquestUnitExcelAddUnitFxPrefabName(b, __offset_unit_fx_prefab_name)
	ConquestUnitExcelAddPointAnimation(b, __offset_point_animation)
