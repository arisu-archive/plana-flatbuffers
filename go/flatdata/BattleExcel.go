...
func BattleExcelAddNormal(builder *flatbuffers.Builder, normal flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(18, flatbuffers.UOffsetT(normal), 0)
}
