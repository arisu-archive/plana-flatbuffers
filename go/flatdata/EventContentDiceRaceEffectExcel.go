...
func FinishEventContentDiceRaceEffectExcelBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func FinishSizePrefixedEventContentDiceRaceEffectExcelBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
