...
func (t *CharacterExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	__offset_scenario_character := b.CreateString(fbsutils.Convert(t.ScenarioCharacter, t.FlatBuffer.TableKey))
	CharacterExcelStart(b)
	CharacterExcelAddId(b, fbsutils.Convert(t.Id, t.FlatBuffer.TableKey))
	CharacterExcelAddDevName(b, __offset_dev_name)
	...
	CharacterExcelAddReleaseDate(b, __offset_release_date)
	CharacterExcelAddCollectionVisibleStartDate(b, __offset_collection_visible_start_date)
	CharacterExcelAddCollectionVisibleEndDate(b, __offset_collection_visible_end_date)
