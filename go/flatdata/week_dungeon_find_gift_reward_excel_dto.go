...
func (t *WeekDungeonFindGiftRewardExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	for i := len(t.RewardParcelProbability) - 1; i >= 0; i-- {
		b.PrependInt64(fbsutils.Encode(t.RewardParcelProbability[i], t.FlatBuffer.TableKey))
	}
	...
	WeekDungeonFindGiftRewardExcelAddStageRewardId(b, fbsutils.Encode(t.StageRewardID, t.FlatBuffer.TableKey))
...
func (t *WeekDungeonFindGiftRewardExcelDto) UnmarshalMessage(e *WeekDungeonFindGiftRewardExcel) error {
	...
	for i := 0; i < e.RewardParcelProbabilityLength(); i++ {
		t.RewardParcelProbability[i] = fbsutils.Decode(e.RewardParcelProbability(i), t.FlatBuffer.TableKey)
	}
	t.DropItemModelPrefabPath = make([]string, e.DropItemModelPrefabPathLength())
	for i := 0; i < e.DropItemModelPrefabPathLength(); i++ {
		t.DropItemModelPrefabPath[i] = fbsutils.Decode(string(e.DropItemModelPrefabPath(i)), t.FlatBuffer.TableKey)
	}
	return nil
}
