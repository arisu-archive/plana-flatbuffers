...
func (t *CampaignStrategyObjectExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	__offset_strategy_reward_name := b.CreateString(fbsutils.Convert(t.StrategyRewardName, t.FlatBuffer.TableKey))
	...
	CampaignStrategyObjectExcelAddName(b, __offset_name)
	CampaignStrategyObjectExcelAddPrefabName(b, __offset_prefab_name)
	...
	CampaignStrategyObjectExcelAddStrategyRewardName(b, __offset_strategy_reward_name)
