...
func (t *MinigameTBGSeasonExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	__offset_echelon_slot1_portrait := b.CreateString(fbsutils.Convert(t.EchelonSlot1Portrait, t.FlatBuffer.TableKey))
	__offset_echelon_slot2_portrait := b.CreateString(fbsutils.Convert(t.EchelonSlot2Portrait, t.FlatBuffer.TableKey))
	__offset_echelon_slot3_portrait := b.CreateString(fbsutils.Convert(t.EchelonSlot3Portrait, t.FlatBuffer.TableKey))
	__offset_echelon_slot4_portrait := b.CreateString(fbsutils.Convert(t.EchelonSlot4Portrait, t.FlatBuffer.TableKey))
	__offset_map_image_path := b.CreateString(fbsutils.Convert(t.MapImagePath, t.FlatBuffer.TableKey))
	__offset_map_name_localize := b.CreateString(fbsutils.Convert(t.MapNameLocalize, t.FlatBuffer.TableKey))
	...
	MinigameTBGSeasonExcelAddEchelonSlot1Portrait(b, __offset_echelon_slot1_portrait)
	MinigameTBGSeasonExcelAddEchelonSlot2Portrait(b, __offset_echelon_slot2_portrait)
	MinigameTBGSeasonExcelAddEchelonSlot3Portrait(b, __offset_echelon_slot3_portrait)
	MinigameTBGSeasonExcelAddEchelonSlot4Portrait(b, __offset_echelon_slot4_portrait)
	...
	MinigameTBGSeasonExcelAddMapImagePath(b, __offset_map_image_path)
	MinigameTBGSeasonExcelAddMapNameLocalize(b, __offset_map_name_localize)
