...
func (t *NormalSkillTemplateExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	NormalSkillTemplateExcelAddIndex(b, fbsutils.Encode(t.Index, t.FlatBuffer.TableKey))
	NormalSkillTemplateExcelAddFirstCoolTime(b, fbsutils.Encode(t.FirstCoolTime, t.FlatBuffer.TableKey))
	NormalSkillTemplateExcelAddCoolTime(b, fbsutils.Encode(t.CoolTime, t.FlatBuffer.TableKey))
...
func (t *NormalSkillTemplateExcelDto) UnmarshalMessage(e *NormalSkillTemplateExcel) error {
	...
	t.FirstCoolTime = fbsutils.Decode(e.FirstCoolTime(), t.FlatBuffer.TableKey)
	t.CoolTime = fbsutils.Decode(e.CoolTime(), t.FlatBuffer.TableKey)
