...
func FinishRecipeExcelBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func FinishSizePrefixedRecipeExcelBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func RecipeExcelAddParcelId(builder *flatbuffers.Builder, parcelId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(parcelId), 0)
}
...
func RecipeExcelAddResultAmountMin(builder *flatbuffers.Builder, resultAmountMin flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(resultAmountMin), 0)
}
...
func RecipeExcelAddResultAmountMax(builder *flatbuffers.Builder, resultAmountMax flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(resultAmountMax), 0)
}
