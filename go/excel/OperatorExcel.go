...
func OperatorExcelAddOperatorWaitQueue(builder *flatbuffers.Builder, operatorWaitQueue bool) {
	builder.PrependBoolSlot(0, operatorWaitQueue, false)
}
