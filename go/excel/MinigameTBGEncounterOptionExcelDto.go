...
func (t *MinigameTBGEncounterOptionExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	__offset_option_title_localize := b.CreateString(fbsutils.Convert(t.OptionTitleLocalize, t.FlatBuffer.TableKey))
	__offset_option_success_localize := b.CreateString(fbsutils.Convert(t.OptionSuccessLocalize, t.FlatBuffer.TableKey))
	__offset_option_fail_localize := b.CreateString(fbsutils.Convert(t.OptionFailLocalize, t.FlatBuffer.TableKey))
	...
	MinigameTBGEncounterOptionExcelAddOptionTitleLocalize(b, __offset_option_title_localize)
	MinigameTBGEncounterOptionExcelAddOptionSuccessLocalize(b, __offset_option_success_localize)
	...
	MinigameTBGEncounterOptionExcelAddOptionFailLocalize(b, __offset_option_fail_localize)
