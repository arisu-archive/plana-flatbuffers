...
func LocalizeGachaShopExcelAddTitleNameKr(builder *flatbuffers.Builder, titleNameKr flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(titleNameKr), 0)
}
