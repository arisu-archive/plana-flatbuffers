...
func (t *SkillExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	__offset_skill_data_key := b.CreateString(fbsutils.Convert(t.SkillDataKey, t.FlatBuffer.TableKey))
	__offset_visual_data_key := b.CreateString(fbsutils.Convert(t.VisualDataKey, t.FlatBuffer.TableKey))
	__offset_icon_name := b.CreateString(fbsutils.Convert(t.IconName, t.FlatBuffer.TableKey))
	__offset_texture_skill_card_for_form_conversion := b.CreateString(fbsutils.Convert(t.TextureSkillCardForFormConversion, t.FlatBuffer.TableKey))
	__offset_skill_card_label_path := b.CreateString(fbsutils.Convert(t.SkillCardLabelPath, t.FlatBuffer.TableKey))
	SkillExcelStart(b)
	...
	SkillExcelAddGroupId(b, __offset_group_id)
	SkillExcelAddSkillDataKey(b, __offset_skill_data_key)
	SkillExcelAddVisualDataKey(b, __offset_visual_data_key)
	...
	SkillExcelAddIconName(b, __offset_icon_name)
	...
	SkillExcelAddTextureSkillCardForFormConversion(b, __offset_texture_skill_card_for_form_conversion)
	SkillExcelAddSkillCardLabelPath(b, __offset_skill_card_label_path)
