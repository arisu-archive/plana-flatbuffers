...
func (t *AttendanceExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	__offset_countdown_prefab := b.CreateString(fbsutils.Convert(t.CountdownPrefab, t.FlatBuffer.TableKey))
	__offset_title := b.CreateString(fbsutils.Convert(t.Title, t.FlatBuffer.TableKey))
	...
	__offset_decoration_image_path := b.CreateString(fbsutils.Convert(t.DecorationImagePath, t.FlatBuffer.TableKey))
	__offset_decoration_garland_image_path := b.CreateString(fbsutils.Convert(t.DecorationGarlandImagePath, t.FlatBuffer.TableKey))
	...
	AttendanceExcelAddStartDate(b, __offset_start_date)
	AttendanceExcelAddStartableEndDate(b, __offset_startable_end_date)
	AttendanceExcelAddEndDate(b, __offset_end_date)
	...
	AttendanceExcelAddTitleImagePath(b, __offset_title_image_path)
	AttendanceExcelAddDecorationImagePath(b, __offset_decoration_image_path)
	AttendanceExcelAddDecorationGarlandImagePath(b, __offset_decoration_garland_image_path)
