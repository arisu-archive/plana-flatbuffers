...
func FinishEventContentCardShopModifyExcelBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func FinishSizePrefixedEventContentCardShopModifyExcelBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func EventContentCardShopModifyExcelAddUsePrefabName(builder *flatbuffers.Builder, usePrefabName flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(usePrefabName), 0)
}
