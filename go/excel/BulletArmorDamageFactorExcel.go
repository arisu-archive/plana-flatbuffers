...
func BulletArmorDamageFactorExcelAddDamageFactorGroupId(builder *flatbuffers.Builder, damageFactorGroupId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(damageFactorGroupId), 0)
}
