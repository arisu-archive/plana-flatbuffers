...
func FinishAssistRewardExcelBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func FinishSizePrefixedAssistRewardExcelBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func AssistRewardExcelAddRewardType(builder *flatbuffers.Builder, rewardType AssistRewardType) {
	builder.PrependInt32Slot(0, int32(rewardType), 0)
}
