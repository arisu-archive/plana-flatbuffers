...
func GoodsExcelAddConsumeExtraAmount(builder *flatbuffers.Builder, consumeExtraAmount flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(4, flatbuffers.UOffsetT(consumeExtraAmount), 0)
}
...
func GoodsExcelAddConsumeExtraStep(builder *flatbuffers.Builder, consumeExtraStep flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(consumeExtraStep), 0)
}
...
func GoodsExcelAddProductIdiOs(builder *flatbuffers.Builder, productIdiOs int64) {
	builder.PrependInt64Slot(6, productIdiOs, 0)
}
func GoodsExcelAddProductIdAos(builder *flatbuffers.Builder, productIdAos int64) {
	builder.PrependInt64Slot(7, productIdAos, 0)
}
func GoodsExcelAddConsumeGachaTicketTypeAmount(builder *flatbuffers.Builder, consumeGachaTicketTypeAmount flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(consumeGachaTicketTypeAmount), 0)
}
...
func GoodsExcelAddConsumeGachaTicketType(builder *flatbuffers.Builder, consumeGachaTicketType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(9, flatbuffers.UOffsetT(consumeGachaTicketType), 0)
}
...
func GoodsExcelAddConsumeCondition(builder *flatbuffers.Builder, consumeCondition flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(consumeCondition), 0)
}
...
func GoodsExcelAddConsumeParcelAmount(builder *flatbuffers.Builder, consumeParcelAmount flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(11, flatbuffers.UOffsetT(consumeParcelAmount), 0)
}
...
func GoodsExcelAddConsumeParcelId(builder *flatbuffers.Builder, consumeParcelId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(12, flatbuffers.UOffsetT(consumeParcelId), 0)
}
...
func GoodsExcelAddConsumeParcelType(builder *flatbuffers.Builder, consumeParcelType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(13, flatbuffers.UOffsetT(consumeParcelType), 0)
}
...
func GoodsExcelAddIconPath(builder *flatbuffers.Builder, iconPath flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(14, flatbuffers.UOffsetT(iconPath), 0)
}
func GoodsExcelAddRarity(builder *flatbuffers.Builder, rarity Rarity) {
	builder.PrependInt32Slot(15, int32(rarity), 0)
}
func GoodsExcelAddType(builder *flatbuffers.Builder, type_ int32) {
	builder.PrependInt32Slot(16, type_, 0)
}
