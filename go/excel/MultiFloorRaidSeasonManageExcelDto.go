...
func (t *MultiFloorRaidSeasonManageExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	__offset_season_start_date := b.CreateString(fbsutils.Convert(t.SeasonStartDate, t.FlatBuffer.TableKey))
	__offset_end_note_label_start_date := b.CreateString(fbsutils.Convert(t.EndNoteLabelStartDate, t.FlatBuffer.TableKey))
	__offset_season_end_date := b.CreateString(fbsutils.Convert(t.SeasonEndDate, t.FlatBuffer.TableKey))
	__offset_settlement_end_date := b.CreateString(fbsutils.Convert(t.SettlementEndDate, t.FlatBuffer.TableKey))
	__offset_open_raid_boss_group_id := b.CreateString(fbsutils.Convert(t.OpenRaidBossGroupId, t.FlatBuffer.TableKey))
	__offset_lobby_img_path := b.CreateString(fbsutils.Convert(t.LobbyImgPath, t.FlatBuffer.TableKey))
	__offset_level_img_path := b.CreateString(fbsutils.Convert(t.LevelImgPath, t.FlatBuffer.TableKey))
	__offset_play_tip := b.CreateString(fbsutils.Convert(t.PlayTip, t.FlatBuffer.TableKey))
	...
	MultiFloorRaidSeasonManageExcelAddSeasonStartDate(b, __offset_season_start_date)
	MultiFloorRaidSeasonManageExcelAddEndNoteLabelStartDate(b, __offset_end_note_label_start_date)
	MultiFloorRaidSeasonManageExcelAddSeasonEndDate(b, __offset_season_end_date)
	MultiFloorRaidSeasonManageExcelAddSettlementEndDate(b, __offset_settlement_end_date)
	MultiFloorRaidSeasonManageExcelAddOpenRaidBossGroupId(b, __offset_open_raid_boss_group_id)
	MultiFloorRaidSeasonManageExcelAddEnterScenarioKey(b, fbsutils.Convert(t.EnterScenarioKey, t.FlatBuffer.TableKey))
	MultiFloorRaidSeasonManageExcelAddLobbyImgPath(b, __offset_lobby_img_path)
	MultiFloorRaidSeasonManageExcelAddLevelImgPath(b, __offset_level_img_path)
	MultiFloorRaidSeasonManageExcelAddPlayTip(b, __offset_play_tip)
