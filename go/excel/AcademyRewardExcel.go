...
func AcademyRewardExcelAddProgressTexture(builder *flatbuffers.Builder, progressTexture flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(15, flatbuffers.UOffsetT(progressTexture), 0)
}
