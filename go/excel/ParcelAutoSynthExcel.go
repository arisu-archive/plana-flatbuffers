...
func ParcelAutoSynthExcelAddRequireParcelAmount(builder *flatbuffers.Builder, requireParcelAmount int64) {
	builder.PrependInt64Slot(0, requireParcelAmount, 0)
}
