...
func (rcv *ContentsShortcutExcel) ScenarioModeType() ScenarioModeTypes {
...
func (rcv *ContentsShortcutExcel) MutateScenarioModeType(n ScenarioModeTypes) bool {
	return rcv._tab.MutateInt32Slot(10, int32(n))
}

func (rcv *ContentsShortcutExcel) ScenarioModeSubType() ScenarioModeSubTypes {
...
func (rcv *ContentsShortcutExcel) MutateScenarioModeSubType(n ScenarioModeSubTypes) bool {
...
func ContentsShortcutExcelAddScenarioModeType(builder *flatbuffers.Builder, scenarioModeType ScenarioModeTypes) {
	builder.PrependInt32Slot(3, int32(scenarioModeType), 0)
}
func ContentsShortcutExcelAddScenarioModeSubType(builder *flatbuffers.Builder, scenarioModeSubType ScenarioModeSubTypes) {
	builder.PrependInt32Slot(4, int32(scenarioModeSubType), 0)
}
...
func ContentsShortcutExcelAddConquestMapDifficulty(builder *flatbuffers.Builder, conquestMapDifficulty StageDifficulty) {
	builder.PrependInt32Slot(10, int32(conquestMapDifficulty), 0)
}
...
func ContentsShortcutExcelAddShortcutUiName(builder *flatbuffers.Builder, shortcutUiName flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(13, flatbuffers.UOffsetT(shortcutUiName), 0)
}
...
func ContentsShortcutExcelAddLocalize(builder *flatbuffers.Builder, localize flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(14, flatbuffers.UOffsetT(localize), 0)
}
