...
func (t *ContentsShortcutExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ContentsShortcutExcelAddScenarioModeSubType(b, fbsutils.Convert(t.ScenarioModeSubType, t.FlatBuffer.TableKey))
...
func (t *ContentsShortcutExcelDto) UnmarshalMessage(e *ContentsShortcutExcel) error {
	...
	t.ScenarioModeSubType = ScenarioModeSubTypes(fbsutils.Convert(int32(e.ScenarioModeSubType()), t.FlatBuffer.TableKey))
